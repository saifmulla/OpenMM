...
# 1 "kCalculateGBVIBornSum.compute_11.cudafe1.stub.c"
...
# 1 "kCalculateGBVIBornSum.compute_11.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T266) {  __nv_dummy_param_ref(__T266); __cudaRegisterEntry(__T266, ((void ( *)(void))kReduceGBVIBornSum_kernel), _Z25kReduceGBVIBornSum_kernelv, (-1)); __cudaRegisterEntry(__T266, ((void ( *)(unsigned *))kCalculateGBVIPeriodicByWarpBornSum_kernel), _Z42kCalculateGBVIPeriodicByWarpBornSum_kernelPj, 256); __cudaRegisterEntry(__T266, ((void ( *)(unsigned *))kCalculateGBVIPeriodicBornSum_kernel), _Z36kCalculateGBVIPeriodicBornSum_kernelPj, 256); __cudaRegisterEntry(__T266, ((void ( *)(unsigned *))kCalculateGBVICutoffByWarpBornSum_kernel), _Z40kCalculateGBVICutoffByWarpBornSum_kernelPj, 256); __cudaRegisterEntry(__T266, ((void ( *)(unsigned *))kCalculateGBVICutoffBornSum_kernel), _Z34kCalculateGBVICutoffBornSum_kernelPj, 256); __cudaRegisterEntry(__T266, ((void ( *)(unsigned *))kCalculateGBVIN2ByWarpBornSum_kernel), _Z36kCalculateGBVIN2ByWarpBornSum_kernelPj, 256); __cudaRegisterEntry(__T266, ((void ( *)(unsigned *))kCalculateGBVIN2BornSum_kernel), _Z30kCalculateGBVIN2BornSum_kernelPj, 256); __cudaRegisterVariable(__T266, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
