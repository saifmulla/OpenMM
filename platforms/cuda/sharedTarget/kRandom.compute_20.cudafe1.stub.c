...
# 1 "kRandom.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T229) {  __nv_dummy_param_ref(__T229); __cudaRegisterEntry(__T229, ((void ( *)(void))kGenerateRandoms_kernel), _Z23kGenerateRandoms_kernelv, 768); __cudaRegisterVariable(__T229, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
