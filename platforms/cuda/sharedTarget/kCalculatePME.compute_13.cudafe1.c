...
{
 enum cudaError __cuda_local_var_39080_17_non_const_status;
__cuda_local_var_39080_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_39080_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
{
 enum cudaError __cuda_local_var_39087_17_non_const_status;
__cuda_local_var_39087_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_39087_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 387 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
 struct cudaChannelFormatDesc __cuda_local_var_39427_27_non_const_channelDesc;

 unsigned __cuda_local_var_39429_18_non_const_threads;
# 387 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39427_27_non_const_channelDesc = ((__T214 = 32) , (cudaCreateChannelDesc(__T214, __T214, __T214, __T214, cudaChannelFormatKindFloat)));
cudaBindTexture(((size_t *)0LL), ((const struct textureReference *)(&__text_var(bsplineThetaRef,bsplineThetaRef).__b_16textureReference)), ((const void *)((gpu->psPmeBsplineTheta)->_pDevData)), ((const struct cudaChannelFormatDesc *)(&__cuda_local_var_39427_27_non_const_channelDesc)), (((unsigned long)((gpu->psPmeBsplineTheta)->_length)) * 16UL));
__cuda_local_var_39429_18_non_const_threads = 102U;
(cudaConfigureCall((((void)((__T216 = ((gpu->sim).blocks)) , (void)((((__T215.x) = __T216) , (void)((__T215.y) = 1U)) , ((__T215.z) = 1U)))) , __T215), (((void)((((__T217.x) = __cuda_local_var_39429_18_non_const_threads) , (void)((__T217.y) = 1U)) , (void)((__T217.z) = 1U))) , __T217), (((unsigned long)((2U * __cuda_local_var_39429_18_non_const_threads) * 5U)) * 16UL), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z22kUpdateBsplines_kernelv());
{  enum cudaError __cuda_local_var_39431_19_non_const_status;
# 391 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39431_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39431_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T233;
 struct _ZSs __T234;
 struct _ZSs __T235;
 struct _ZSs __T236;
 _ZSt6string __T237;
...
{  enum cudaError __cuda_local_var_39434_19_non_const_status;
# 394 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39434_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39434_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T241;
 struct _ZSs __T242;
 struct _ZSs __T243;
 struct _ZSs __T244;
 _ZSt6string __T245;
...
{  enum cudaError __cuda_local_var_39436_19_non_const_status;
# 396 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39436_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39436_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T249;
 struct _ZSs __T250;
 struct _ZSs __T251;
 struct _ZSs __T252;
 _ZSt6string __T253;
...
{  enum cudaError __cuda_local_var_39439_19_non_const_status;
# 399 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39439_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39439_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T257;
 struct _ZSs __T258;
 struct _ZSs __T259;
 struct _ZSs __T260;
 _ZSt6string __T261;
...
{  enum cudaError __cuda_local_var_39442_19_non_const_status;
# 402 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39442_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39442_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T265;
 struct _ZSs __T266;
 struct _ZSs __T267;
 struct _ZSs __T268;
 _ZSt6string __T269;
...
#include "kCalculatePME.compute_13.cudafe1.stub.c"
