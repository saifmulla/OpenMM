...
# 1 "kVerletUpdate.compute_11.cudafe1.stub.c"
...
# 1 "kVerletUpdate.compute_11.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T284) {  __nv_dummy_param_ref(__T284); __cudaRegisterEntry(__T284, ((void ( *)(float))kSelectVerletStepSize_kernel), _Z28kSelectVerletStepSize_kernelf, 192); __cudaRegisterEntry(__T284, ((void ( *)(void))kVerletUpdatePart2CM_kernel), _Z27kVerletUpdatePart2CM_kernelv, 192); __cudaRegisterEntry(__T284, ((void ( *)(void))kVerletUpdatePart1CM_kernel), _Z27kVerletUpdatePart1CM_kernelv, 192); __cudaRegisterEntry(__T284, ((void ( *)(void))kVerletUpdatePart2_kernel), _Z25kVerletUpdatePart2_kernelv, 192); __cudaRegisterEntry(__T284, ((void ( *)(void))kVerletUpdatePart1_kernel), _Z25kVerletUpdatePart1_kernelv, 192); __cudaRegisterVariable(__T284, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
