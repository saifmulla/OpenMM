# 1 "kCalculateAndersenThermostat.compute_12.cudafe1.gpu"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kCalculateAndersenThermostat.compute_12.cudafe1.gpu"
...
__syncthreads();
# 60 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateAndersenThermostat.cu"
__cuda_local_var_38901_11_non_const_collisionProbability = ((1.0F) - ((__T226 = ((-(cSim.collisionFrequency)) * (((cSim.pStepSize)[0]).y))) , (expf(__T226))));
# 61 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateAndersenThermostat.cu"
__cuda_local_var_38902_11_non_const_randomRange = ((__T227 = ( fdividef(__cuda_local_var_38901_11_non_const_collisionProbability , (sqrtf((2.0F)))))) , (erff(__T227)));
