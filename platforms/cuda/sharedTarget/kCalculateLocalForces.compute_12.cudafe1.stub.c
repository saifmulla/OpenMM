...
# 1 "kCalculateLocalForces.compute_12.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T237) {  __nv_dummy_param_ref(__T237); __cudaRegisterEntry(__T237, ((void ( *)(void))kCalculateLocalForces_kernel), _Z28kCalculateLocalForces_kernelv, 384); __cudaRegisterVariable(__T237, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
