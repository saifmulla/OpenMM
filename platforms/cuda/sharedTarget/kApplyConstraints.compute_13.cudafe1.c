# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kApplyConstraints.cu"
...
# 57 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudaKernels.h"
extern void _Z11kApplyShakeP11_gpuContext(gpuContext);
extern void _Z10kApplyCCMAP11_gpuContext(gpuContext);
extern void _Z12kApplySettleP11_gpuContext(gpuContext);
# 55 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kApplyConstraints.cu"
extern void _Z17kApplyConstraintsP11_gpuContext(gpuContext);
...
static void __sti___36_kApplyConstraints_compute_20_cpp1_ii_964f8538(void) __attribute__((__constructor__));
...
# 55 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kApplyConstraints.cu"
void _Z17kApplyConstraintsP11_gpuContext( gpuContext gpu)
{  struct dim3 __T20;
 unsigned __T21;
 struct dim3 __T22;
 unsigned __T23;
 ...
 struct dim3 __T26;
 unsigned __T27;
# 57 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kApplyConstraints.cu"
(cudaConfigureCall((((void)((__T21 = ((gpu->sim).blocks)) , (void)((((__T20.x) = __T21) , (void)((__T20.y) = 1U)) , ((__T20.z) = 1U)))) , __T20), (((void)((__T23 = ((gpu->sim).update_threads_per_block)) , (void)((((__T22.x) = __T23) , (void)((__T22.y) = 1U)) , ((__T22.z) = 1U)))) , __T22), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z26kPrepareConstraints_kerneliP6float4S0_S0_((gpu->natoms), ((gpu->sim).pOldPosq), ((gpu->sim).pPosq), ((gpu->sim).pPosqP)));
{  enum cudaError __cuda_local_var_39223_19_non_const_status;
# 58 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kApplyConstraints.cu"
__cuda_local_var_39223_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39223_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T28;
 struct _ZSs __T29;
 struct _ZSs __T210;
 struct _ZSs __T211;
 _ZSt6string __T212;
 struct _ZSaIcE __T213;
 struct _ZN6OpenMM15OpenMMExceptionE *__T214;
 const _ZSt6string *__T215;
# 58 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kApplyConstraints.cu"
((((((__T28 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T214 = __T28) , (void)(__T215 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T29), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T210), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T211), ((_ZNSsC1EPKcRKSaIcE((&__T212), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T213))) , (((const struct _ZSaIcE *)&__T213))))) , (((const struct _ZSs *)&__T212))), (cudaGetErrorString(__cuda_local_var_39223_19_non_const_status)))) , (((const struct _ZSs *)&__T211))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T210))), ((const char *)"kPrepareConstraints"))) , (((const _ZSt6string *)&__T29))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T214->__b_St9exception)))) , (void)(((__T214->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T214->message)), __T215)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T29)))) , (void)(_ZNSsD1Ev((&__T210)))) , (void)(_ZNSsD1Ev((&__T211)))) , (void)(_ZNSsD1Ev((&__T212)))) , (void)(_ZNSaIcED1Ev((&__T213))); } } ;
_Z11kApplyShakeP11_gpuContext(gpu);
_Z12kApplySettleP11_gpuContext(gpu);
_Z10kApplyCCMAP11_gpuContext(gpu);
(cudaConfigureCall((((void)((__T25 = ((gpu->sim).blocks)) , (void)((((__T24.x) = __T25) , (void)((__T24.y) = 1U)) , ((__T24.z) = 1U)))) , __T24), (((void)((__T27 = ((gpu->sim).update_threads_per_block)) , (void)((((__T26.x) = __T27) , (void)((__T26.y) = 1U)) , ((__T26.z) = 1U)))) , __T26), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z25kFinishConstraints_kerneliP6float4S0_((gpu->natoms), ((gpu->sim).pPosq), ((gpu->sim).pPosqP)));
{  enum cudaError __cuda_local_var_39228_19_non_const_status;
# 63 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kApplyConstraints.cu"
__cuda_local_var_39228_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39228_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T216;
 struct _ZSs __T217;
 struct _ZSs __T218;
 struct _ZSs __T219;
 _ZSt6string __T220;
 struct _ZSaIcE __T221;
 struct _ZN6OpenMM15OpenMMExceptionE *__T222;
 const _ZSt6string *__T223;
# 63 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kApplyConstraints.cu"
((((((__T216 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T222 = __T216) , (void)(__T223 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T217), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T218), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T219), ((_ZNSsC1EPKcRKSaIcE((&__T220), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T221))) , (((const struct _ZSaIcE *)&__T221))))) , (((const struct _ZSs *)&__T220))), (cudaGetErrorString(__cuda_local_var_39228_19_non_const_status)))) , (((const struct _ZSs *)&__T219))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T218))), ((const char *)"kFinishConstraints"))) , (((const _ZSt6string *)&__T217))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T222->__b_St9exception)))) , (void)(((__T222->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T222->message)), __T223)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T217)))) , (void)(_ZNSsD1Ev((&__T218)))) , (void)(_ZNSsD1Ev((&__T219)))) , (void)(_ZNSsD1Ev((&__T220)))) , (void)(_ZNSaIcED1Ev((&__T221))); } } ; 
}
__asm__(".align 2");
# 62 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/exception" 3
...
{  _ZNSs14allocator_typeE __T231;
 struct _ZNSs4_RepE *__T232;
 const struct _ZSaIcE *__T233;
 void *__T234;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T232 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T233 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T231)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T231))))) , (void)((__builtin_expect(((long)(__T232 != ((__T234 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T234)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T232->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T232, __T233)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T231)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T235) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T236) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T236);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T237,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T237, __lhs);
_ZNSs6appendEPKcm(__T237, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T238 = (*__mem)) , (void)((*__mem) += __val)) , __T238; }



}
static void __sti___36_kApplyConstraints_compute_20_cpp1_ii_964f8538(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kApplyConstraints.compute_13.cudafe1.stub.c"
