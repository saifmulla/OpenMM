...
# 1 "kCalculateGBVIForces2.compute_13.cudafe1.stub.c"
...
# 1 "kCalculateGBVIForces2.compute_13.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T255) {  __nv_dummy_param_ref(__T255); __cudaRegisterEntry(__T255, ((void ( *)(unsigned *))kCalculateGBVIPeriodicByWarpForces2_kernel), _Z42kCalculateGBVIPeriodicByWarpForces2_kernelPj, 320); __cudaRegisterEntry(__T255, ((void ( *)(unsigned *))kCalculateGBVIPeriodicForces2_kernel), _Z36kCalculateGBVIPeriodicForces2_kernelPj, 320); __cudaRegisterEntry(__T255, ((void ( *)(unsigned *))kCalculateGBVICutoffByWarpForces2_kernel), _Z40kCalculateGBVICutoffByWarpForces2_kernelPj, 320); __cudaRegisterEntry(__T255, ((void ( *)(unsigned *))kCalculateGBVICutoffForces2_kernel), _Z34kCalculateGBVICutoffForces2_kernelPj, 320); __cudaRegisterEntry(__T255, ((void ( *)(unsigned *))kCalculateGBVIN2ByWarpForces2_kernel), _Z36kCalculateGBVIN2ByWarpForces2_kernelPj, 320); __cudaRegisterEntry(__T255, ((void ( *)(unsigned *))kCalculateGBVIN2Forces2_kernel), _Z30kCalculateGBVIN2Forces2_kernelPj, 320); __cudaRegisterVariable(__T255, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
