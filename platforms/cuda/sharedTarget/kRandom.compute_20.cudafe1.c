# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
...
# 40 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
extern void _Z12SetRandomSimP11_gpuContext(gpuContext);
...
# 47 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
extern void _Z12GetRandomSimP11_gpuContext(gpuContext);
...
# 173 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
...
static void __sti___26_kRandom_compute_20_cpp1_ii_752c8a45(void) __attribute__((__constructor__));
...
# 40 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
void _Z12SetRandomSimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_58694_17_non_const_status;
__cuda_local_var_58694_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_58694_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 47 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
void _Z12GetRandomSimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_58701_17_non_const_status;
__cuda_local_var_58701_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_58701_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 173 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
void _Z16kGenerateRandomsP11_gpuContext( gpuContext gpu)
{  struct dim3 __T214;
 unsigned __T215;
 struct dim3 __T216;
 unsigned __T217;
# 175 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
(cudaConfigureCall((((void)((__T215 = ((gpu->sim).blocks)) , (void)((((__T214.x) = __T215) , (void)((__T214.y) = 1U)) , ((__T214.z) = 1U)))) , __T214), (((void)((__T217 = ((gpu->sim).random_threads_per_block)) , (void)((((__T216.x) = __T217) , (void)((__T216.y) = 1U)) , ((__T216.z) = 1U)))) , __T216), (((unsigned long)(((gpu->sim).random_threads_per_block) * 2U)) * 12UL), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z23kGenerateRandoms_kernelv()); 
}
__asm__(".align 2");
# 62 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/exception" 3
...
{  _ZNSs14allocator_typeE __T221;
 struct _ZNSs4_RepE *__T222;
 const struct _ZSaIcE *__T223;
 void *__T224;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T222 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T223 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T221)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T221))))) , (void)((__builtin_expect(((long)(__T222 != ((__T224 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T224)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T222->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T222, __T223)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T221)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T225) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T226) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T226);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T227,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T227, __lhs);
_ZNSs6appendEPKcm(__T227, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T228 = (*__mem)) , (void)((*__mem) += __val)) , __T228; }



}
static void __sti___26_kRandom_compute_20_cpp1_ii_752c8a45(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kRandom.compute_20.cudafe1.stub.c"
