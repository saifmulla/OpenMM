# 1 "kRandom.compute_11.cudafe1.gpu"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kRandom.compute_11.cudafe1.gpu"
...
__attribute__((launch_bounds(256,1))) __attribute__((global)) extern void _Z23kGenerateRandoms_kernelv(void);
...
# 65 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
__attribute__((launch_bounds(256,1))) __attribute__((global)) void _Z23kGenerateRandoms_kernelv(void){
...
# 92 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
__cuda_local_var_40782_19_non_const_x1 = ( fdividef(((float)((__T218 = (((__cuda_local_var_40761_11_non_const_state.x) + (__cuda_local_var_40761_11_non_const_state.y)) + (__cuda_local_var_40761_11_non_const_state.w))) , (umax(__T218, ((unsigned)1))))) , (4294967296.0F)));
...
__cuda_local_var_40762_18_non_const_carry = (__cuda_local_var_40777_26_non_const_k >> 30);
# 103 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
__cuda_local_var_40793_19_non_const_x2 = ( fdividef(((float)(((__cuda_local_var_40761_11_non_const_state.x) + (__cuda_local_var_40761_11_non_const_state.y)) + (__cuda_local_var_40761_11_non_const_state.w))) , (4294967296.0F)));
...
__cuda_local_var_40762_18_non_const_carry = (__cuda_local_var_40777_26_non_const_k >> 30);
# 115 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
__cuda_local_var_40805_19_non_const_x3 = ( fdividef(((float)((__T219 = (((__cuda_local_var_40761_11_non_const_state.x) + (__cuda_local_var_40761_11_non_const_state.y)) + (__cuda_local_var_40761_11_non_const_state.w))) , (umax(__T219, ((unsigned)1))))) , (4294967296.0F)));
...
__cuda_local_var_40762_18_non_const_carry = (__cuda_local_var_40777_26_non_const_k >> 30);
# 126 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
__cuda_local_var_40816_19_non_const_x4 = ( fdividef(((float)(((__cuda_local_var_40761_11_non_const_state.x) + (__cuda_local_var_40761_11_non_const_state.y)) + (__cuda_local_var_40761_11_non_const_state.w))) , (4294967296.0F)));
...
__cuda_local_var_40762_18_non_const_carry = (__cuda_local_var_40777_26_non_const_k >> 30);
# 138 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
__cuda_local_var_40828_19_non_const_x5 = ( fdividef(((float)((__T220 = (((__cuda_local_var_40761_11_non_const_state.x) + (__cuda_local_var_40761_11_non_const_state.y)) + (__cuda_local_var_40761_11_non_const_state.w))) , (umax(__T220, ((unsigned)1))))) , (4294967296.0F)));
...
__cuda_local_var_40762_18_non_const_carry = (__cuda_local_var_40777_26_non_const_k >> 30);
# 149 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kRandom.cu"
__cuda_local_var_40839_19_non_const_x6 = ( fdividef(((float)(((__cuda_local_var_40761_11_non_const_state.x) + (__cuda_local_var_40761_11_non_const_state.y)) + (__cuda_local_var_40761_11_non_const_state.w))) , (4294967296.0F)));
