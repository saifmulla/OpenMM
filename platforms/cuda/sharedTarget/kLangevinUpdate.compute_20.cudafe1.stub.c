...
# 1 "kLangevinUpdate.compute_20.cudafe1.stub.c"
...
# 1 "kLangevinUpdate.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2110) {  __nv_dummy_param_ref(__T2110); __cudaRegisterEntry(__T2110, ((void ( *)(void))kSetVelocitiesFromPositions_kernel), _Z34kSetVelocitiesFromPositions_kernelv, 768); __cudaRegisterEntry(__T2110, ((void ( *)(float))kSelectLangevinStepSize_kernel), _Z30kSelectLangevinStepSize_kernelf, 768); __cudaRegisterEntry(__T2110, ((void ( *)(void))kLangevinUpdatePart2CM_kernel), _Z29kLangevinUpdatePart2CM_kernelv, 768); __cudaRegisterEntry(__T2110, ((void ( *)(void))kLangevinUpdatePart1CM_kernel), _Z29kLangevinUpdatePart1CM_kernelv, 768); __cudaRegisterEntry(__T2110, ((void ( *)(void))kLangevinUpdatePart2_kernel), _Z27kLangevinUpdatePart2_kernelv, 768); __cudaRegisterEntry(__T2110, ((void ( *)(void))kLangevinUpdatePart1_kernel), _Z27kLangevinUpdatePart1_kernelv, 768); __cudaRegisterVariable(__T2110, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
