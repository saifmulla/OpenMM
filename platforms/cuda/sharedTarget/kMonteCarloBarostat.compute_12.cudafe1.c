...
{  enum cudaError __cuda_local_var_38930_19_non_const_status;
# 89 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kMonteCarloBarostat.cu"
__cuda_local_var_38930_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_38930_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T28;
 struct _ZSs __T29;
 struct _ZSs __T210;
 struct _ZSs __T211;
 _ZSt6string __T212;
...
#include "kMonteCarloBarostat.compute_12.cudafe1.stub.c"
