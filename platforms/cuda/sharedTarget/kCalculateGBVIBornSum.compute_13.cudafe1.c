# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
...
struct _Z10CUDAStreamI4int4E; struct _Z10CUDAStreamI4int2E; struct _Z10CUDAStreamIiE; struct _Z10CUDAStreamImE; struct _Z10CUDAStreamI5uint4E;
...
struct Atom;
# 65 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudatypes.h"
struct _Z10CUDAStreamI6float4E; struct _Z10CUDAStreamIfE; struct _Z10CUDAStreamI6float2E; struct _Z10CUDAStreamIjE;
...
# 58 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
extern void _Z26SetCalculateGBVIBornSumSimP11_gpuContext(gpuContext);
...
# 65 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
extern void _Z26GetCalculateGBVIBornSumSimP11_gpuContext(gpuContext);
...
# 237 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
extern void _Z18kReduceGBVIBornSumP11_gpuContext(gpuContext);
# 245 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
static int _Z15isNanOrInfinityf(float);



extern void _Z10kPrintGBVIP11_gpuContextSsiP8_IO_FILE(gpuContext, _ZSt6string *, int, FILE *);
# 305 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
...
static void __sti___40_kCalculateGBVIBornSum_compute_20_cpp1_ii_466b533c(void) __attribute__((__constructor__));
...
# 58 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
void _Z26SetCalculateGBVIBornSumSimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_41002_17_non_const_status;
__cuda_local_var_41002_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41002_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 65 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
void _Z26GetCalculateGBVIBornSumSimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_41009_17_non_const_status;
__cuda_local_var_41009_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_41009_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 237 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
void _Z18kReduceGBVIBornSumP11_gpuContext( gpuContext gpu)
{  struct dim3 __T214;
 unsigned __T215;
 struct dim3 __T216;
# 240 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
(cudaConfigureCall((((void)((__T215 = ((gpu->sim).blocks)) , (void)((((__T214.x) = __T215) , (void)((__T214.y) = 1U)) , ((__T214.z) = 1U)))) , __T214), (((void)((((__T216.x) = 384U) , (void)((__T216.y) = 1U)) , (void)((__T216.z) = 1U))) , __T216), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z25kReduceGBVIBornSum_kernelv());
(gpu->bRecalculateBornRadii) = ((char)0);
{  enum cudaError __cuda_local_var_42407_19_non_const_status;
# 242 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
__cuda_local_var_42407_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_42407_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T217;
 struct _ZSs __T218;
 struct _ZSs __T219;
 struct _ZSs __T220;
 _ZSt6string __T221;
...
# 242 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
((((((__T217 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T223 = __T217) , (void)(__T224 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T218), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T219), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T220), ((_ZNSsC1EPKcRKSaIcE((&__T221), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T222))) , (((const struct _ZSaIcE *)&__T222))))) , (((const struct _ZSs *)&__T221))), (cudaGetErrorString(__cuda_local_var_42407_19_non_const_status)))) , (((const struct _ZSs *)&__T220))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T219))), ((const char *)"kReduceGBVIBornSum"))) , (((const _ZSt6string *)&__T218))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T223->__b_St9exception)))) , (void)(((__T223->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T223->message)), __T224)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T218)))) , (void)(_ZNSsD1Ev((&__T219)))) , (void)(_ZNSsD1Ev((&__T220)))) , (void)(_ZNSsD1Ev((&__T221)))) , (void)(_ZNSaIcED1Ev((&__T222))); } } ; 
}

static int _Z15isNanOrInfinityf( float number) {
return (((number != number) || (number == ((__builtin_huge_valf())))) || (number == (-((__builtin_huge_valf()))))) ? 1 : 0;
}

void _Z10kPrintGBVIP11_gpuContextSsiP8_IO_FILE( gpuContext gpu,  _ZSt6string *callId,  int call,  FILE *log)
{
# 259 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
 int __cuda_local_var_42424_9_non_const_printOnlyOnNan;
 int __cuda_local_var_42425_9_non_const_foundNan;
# 252 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
(*((void (**)(struct _Z10CUDAStreamI6float4E *const))((((gpu->psGBVIData)->__b_15SoADeviceObject).__vptr) + 3)))((gpu->psGBVIData));
(*((void (**)(struct _Z10CUDAStreamIfE *const))((((gpu->psBornRadii)->__b_15SoADeviceObject).__vptr) + 3)))((gpu->psBornRadii));
(*((void (**)(struct _Z10CUDAStreamIfE *const))((((gpu->psGBVISwitchDerivative)->__b_15SoADeviceObject).__vptr) + 3)))((gpu->psGBVISwitchDerivative));
(*((void (**)(struct _Z10CUDAStreamIfE *const))((((gpu->psBornForce)->__b_15SoADeviceObject).__vptr) + 3)))((gpu->psBornForce));
(*((void (**)(struct _Z10CUDAStreamI6float4E *const))((((gpu->psPosq4)->__b_15SoADeviceObject).__vptr) + 3)))((gpu->psPosq4));
(*((void (**)(struct _Z10CUDAStreamI6float2E *const))((((gpu->psSigEps2)->__b_15SoADeviceObject).__vptr) + 3)))((gpu->psSigEps2));

__cuda_local_var_42424_9_non_const_printOnlyOnNan = 1;
__cuda_local_var_42425_9_non_const_foundNan = 0;
if (__cuda_local_var_42424_9_non_const_printOnlyOnNan) { {
 unsigned ii;
# 262 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
ii = 0U; for (; ((ii < ((gpu->sim).paddedNumberOfAtoms)) && (__cuda_local_var_42425_9_non_const_foundNan == 0)); ii++) {
__cuda_local_var_42425_9_non_const_foundNan += (_Z15isNanOrInfinityf((((gpu->psBornRadii)->_pSysData)[ii])));
__cuda_local_var_42425_9_non_const_foundNan += (_Z15isNanOrInfinityf((((gpu->psBornForce)->_pSysData)[ii])));
__cuda_local_var_42425_9_non_const_foundNan += (_Z15isNanOrInfinityf((((gpu->psGBVISwitchDerivative)->_pSysData)[ii])));
} }
if (__cuda_local_var_42425_9_non_const_foundNan) {
log = stderr;
(void)(fprintf(log, ((const char *)"kPrintGBVI found nan \n"), ((gpu->sim).paddedNumberOfAtoms))); {
 unsigned ii;
# 270 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
ii = 0U; for (; (ii < ((gpu->sim).paddedNumberOfAtoms)); ii++) {
(void)(fprintf(log, ((const char *)"%6d %15.7e %15.7e %15.7e\n"), ii, ((double)((((gpu->psPosq4)->_pSysData)[ii]).x)), ((double)((((gpu->psPosq4)->_pSysData)[ii]).y)), ((double)((((gpu->psPosq4)->_pSysData)[ii]).z))));
...
if ((!(__cuda_local_var_42424_9_non_const_printOnlyOnNan)) || (__cuda_local_var_42425_9_non_const_foundNan)) {
(void)(fprintf(log, ((const char *)"kPrintGBVI Cuda comp bR bF prm    sigeps2\n")));
(void)(fprintf(stderr, ((const char *)"kCalculateGBVIBornSum: bOutputBufferPerWarp=%u blks=%u th/blk=%u wu=%u %u shrd=%u\n"), ((int)(gpu->bOutputBufferPerWarp)), ((gpu->sim).nonbond_blocks), ((gpu->sim).nonbond_threads_per_block), ((gpu->sim).workUnits), ((((gpu->psWorkUnit)->_pSysStream)[0])[0]), (28UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block)))));


(void)(fprintf(stderr, ((const char *)"bR bF swd r scR ...\n"))); {
 unsigned ii;
# 284 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
ii = 0U; for (; (ii < ((gpu->sim).paddedNumberOfAtoms)); ii++) {
(void)(fprintf(log, ((const char *)"%6d %15.7e %15.7e %15.7e %15.7e %15.7e %15.7e %15.7e %15.7e %15.7e\n"), ii, ((double)(((gpu->psBornRadii)->_pSysData)[ii])), ((double)(((gpu->psBornForce)->_pSysData)[ii])), ((double)(((gpu->psGBVISwitchDerivative)->_pSysData)[ii])), ((double)((((gpu->psGBVIData)->_pSysData)[ii]).x)), ((double)((((gpu->psGBVIData)->_pSysData)[ii]).y)), ((double)((((gpu->psGBVIData)->_pSysData)[ii]).z)), ((double)((((gpu->psGBVIData)->_pSysData)[ii]).w)), ((double)((((gpu->psSigEps2)->_pSysData)[ii]).x)), ((double)((((gpu->psSigEps2)->_pSysData)[ii]).y))));
# 297 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
} }
if (__cuda_local_var_42425_9_non_const_foundNan) {
exit(0);
}
...
void _Z21kCalculateGBVIBornSumP11_gpuContext( gpuContext gpu)
{
...
{
case 0:
if (gpu->bOutputBufferPerWarp) {  struct dim3 __T225;
 unsigned __T226;
 struct dim3 __T227;
 unsigned __T228;
# 313 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
(cudaConfigureCall((((void)((__T226 = ((gpu->sim).nonbond_blocks)) , (void)((((__T225.x) = __T226) , (void)((__T225.y) = 1U)) , ((__T225.z) = 1U)))) , __T225), (((void)((__T228 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T227.x) = __T228) , (void)((__T227.y) = 1U)) , ((__T227.z) = 1U)))) , __T227), (28UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z36kCalculateGBVIN2ByWarpBornSum_kernelPj(((gpu->sim).pWorkUnit)));

} else  {  struct dim3 __T229;
 unsigned __T230;
 struct dim3 __T231;
 unsigned __T232;
# 316 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
(cudaConfigureCall((((void)((__T230 = ((gpu->sim).nonbond_blocks)) , (void)((((__T229.x) = __T230) , (void)((__T229.y) = 1U)) , ((__T229.z) = 1U)))) , __T229), (((void)((__T232 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T231.x) = __T232) , (void)((__T231.y) = 1U)) , ((__T231.z) = 1U)))) , __T231), (28UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z30kCalculateGBVIN2BornSum_kernelPj(((gpu->sim).pWorkUnit)));

}
goto __T233;

case 1:
if (gpu->bOutputBufferPerWarp) {  struct dim3 __T234;
 unsigned __T235;
 struct dim3 __T236;
 unsigned __T237;
# 323 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
(cudaConfigureCall((((void)((__T235 = ((gpu->sim).nonbond_blocks)) , (void)((((__T234.x) = __T235) , (void)((__T234.y) = 1U)) , ((__T234.z) = 1U)))) , __T234), (((void)((__T237 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T236.x) = __T237) , (void)((__T236.y) = 1U)) , ((__T236.z) = 1U)))) , __T236), (32UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z40kCalculateGBVICutoffByWarpBornSum_kernelPj(((gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T238;
 unsigned __T239;
 struct dim3 __T240;
 unsigned __T241;
# 326 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
(cudaConfigureCall((((void)((__T239 = ((gpu->sim).nonbond_blocks)) , (void)((((__T238.x) = __T239) , (void)((__T238.y) = 1U)) , ((__T238.z) = 1U)))) , __T238), (((void)((__T241 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T240.x) = __T241) , (void)((__T240.y) = 1U)) , ((__T240.z) = 1U)))) , __T240), (32UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z34kCalculateGBVICutoffBornSum_kernelPj(((gpu->sim).pInteractingWorkUnit))); }

goto __T233;

case 2:
if (gpu->bOutputBufferPerWarp) {  struct dim3 __T242;
 unsigned __T243;
 struct dim3 __T244;
 unsigned __T245;
# 332 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
(cudaConfigureCall((((void)((__T243 = ((gpu->sim).nonbond_blocks)) , (void)((((__T242.x) = __T243) , (void)((__T242.y) = 1U)) , ((__T242.z) = 1U)))) , __T242), (((void)((__T245 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T244.x) = __T245) , (void)((__T244.y) = 1U)) , ((__T244.z) = 1U)))) , __T244), (32UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z42kCalculateGBVIPeriodicByWarpBornSum_kernelPj(((gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T246;
 unsigned __T247;
 struct dim3 __T248;
 unsigned __T249;
# 335 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
(cudaConfigureCall((((void)((__T247 = ((gpu->sim).nonbond_blocks)) , (void)((((__T246.x) = __T247) , (void)((__T246.y) = 1U)) , ((__T246.z) = 1U)))) , __T246), (((void)((__T249 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T248.x) = __T249) , (void)((__T248.y) = 1U)) , ((__T248.z) = 1U)))) , __T248), (32UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z36kCalculateGBVIPeriodicBornSum_kernelPj(((gpu->sim).pInteractingWorkUnit))); }

goto __T233;

} __T233:;
{  enum cudaError __cuda_local_var_42505_19_non_const_status;
# 340 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
__cuda_local_var_42505_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_42505_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T250;
 struct _ZSs __T251;
 struct _ZSs __T252;
 struct _ZSs __T253;
 _ZSt6string __T254;
...
# 340 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
((((((__T250 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T256 = __T250) , (void)(__T257 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T251), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T252), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T253), ((_ZNSsC1EPKcRKSaIcE((&__T254), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T255))) , (((const struct _ZSaIcE *)&__T255))))) , (((const struct _ZSs *)&__T254))), (cudaGetErrorString(__cuda_local_var_42505_19_non_const_status)))) , (((const struct _ZSs *)&__T253))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T252))), ((const char *)"kCalculateGBVIBornSum"))) , (((const _ZSt6string *)&__T251))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T256->__b_St9exception)))) , (void)(((__T256->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T256->message)), __T257)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T251)))) , (void)(_ZNSsD1Ev((&__T252)))) , (void)(_ZNSsD1Ev((&__T253)))) , (void)(_ZNSsD1Ev((&__T254)))) , (void)(_ZNSaIcED1Ev((&__T255))); } } ; 
}
__asm__(".align 2");
# 62 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/exception" 3
...
(((__T259 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T260 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T258)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T258))))) , (void)((__builtin_expect(((long)(__T259 != ((__T261 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T261)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T259->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T259, __T260)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T258)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T262) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T263) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T263);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T264,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T264, __lhs);
_ZNSs6appendEPKcm(__T264, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T265 = (*__mem)) , (void)((*__mem) += __val)) , __T265; }



}
static void __sti___40_kCalculateGBVIBornSum_compute_20_cpp1_ii_466b533c(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kCalculateGBVIBornSum.compute_13.cudafe1.stub.c"
