...
# 1 "kSettle.compute_13.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T238) {  __nv_dummy_param_ref(__T238); __cudaRegisterEntry(__T238, ((void ( *)(void))kApplySettle_kernel), _Z19kApplySettle_kernelv, 256); __cudaRegisterVariable(__T238, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
