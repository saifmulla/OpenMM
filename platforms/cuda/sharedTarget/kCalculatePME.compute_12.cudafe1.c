# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
...
SM_20};
# 65 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudatypes.h"
struct _Z10CUDAStreamI4int4E; struct _Z10CUDAStreamIiE; struct _Z10CUDAStreamIjE; struct _Z10CUDAStreamImE; struct _Z10CUDAStreamI5uint4E;
...
struct _gpuContext;
# 65 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudatypes.h"
struct _Z10CUDAStreamI6float4E; struct _Z10CUDAStreamI4int2E; struct _Z10CUDAStreamI6float2E;
...
# 180 "/usr/local/cuda-5.0/include/cufft.h"
extern cufftResult cufftExecC2C(cufftHandle, cufftComplex *, cufftComplex *, int);
# 38 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
extern void _Z18SetCalculatePMESimP11_gpuContext(gpuContext);
...
# 45 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
extern void _Z18GetCalculatePMESimP11_gpuContext(gpuContext);
...
# 384 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
extern void _Z13kCalculatePMEP11_gpuContext(gpuContext);
# 22 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//bbsort.h"
...
static void __sti___32_kCalculatePME_compute_20_cpp1_ii_58ca5113(void) __attribute__((__constructor__));
...
struct _Z7textureI6float4Li1EL19cudaTextureReadMode0EE __text_var(bsplineThetaRef,bsplineThetaRef);
...
# 38 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
void _Z18SetCalculatePMESimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_38867_17_non_const_status;
__cuda_local_var_38867_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_38867_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 45 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
void _Z18GetCalculatePMESimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_38874_17_non_const_status;
__cuda_local_var_38874_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_38874_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 384 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
void _Z13kCalculatePMEP11_gpuContext( gpuContext gpu)
{  int __T214;
 struct dim3 __T215;
 unsigned __T216;
 struct dim3 __T217;
 ...
 struct dim3 __T231;
 unsigned __T232;
# 387 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
 struct cudaChannelFormatDesc __cuda_local_var_39214_27_non_const_channelDesc;

 unsigned __cuda_local_var_39216_18_non_const_threads;
# 387 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39214_27_non_const_channelDesc = ((__T214 = 32) , (cudaCreateChannelDesc(__T214, __T214, __T214, __T214, cudaChannelFormatKindFloat)));
cudaBindTexture(((size_t *)0LL), ((const struct textureReference *)(&__text_var(bsplineThetaRef,bsplineThetaRef).__b_16textureReference)), ((const void *)((gpu->psPmeBsplineTheta)->_pDevData)), ((const struct cudaChannelFormatDesc *)(&__cuda_local_var_39214_27_non_const_channelDesc)), (((unsigned long)((gpu->psPmeBsplineTheta)->_length)) * 16UL));
__cuda_local_var_39216_18_non_const_threads = 102U;
(cudaConfigureCall((((void)((__T216 = ((gpu->sim).blocks)) , (void)((((__T215.x) = __T216) , (void)((__T215.y) = 1U)) , ((__T215.z) = 1U)))) , __T215), (((void)((((__T217.x) = __cuda_local_var_39216_18_non_const_threads) , (void)((__T217.y) = 1U)) , (void)((__T217.z) = 1U))) , __T217), (((unsigned long)((2U * __cuda_local_var_39216_18_non_const_threads) * 5U)) * 16UL), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z22kUpdateBsplines_kernelv());
{  enum cudaError __cuda_local_var_39218_19_non_const_status;
# 391 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39218_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39218_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T233;
 struct _ZSs __T234;
 struct _ZSs __T235;
 struct _ZSs __T236;
 _ZSt6string __T237;
...
# 391 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
((((((__T233 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T239 = __T233) , (void)(__T240 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T234), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T235), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T236), ((_ZNSsC1EPKcRKSaIcE((&__T237), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T238))) , (((const struct _ZSaIcE *)&__T238))))) , (((const struct _ZSs *)&__T237))), (cudaGetErrorString(__cuda_local_var_39218_19_non_const_status)))) , (((const struct _ZSs *)&__T236))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T235))), ((const char *)"kUpdateBsplines"))) , (((const _ZSt6string *)&__T234))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T239->__b_St9exception)))) , (void)(((__T239->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T239->message)), __T240)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T234)))) , (void)(_ZNSsD1Ev((&__T235)))) , (void)(_ZNSsD1Ev((&__T236)))) , (void)(_ZNSsD1Ev((&__T237)))) , (void)(_ZNSaIcED1Ev((&__T238))); } } ;
_Z6bbSortI4int2EvPT_ii(((gpu->psPmeAtomGridIndex)->_pDevData), (gpu->natoms), 2);
(cudaConfigureCall((((void)((__T219 = ((gpu->sim).blocks)) , (void)((((__T218.x) = __T219) , (void)((__T218.y) = 1U)) , ((__T218.z) = 1U)))) , __T218), (((void)((__T221 = ((gpu->sim).update_threads_per_block)) , (void)((((__T220.x) = __T221) , (void)((__T220.y) = 1U)) , ((__T220.z) = 1U)))) , __T220), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z28kFindAtomRangeForGrid_kernelv());
{  enum cudaError __cuda_local_var_39221_19_non_const_status;
# 394 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39221_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39221_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T241;
 struct _ZSs __T242;
 struct _ZSs __T243;
 struct _ZSs __T244;
 _ZSt6string __T245;
 struct _ZSaIcE __T246;
 struct _ZN6OpenMM15OpenMMExceptionE *__T247;
 const _ZSt6string *__T248;
# 394 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
((((((__T241 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T247 = __T241) , (void)(__T248 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T242), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T243), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T244), ((_ZNSsC1EPKcRKSaIcE((&__T245), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T246))) , (((const struct _ZSaIcE *)&__T246))))) , (((const struct _ZSs *)&__T245))), (cudaGetErrorString(__cuda_local_var_39221_19_non_const_status)))) , (((const struct _ZSs *)&__T244))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T243))), ((const char *)"kFindAtomRangeForGrid"))) , (((const _ZSt6string *)&__T242))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T247->__b_St9exception)))) , (void)(((__T247->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T247->message)), __T248)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T242)))) , (void)(_ZNSsD1Ev((&__T243)))) , (void)(_ZNSsD1Ev((&__T244)))) , (void)(_ZNSsD1Ev((&__T245)))) , (void)(_ZNSaIcED1Ev((&__T246))); } } ;
(cudaConfigureCall((((void)((__T223 = (16U * ((gpu->sim).blocks))) , (void)((((__T222.x) = __T223) , (void)((__T222.y) = 1U)) , ((__T222.z) = 1U)))) , __T222), (((void)((((__T224.x) = 64U) , (void)((__T224.y) = 1U)) , (void)((__T224.z) = 1U))) , __T224), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z24kGridSpreadCharge_kernelv());
{  enum cudaError __cuda_local_var_39223_19_non_const_status;
# 396 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39223_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39223_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T249;
 struct _ZSs __T250;
 struct _ZSs __T251;
 struct _ZSs __T252;
 _ZSt6string __T253;
...
# 396 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
((((((__T249 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T255 = __T249) , (void)(__T256 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T250), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T251), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T252), ((_ZNSsC1EPKcRKSaIcE((&__T253), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T254))) , (((const struct _ZSaIcE *)&__T254))))) , (((const struct _ZSs *)&__T253))), (cudaGetErrorString(__cuda_local_var_39223_19_non_const_status)))) , (((const struct _ZSs *)&__T252))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T251))), ((const char *)"kGridSpreadCharge"))) , (((const _ZSt6string *)&__T250))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T255->__b_St9exception)))) , (void)(((__T255->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T255->message)), __T256)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T250)))) , (void)(_ZNSsD1Ev((&__T251)))) , (void)(_ZNSsD1Ev((&__T252)))) , (void)(_ZNSsD1Ev((&__T253)))) , (void)(_ZNSaIcED1Ev((&__T254))); } } ;
cufftExecC2C((gpu->fftplan), ((gpu->psPmeGrid)->_pDevData), ((gpu->psPmeGrid)->_pDevData), (-1));
(cudaConfigureCall((((void)((__T226 = ((gpu->sim).blocks)) , (void)((((__T225.x) = __T226) , (void)((__T225.y) = 1U)) , ((__T225.z) = 1U)))) , __T225), (((void)((__T228 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T227.x) = __T228) , (void)((__T227.y) = 1U)) , ((__T227.z) = 1U)))) , __T227), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z29kReciprocalConvolution_kernelv());
{  enum cudaError __cuda_local_var_39226_19_non_const_status;
# 399 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39226_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39226_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T257;
 struct _ZSs __T258;
 struct _ZSs __T259;
 struct _ZSs __T260;
 _ZSt6string __T261;
 struct _ZSaIcE __T262;
 struct _ZN6OpenMM15OpenMMExceptionE *__T263;
 const _ZSt6string *__T264;
# 399 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
((((((__T257 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T263 = __T257) , (void)(__T264 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T258), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T259), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T260), ((_ZNSsC1EPKcRKSaIcE((&__T261), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T262))) , (((const struct _ZSaIcE *)&__T262))))) , (((const struct _ZSs *)&__T261))), (cudaGetErrorString(__cuda_local_var_39226_19_non_const_status)))) , (((const struct _ZSs *)&__T260))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T259))), ((const char *)"kReciprocalConvolution"))) , (((const _ZSt6string *)&__T258))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T263->__b_St9exception)))) , (void)(((__T263->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T263->message)), __T264)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T258)))) , (void)(_ZNSsD1Ev((&__T259)))) , (void)(_ZNSsD1Ev((&__T260)))) , (void)(_ZNSsD1Ev((&__T261)))) , (void)(_ZNSaIcED1Ev((&__T262))); } } ;
cufftExecC2C((gpu->fftplan), ((gpu->psPmeGrid)->_pDevData), ((gpu->psPmeGrid)->_pDevData), 1);
(cudaConfigureCall((((void)((__T230 = (2U * ((gpu->sim).blocks))) , (void)((((__T229.x) = __T230) , (void)((__T229.y) = 1U)) , ((__T229.z) = 1U)))) , __T229), (((void)((__T232 = ((gpu->sim).update_threads_per_block)) , (void)((((__T231.x) = __T232) , (void)((__T231.y) = 1U)) , ((__T231.z) = 1U)))) , __T231), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z28kGridInterpolateForce_kernelv());
{  enum cudaError __cuda_local_var_39229_19_non_const_status;
# 402 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
__cuda_local_var_39229_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39229_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T265;
 struct _ZSs __T266;
 struct _ZSs __T267;
 struct _ZSs __T268;
 _ZSt6string __T269;
...
# 402 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
((((((__T265 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T271 = __T265) , (void)(__T272 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T266), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T267), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T268), ((_ZNSsC1EPKcRKSaIcE((&__T269), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T270))) , (((const struct _ZSaIcE *)&__T270))))) , (((const struct _ZSs *)&__T269))), (cudaGetErrorString(__cuda_local_var_39229_19_non_const_status)))) , (((const struct _ZSs *)&__T268))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T267))), ((const char *)"kGridInterpolateForce"))) , (((const _ZSt6string *)&__T266))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T271->__b_St9exception)))) , (void)(((__T271->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T271->message)), __T272)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T266)))) , (void)(_ZNSsD1Ev((&__T267)))) , (void)(_ZNSsD1Ev((&__T268)))) , (void)(_ZNSsD1Ev((&__T269)))) , (void)(_ZNSaIcED1Ev((&__T270))); } } ; 
}
__asm__(".align 2");
# 76 "/usr/local/cuda-5.0/include/cuda_texture_types.h"
...
((this->__b_16textureReference).channelDesc) = ((__T2379 = 32) , (cudaCreateChannelDesc(__T2379, __T2379, __T2379, __T2379, cudaChannelFormatKindFloat)));
((this->__b_16textureReference).sRGB) = 0; 
}
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN7textureI6float4Li1EL19cudaTextureReadMode0EEC2Ei21cudaTextureFilterMode22cudaTextureAddressMode */ __inline__ void _ZN7textureI6float4Li1EL19cudaTextureReadMode0EEC2Ei21cudaTextureFilterMode22cudaTextureAddressMode( struct _Z7textureI6float4Li1EL19cudaTextureReadMode0EE *const this,  int __T2380,  enum cudaTextureFilterMode __T2381,  enum cudaTextureAddressMode __T2382) {  _ZN7textureI6float4Li1EL19cudaTextureReadMode0EEC1Ei21cudaTextureFilterMode22cudaTextureAddressMode(this, __T2380, __T2381, __T2382);  }
__asm__(".align 2");
# 62 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/exception" 3
...
{  _ZNSs14allocator_typeE __T2383;
 struct _ZNSs4_RepE *__T2384;
 const struct _ZSaIcE *__T2385;
 void *__T2386;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T2384 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T2385 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T2383)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T2383))))) , (void)((__builtin_expect(((long)(__T2384 != ((__T2386 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T2386)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T2384->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T2384, __T2385)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T2383)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2387) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2388) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T2388);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T2389,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T2389, __lhs);
_ZNSs6appendEPKcm(__T2389, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T2390 = (*__mem)) , (void)((*__mem) += __val)) , __T2390; }



}
static void __sti___32_kCalculatePME_compute_20_cpp1_ii_58ca5113(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));
# 52 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculatePME.cu"
_ZN7textureI6float4Li1EL19cudaTextureReadMode0EEC1Ei21cudaTextureFilterMode22cudaTextureAddressMode((&__text_var(bsplineThetaRef,bsplineThetaRef)), 0, cudaFilterModePoint, cudaAddressModeClamp);  }

#include "kCalculatePME.compute_12.cudafe1.stub.c"
