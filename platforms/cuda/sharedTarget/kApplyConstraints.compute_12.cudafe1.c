...
{  enum cudaError __cuda_local_var_39010_19_non_const_status;
# 58 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kApplyConstraints.cu"
__cuda_local_var_39010_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39010_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T28;
 struct _ZSs __T29;
 struct _ZSs __T210;
 struct _ZSs __T211;
 _ZSt6string __T212;
...
{  enum cudaError __cuda_local_var_39015_19_non_const_status;
# 63 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kApplyConstraints.cu"
__cuda_local_var_39015_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39015_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T216;
 struct _ZSs __T217;
 struct _ZSs __T218;
 struct _ZSs __T219;
 _ZSt6string __T220;
...
#include "kApplyConstraints.compute_12.cudafe1.stub.c"
