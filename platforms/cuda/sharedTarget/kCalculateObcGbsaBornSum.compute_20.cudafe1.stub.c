...
# 1 "kCalculateObcGbsaBornSum.compute_20.cudafe1.stub.c"
...
# 1 "kCalculateObcGbsaBornSum.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2145) {  __nv_dummy_param_ref(__T2145); __cudaRegisterEntry(__T2145, ((void ( *)(void))kReduceObcGbsaBornSum_kernel), _Z28kReduceObcGbsaBornSum_kernelv, 384); __cudaRegisterEntry(__T2145, ((void ( *)(unsigned *))kCalculateObcGbsaPeriodicByWarpBornSum_kernel), _Z45kCalculateObcGbsaPeriodicByWarpBornSum_kernelPj, 768); __cudaRegisterEntry(__T2145, ((void ( *)(unsigned *))kCalculateObcGbsaPeriodicBornSum_kernel), _Z39kCalculateObcGbsaPeriodicBornSum_kernelPj, 768); __cudaRegisterEntry(__T2145, ((void ( *)(unsigned *))kCalculateObcGbsaCutoffByWarpBornSum_kernel), _Z43kCalculateObcGbsaCutoffByWarpBornSum_kernelPj, 768); __cudaRegisterEntry(__T2145, ((void ( *)(unsigned *))kCalculateObcGbsaCutoffBornSum_kernel), _Z37kCalculateObcGbsaCutoffBornSum_kernelPj, 768); __cudaRegisterEntry(__T2145, ((void ( *)(unsigned *))kCalculateObcGbsaN2ByWarpBornSum_kernel), _Z39kCalculateObcGbsaN2ByWarpBornSum_kernelPj, 768); __cudaRegisterEntry(__T2145, ((void ( *)(unsigned *))kCalculateObcGbsaN2BornSum_kernel), _Z33kCalculateObcGbsaN2BornSum_kernelPj, 768); __cudaRegisterVariable(__T2145, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
