# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
...
extern void _Z20SetBrownianUpdateSimP11_gpuContext(gpuContext);
...
# 47 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
extern void _Z20GetBrownianUpdateSimP11_gpuContext(gpuContext);
...
# 86 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
extern void _Z20kBrownianUpdatePart1P11_gpuContext(gpuContext);
# 137 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
extern void _Z16kGenerateRandomsP11_gpuContext(gpuContext);
extern void _Z20kBrownianUpdatePart2P11_gpuContext(gpuContext);
...
static void __sti___34_kBrownianUpdate_compute_20_cpp1_ii_366e2a62(void) __attribute__((__constructor__));
...
# 40 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
void _Z20SetBrownianUpdateSimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_38883_17_non_const_status;
__cuda_local_var_38883_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_38883_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 47 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
void _Z20GetBrownianUpdateSimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_38890_17_non_const_status;
__cuda_local_var_38890_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_38890_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 86 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
void _Z20kBrownianUpdatePart1P11_gpuContext( gpuContext gpu)
{  struct dim3 __T214;
 unsigned __T215;
 struct dim3 __T216;
 unsigned __T217;
# 89 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
(cudaConfigureCall((((void)((__T215 = ((gpu->sim).blocks)) , (void)((((__T214.x) = __T215) , (void)((__T214.y) = 1U)) , ((__T214.z) = 1U)))) , __T214), (((void)((__T217 = ((gpu->sim).update_threads_per_block)) , (void)((((__T216.x) = __T217) , (void)((__T216.y) = 1U)) , ((__T216.z) = 1U)))) , __T216), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z27kBrownianUpdatePart1_kernelv());
{  enum cudaError __cuda_local_var_38931_19_non_const_status;
# 90 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
__cuda_local_var_38931_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_38931_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T218;
 struct _ZSs __T219;
 struct _ZSs __T220;
 struct _ZSs __T221;
 _ZSt6string __T222;
...
# 90 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
((((((__T218 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T224 = __T218) , (void)(__T225 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T219), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T220), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T221), ((_ZNSsC1EPKcRKSaIcE((&__T222), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T223))) , (((const struct _ZSaIcE *)&__T223))))) , (((const struct _ZSs *)&__T222))), (cudaGetErrorString(__cuda_local_var_38931_19_non_const_status)))) , (((const struct _ZSs *)&__T221))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T220))), ((const char *)"kBrownianUpdatePart1"))) , (((const _ZSt6string *)&__T219))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T224->__b_St9exception)))) , (void)(((__T224->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T224->message)), __T225)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T219)))) , (void)(_ZNSsD1Ev((&__T220)))) , (void)(_ZNSsD1Ev((&__T221)))) , (void)(_ZNSsD1Ev((&__T222)))) , (void)(_ZNSaIcED1Ev((&__T223))); } } ; 
}
# 138 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
void _Z20kBrownianUpdatePart2P11_gpuContext( gpuContext gpu)
{  struct dim3 __T226;
 unsigned __T227;
 struct dim3 __T228;
 unsigned __T229;
# 141 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
(cudaConfigureCall((((void)((__T227 = ((gpu->sim).blocks)) , (void)((((__T226.x) = __T227) , (void)((__T226.y) = 1U)) , ((__T226.z) = 1U)))) , __T226), (((void)((__T229 = ((gpu->sim).update_threads_per_block)) , (void)((((__T228.x) = __T229) , (void)((__T228.y) = 1U)) , ((__T228.z) = 1U)))) , __T228), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z27kBrownianUpdatePart2_kernelv());
{  enum cudaError __cuda_local_var_38983_19_non_const_status;
# 142 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kBrownianUpdate.cu"
__cuda_local_var_38983_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_38983_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T230;
 struct _ZSs __T231;
 struct _ZSs __T232;
 struct _ZSs __T233;
 _ZSt6string __T234;
...
{  _ZNSs14allocator_typeE __T238;
 struct _ZNSs4_RepE *__T239;
 const struct _ZSaIcE *__T240;
 void *__T241;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T239 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T240 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T238)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T238))))) , (void)((__builtin_expect(((long)(__T239 != ((__T241 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T241)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T239->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T239, __T240)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T238)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T242) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T243) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T243);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T244,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T244, __lhs);
_ZNSs6appendEPKcm(__T244, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T245 = (*__mem)) , (void)((*__mem) += __val)) , __T245; }



}
static void __sti___34_kBrownianUpdate_compute_20_cpp1_ii_366e2a62(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kBrownianUpdate.compute_12.cudafe1.stub.c"
