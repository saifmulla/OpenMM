...
void planCompaction( struct compactionPlan *d,  char stageOutput) {
 int __cuda_local_var_33823_9_non_const_device;

 struct cudaDeviceProp __cuda_local_var_33825_20_non_const_deviceProp;
# 188 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudaCompact.cu"
cudaGetDevice((&__cuda_local_var_33823_9_non_const_device));

cudaGetDeviceProperties((&__cuda_local_var_33825_20_non_const_deviceProp), __cuda_local_var_33823_9_non_const_device);
(d->nThreadBlocks) = ((unsigned)(16 * (__cuda_local_var_33825_20_non_const_deviceProp.multiProcessorCount)));
