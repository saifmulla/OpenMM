# 1 "kCalculateAndersenThermostat.compute_13.cudafe1.gpu"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kCalculateAndersenThermostat.compute_13.cudafe1.gpu"
...
__syncthreads();
# 60 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateAndersenThermostat.cu"
__cuda_local_var_39114_11_non_const_collisionProbability = ((1.0F) - ((__T226 = ((-(cSim.collisionFrequency)) * (((cSim.pStepSize)[0]).y))) , (expf(__T226))));
# 61 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateAndersenThermostat.cu"
__cuda_local_var_39115_11_non_const_randomRange = ((__T227 = ( fdividef(__cuda_local_var_39114_11_non_const_collisionProbability , (sqrtf((2.0F)))))) , (erff(__T227)));
