...
{
 enum cudaError __cuda_local_var_58882_17_non_const_status;
__cuda_local_var_58882_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_58882_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
{
 enum cudaError __cuda_local_var_58889_17_non_const_status;
__cuda_local_var_58889_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_58889_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
{
 enum cudaError __cuda_local_var_58896_17_non_const_status;
__cuda_local_var_58896_17_non_const_status = (_Z18cudaMemcpyToSymbolI10ExpressionILi256EEE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct _Z10ExpressionILi256EE *)&forceExpX)), ((const void *)expressionX), 2056UL, 0UL, cudaMemcpyHostToDevice));
__cuda_local_var_58896_17_non_const_status = (_Z18cudaMemcpyToSymbolI10ExpressionILi256EEE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct _Z10ExpressionILi256EE *)&forceExpY)), ((const void *)expressionY), 2056UL, 0UL, cudaMemcpyHostToDevice));
__cuda_local_var_58896_17_non_const_status = (_Z18cudaMemcpyToSymbolI10ExpressionILi256EEE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct _Z10ExpressionILi256EE *)&forceExpZ)), ((const void *)expressionZ), 2056UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_58896_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T214;
 struct _ZSs __T215;
 struct _ZSs __T216;
 _ZSt6string __T217;
...
(((((__T214 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T219 = __T214) , (void)(__T220 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T215), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T216), ((_ZNSsC1EPKcRKSaIcE((&__T217), ((const char *)"SetCustomExternalForceExpression: cudaMemcpyToSymbol failed"), ((_ZNSaIcEC1Ev((&__T218))) , (((const struct _ZSaIcE *)&__T218))))) , (((const struct _ZSs *)&__T217))), ((const char *)" "))) , (((const struct _ZSs *)&__T216))), (cudaGetErrorString(__cuda_local_var_58896_17_non_const_status)))) , (((const _ZSt6string *)&__T215))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T219->__b_St9exception)))) , (void)(((__T219->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T219->message)), __T220)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T215)))) , (void)(_ZNSsD1Ev((&__T216)))) , (void)(_ZNSsD1Ev((&__T217)))) , (void)(_ZNSaIcED1Ev((&__T218))); } ; 
}
# 317 "/usr/local/cuda-5.0/include/cuda_runtime.h"
...
{
 enum cudaError __cuda_local_var_58905_17_non_const_status;
__cuda_local_var_58905_17_non_const_status = (_Z18cudaMemcpyToSymbolI10ExpressionILi256EEE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct _Z10ExpressionILi256EE *)&energyExp)), ((const void *)expression), 2056UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_58905_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T221;
 struct _ZSs __T222;
 struct _ZSs __T223;
 _ZSt6string __T224;
...
(((((__T228 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T233 = __T228) , (void)(__T234 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T229), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T230), ((_ZNSsC1EPKcRKSaIcE((&__T231), ((const char *)"SetCustomExternalGlobalParams: cudaMemcpyToSymbol failed"), ((_ZNSaIcEC1Ev((&__T232))) , (((const struct _ZSaIcE *)&__T232))))) , (((const struct _ZSs *)&__T231))), ((const char *)" "))) , (((const struct _ZSs *)&__T230))), (cudaGetErrorString(__cuda_local_var_58912_17_non_const_status)))) , (((const _ZSt6string *)&__T229))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T233->__b_St9exception)))) , (void)(((__T233->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T233->message)), __T234)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T229)))) , (void)(_ZNSsD1Ev((&__T230)))) , (void)(_ZNSsD1Ev((&__T231)))) , (void)(_ZNSaIcED1Ev((&__T232))); } ; 
}
# 317 "/usr/local/cuda-5.0/include/cuda_runtime.h"
...
# 126 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCustomExternalForces.cu"
 int __cuda_local_var_58959_9_non_const_memoryPerThread;
 int __cuda_local_var_58960_9_non_const_maxThreads;
 int __cuda_local_var_58961_9_non_const_threads;
# 126 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCustomExternalForces.cu"
__cuda_local_var_58959_9_non_const_memoryPerThread = ((int)(((unsigned long)(((gpu->sim).customExpressionStackSize) + 9U)) * 4UL));
__cuda_local_var_58960_9_non_const_maxThreads = ((int)(((gpu->sharedMemoryPerBlock) - 16U) / ((unsigned)__cuda_local_var_58959_9_non_const_memoryPerThread)));
__cuda_local_var_58961_9_non_const_threads = ((int)(((__T293 = ((gpu->sim).localForces_threads_per_block)) , (void)(__T294 = ((__cuda_local_var_58960_9_non_const_maxThreads / 64) * 64))) , (umin(__T293, ((unsigned)__T294)))));
(cudaConfigureCall((((void)((__T296 = ((gpu->sim).blocks)) , (void)((((__T295.x) = __T296) , (void)((__T295.y) = 1U)) , ((__T295.z) = 1U)))) , __T295), (((void)((__T298 = ((unsigned)__cuda_local_var_58961_9_non_const_threads)) , (void)((((__T297.x) = __T298) , (void)((__T297.y) = 1U)) , ((__T297.z) = 1U)))) , __T297), ((size_t)(__cuda_local_var_58959_9_non_const_memoryPerThread * __cuda_local_var_58961_9_non_const_threads)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z37kCalculateCustomExternalForces_kernelv());
{  enum cudaError __cuda_local_var_58963_19_non_const_status;
# 130 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCustomExternalForces.cu"
__cuda_local_var_58963_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_58963_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T299;
 struct _ZSs __T2100;
 struct _ZSs __T2101;
 struct _ZSs __T2102;
 _ZSt6string __T2103;
...
#include "kCalculateCustomExternalForces.compute_20.cudafe1.stub.c"
