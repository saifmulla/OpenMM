...
{
 enum cudaError __cuda_local_var_58880_17_non_const_status;
__cuda_local_var_58880_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_58880_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
{
 enum cudaError __cuda_local_var_58887_17_non_const_status;
__cuda_local_var_58887_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_58887_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
{
 enum cudaError __cuda_local_var_58894_17_non_const_status;
__cuda_local_var_58894_17_non_const_status = (_Z18cudaMemcpyToSymbolI10ExpressionILi256EEE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct _Z10ExpressionILi256EE *)&forceExp)), ((const void *)expression), 2056UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_58894_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T214;
 struct _ZSs __T215;
 struct _ZSs __T216;
 _ZSt6string __T217;
...
{
 enum cudaError __cuda_local_var_58901_17_non_const_status;
__cuda_local_var_58901_17_non_const_status = (_Z18cudaMemcpyToSymbolI10ExpressionILi256EEE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct _Z10ExpressionILi256EE *)&energyExp)), ((const void *)expression), 2056UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_58901_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T221;
 struct _ZSs __T222;
 struct _ZSs __T223;
 _ZSt6string __T224;
...
(((((__T221 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T226 = __T221) , (void)(__T227 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T222), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T223), ((_ZNSsC1EPKcRKSaIcE((&__T224), ((const char *)"SetCustomAngleEnergyExpression: cudaMemcpyToSymbol failed"), ((_ZNSaIcEC1Ev((&__T225))) , (((const struct _ZSaIcE *)&__T225))))) , (((const struct _ZSs *)&__T224))), ((const char *)" "))) , (((const struct _ZSs *)&__T223))), (cudaGetErrorString(__cuda_local_var_58901_17_non_const_status)))) , (((const _ZSt6string *)&__T222))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T226->__b_St9exception)))) , (void)(((__T226->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T226->message)), __T227)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T222)))) , (void)(_ZNSsD1Ev((&__T223)))) , (void)(_ZNSsD1Ev((&__T224)))) , (void)(_ZNSaIcED1Ev((&__T225))); } ; 
}

void _Z26SetCustomAngleGlobalParamsRKSt6vectorIfSaIfEE( const struct _ZSt6vectorIfSaIfEE *paramValues)
{
 enum cudaError __cuda_local_var_58908_17_non_const_status;
__cuda_local_var_58908_17_non_const_status = (_Z18cudaMemcpyToSymbolIA8_fE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const float ( *)[8])&globalParams)), ((const void *)(_ZNKSt6vectorIfSaIfEEixEm(paramValues, 0UL))), ((_ZNKSt6vectorIfSaIfEE4sizeEv(paramValues)) * 4UL), 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_58908_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T228;
 struct _ZSs __T229;
 struct _ZSs __T230;
 _ZSt6string __T231;
...
# 159 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCustomAngleForces.cu"
 int __cuda_local_var_58992_9_non_const_memoryPerThread;
 int __cuda_local_var_58993_9_non_const_maxThreads;
 int __cuda_local_var_58994_9_non_const_threads;
# 159 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCustomAngleForces.cu"
__cuda_local_var_58992_9_non_const_memoryPerThread = ((int)(((unsigned long)(((gpu->sim).customExpressionStackSize) + 9U)) * 4UL));
__cuda_local_var_58993_9_non_const_maxThreads = ((int)(((gpu->sharedMemoryPerBlock) - 16U) / ((unsigned)__cuda_local_var_58992_9_non_const_memoryPerThread)));
__cuda_local_var_58994_9_non_const_threads = ((int)(((__T293 = ((gpu->sim).localForces_threads_per_block)) , (void)(__T294 = ((__cuda_local_var_58993_9_non_const_maxThreads / 64) * 64))) , (umin(__T293, ((unsigned)__T294)))));
(cudaConfigureCall((((void)((__T296 = ((gpu->sim).blocks)) , (void)((((__T295.x) = __T296) , (void)((__T295.y) = 1U)) , ((__T295.z) = 1U)))) , __T295), (((void)((__T298 = ((unsigned)__cuda_local_var_58994_9_non_const_threads)) , (void)((((__T297.x) = __T298) , (void)((__T297.y) = 1U)) , ((__T297.z) = 1U)))) , __T297), ((size_t)(__cuda_local_var_58992_9_non_const_memoryPerThread * __cuda_local_var_58994_9_non_const_threads)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z34kCalculateCustomAngleForces_kernelv());
{  enum cudaError __cuda_local_var_58996_19_non_const_status;
# 163 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCustomAngleForces.cu"
__cuda_local_var_58996_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_58996_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T299;
 struct _ZSs __T2100;
 struct _ZSs __T2101;
 struct _ZSs __T2102;
 _ZSt6string __T2103;
...
#include "kCalculateCustomAngleForces.compute_20.cudafe1.stub.c"
