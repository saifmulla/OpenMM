# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
...
# 34 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudaKernels.h"
extern void _Z24kCalculateObcGbsaBornSumP11_gpuContext(gpuContext);
extern void _Z21kReduceObcGbsaBornSumP11_gpuContext(gpuContext);
extern void _Z21kCalculateGBVIBornSumP11_gpuContext(gpuContext);
extern void _Z18kReduceGBVIBornSumP11_gpuContext(gpuContext);
# 53 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
extern void _Z33SetCalculateCDLJObcGbsaForces1SimP11_gpuContext(gpuContext);
...
# 61 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
extern void _Z33GetCalculateCDLJObcGbsaForces1SimP11_gpuContext(gpuContext);
...
# 124 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
extern void _Z28kCalculateCDLJObcGbsaForces1P11_gpuContext(gpuContext);
...
static void __sti___47_kCalculateCDLJObcGbsaForces1_compute_20_cpp1_ii_ed7be9d8(void) __attribute__((__constructor__));
...
# 53 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
void _Z33SetCalculateCDLJObcGbsaForces1SimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_38960_17_non_const_status;
__cuda_local_var_38960_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_38960_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 61 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
void _Z33GetCalculateCDLJObcGbsaForces1SimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_38968_17_non_const_status;
__cuda_local_var_38968_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_38968_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 124 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
void _Z28kCalculateCDLJObcGbsaForces1P11_gpuContext( gpuContext gpu)
{
...
{  struct dim3 __T214;
 ...
 struct dim3 __T234;
 unsigned __T235;
# 130 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
case 0:

if (gpu->bRecalculateBornRadii)
{
if (gpu->bIncludeGBVI) {
_Z21kCalculateGBVIBornSumP11_gpuContext(gpu);
_Z18kReduceGBVIBornSumP11_gpuContext(gpu);
} else  {
_Z24kCalculateObcGbsaBornSumP11_gpuContext(gpu);
_Z21kReduceObcGbsaBornSumP11_gpuContext(gpu);
}

}

if (gpu->bOutputBufferPerWarp) {  struct dim3 __T236;
 unsigned __T237;
 struct dim3 __T238;
 unsigned __T239;
# 145 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
(cudaConfigureCall((((void)((__T237 = ((gpu->sim).nonbond_blocks)) , (void)((((__T236.x) = __T237) , (void)((__T236.y) = 1U)) , ((__T236.z) = 1U)))) , __T236), (((void)((__T239 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T238.x) = __T239) , (void)((__T238.y) = 1U)) , ((__T238.z) = 1U)))) , __T238), (44UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z43kCalculateCDLJObcGbsaN2ByWarpForces1_kernelPj(((gpu->sim).pWorkUnit))); } else  {  struct dim3 __T240;
 unsigned __T241;
 struct dim3 __T242;
 unsigned __T243;
# 148 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
(cudaConfigureCall((((void)((__T241 = ((gpu->sim).nonbond_blocks)) , (void)((((__T240.x) = __T241) , (void)((__T240.y) = 1U)) , ((__T240.z) = 1U)))) , __T240), (((void)((__T243 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T242.x) = __T243) , (void)((__T242.y) = 1U)) , ((__T242.z) = 1U)))) , __T242), (44UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z37kCalculateCDLJObcGbsaN2Forces1_kernelPj(((gpu->sim).pWorkUnit))); }


{  enum cudaError __cuda_local_var_43267_27_non_const_status;
# 151 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
__cuda_local_var_43267_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_43267_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T244;
 struct _ZSs __T245;
 struct _ZSs __T246;
 struct _ZSs __T247;
 _ZSt6string __T248;
...
# 151 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
((((((__T244 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T250 = __T244) , (void)(__T251 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T245), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T246), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T247), ((_ZNSsC1EPKcRKSaIcE((&__T248), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T249))) , (((const struct _ZSaIcE *)&__T249))))) , (((const struct _ZSs *)&__T248))), (cudaGetErrorString(__cuda_local_var_43267_27_non_const_status)))) , (((const struct _ZSs *)&__T247))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T246))), ((const char *)"kCalculateCDLJObcGbsaN2Forces1"))) , (((const _ZSt6string *)&__T245))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T250->__b_St9exception)))) , (void)(((__T250->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T250->message)), __T251)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T245)))) , (void)(_ZNSsD1Ev((&__T246)))) , (void)(_ZNSsD1Ev((&__T247)))) , (void)(_ZNSsD1Ev((&__T248)))) , (void)(_ZNSaIcED1Ev((&__T249))); } } ;
goto __T252;

case 1:

(cudaConfigureCall((((void)((__T215 = ((((gpu->psGridBoundingBox)->_length) + 63U) / 64U)) , (void)((((__T214.x) = __T215) , (void)((__T214.y) = 1U)) , ((__T214.z) = 1U)))) , __T214), (((void)((((__T216.x) = 64U) , (void)((__T216.y) = 1U)) , (void)((__T216.z) = 1U))) , __T216), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z29kFindBlockBoundsCutoff_kernelv());
{  enum cudaError __cuda_local_var_43273_27_non_const_status;
# 157 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
__cuda_local_var_43273_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_43273_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T253;
 struct _ZSs __T254;
 struct _ZSs __T255;
 struct _ZSs __T256;
 _ZSt6string __T257;
...
# 157 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
((((((__T253 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T259 = __T253) , (void)(__T260 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T254), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T255), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T256), ((_ZNSsC1EPKcRKSaIcE((&__T257), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T258))) , (((const struct _ZSaIcE *)&__T258))))) , (((const struct _ZSs *)&__T257))), (cudaGetErrorString(__cuda_local_var_43273_27_non_const_status)))) , (((const struct _ZSs *)&__T256))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T255))), ((const char *)"kFindBlockBoundsCutoff"))) , (((const _ZSt6string *)&__T254))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T259->__b_St9exception)))) , (void)(((__T259->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T259->message)), __T260)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T254)))) , (void)(_ZNSsD1Ev((&__T255)))) , (void)(_ZNSsD1Ev((&__T256)))) , (void)(_ZNSsD1Ev((&__T257)))) , (void)(_ZNSaIcED1Ev((&__T258))); } } ;
(cudaConfigureCall((((void)((__T218 = ((gpu->sim).interaction_blocks)) , (void)((((__T217.x) = __T218) , (void)((__T217.y) = 1U)) , ((__T217.z) = 1U)))) , __T217), (((void)((__T220 = ((gpu->sim).interaction_threads_per_block)) , (void)((((__T219.x) = __T220) , (void)((__T219.y) = 1U)) , ((__T219.z) = 1U)))) , __T219), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z40kFindBlocksWithInteractionsCutoff_kernelv());
{  enum cudaError __cuda_local_var_43275_27_non_const_status;
# 159 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
__cuda_local_var_43275_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_43275_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T261;
 struct _ZSs __T262;
 struct _ZSs __T263;
 struct _ZSs __T264;
 _ZSt6string __T265;
...
# 159 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
((((((__T261 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T267 = __T261) , (void)(__T268 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T262), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T263), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T264), ((_ZNSsC1EPKcRKSaIcE((&__T265), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T266))) , (((const struct _ZSaIcE *)&__T266))))) , (((const struct _ZSs *)&__T265))), (cudaGetErrorString(__cuda_local_var_43275_27_non_const_status)))) , (((const struct _ZSs *)&__T264))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T263))), ((const char *)"kFindBlocksWithInteractionsCutoff"))) , (((const _ZSt6string *)&__T262))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T267->__b_St9exception)))) , (void)(((__T267->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T267->message)), __T268)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T262)))) , (void)(_ZNSsD1Ev((&__T263)))) , (void)(_ZNSsD1Ev((&__T264)))) , (void)(_ZNSsD1Ev((&__T265)))) , (void)(_ZNSaIcED1Ev((&__T266))); } } ;
...
(cudaConfigureCall((((void)((__T222 = ((gpu->sim).nonbond_blocks)) , (void)((((__T221.x) = __T222) , (void)((__T221.y) = 1U)) , ((__T221.z) = 1U)))) , __T221), (((void)((__T224 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T223.x) = __T224) , (void)((__T223.y) = 1U)) , ((__T223.z) = 1U)))) , __T223), (4UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z42kFindInteractionsWithinBlocksCutoff_kernelPj(((gpu->sim).pInteractingWorkUnit)));
...
if (gpu->bOutputBufferPerWarp) {  struct dim3 __T269;
 unsigned __T270;
 struct dim3 __T271;
 unsigned __T272;
# 176 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
(cudaConfigureCall((((void)((__T270 = ((gpu->sim).nonbond_blocks)) , (void)((((__T269.x) = __T270) , (void)((__T269.y) = 1U)) , ((__T269.z) = 1U)))) , __T269), (((void)((__T272 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T271.x) = __T272) , (void)((__T271.y) = 1U)) , ((__T271.z) = 1U)))) , __T271), (48UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z47kCalculateCDLJObcGbsaCutoffByWarpForces1_kernelPj(((gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T273;
 unsigned __T274;
 struct dim3 __T275;
 unsigned __T276;
# 179 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
(cudaConfigureCall((((void)((__T274 = ((gpu->sim).nonbond_blocks)) , (void)((((__T273.x) = __T274) , (void)((__T273.y) = 1U)) , ((__T273.z) = 1U)))) , __T273), (((void)((__T276 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T275.x) = __T276) , (void)((__T275.y) = 1U)) , ((__T275.z) = 1U)))) , __T275), (48UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z41kCalculateCDLJObcGbsaCutoffForces1_kernelPj(((gpu->sim).pInteractingWorkUnit))); }



{  enum cudaError __cuda_local_var_43299_27_non_const_status;
# 183 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
__cuda_local_var_43299_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_43299_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T277;
 struct _ZSs __T278;
 struct _ZSs __T279;
 struct _ZSs __T280;
 _ZSt6string __T281;
...
# 183 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
((((((__T277 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T283 = __T277) , (void)(__T284 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T278), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T279), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T280), ((_ZNSsC1EPKcRKSaIcE((&__T281), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T282))) , (((const struct _ZSaIcE *)&__T282))))) , (((const struct _ZSs *)&__T281))), (cudaGetErrorString(__cuda_local_var_43299_27_non_const_status)))) , (((const struct _ZSs *)&__T280))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T279))), ((const char *)"kCalculateCDLJObcGbsaCutoffForces1"))) , (((const _ZSt6string *)&__T278))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T283->__b_St9exception)))) , (void)(((__T283->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T283->message)), __T284)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T278)))) , (void)(_ZNSsD1Ev((&__T279)))) , (void)(_ZNSsD1Ev((&__T280)))) , (void)(_ZNSsD1Ev((&__T281)))) , (void)(_ZNSaIcED1Ev((&__T282))); } } ;
goto __T252;

case 2:

(cudaConfigureCall((((void)((__T226 = ((((gpu->psGridBoundingBox)->_length) + 63U) / 64U)) , (void)((((__T225.x) = __T226) , (void)((__T225.y) = 1U)) , ((__T225.z) = 1U)))) , __T225), (((void)((((__T227.x) = 64U) , (void)((__T227.y) = 1U)) , (void)((__T227.z) = 1U))) , __T227), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z31kFindBlockBoundsPeriodic_kernelv());
{  enum cudaError __cuda_local_var_43305_27_non_const_status;
# 189 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
__cuda_local_var_43305_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_43305_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T285;
 struct _ZSs __T286;
 struct _ZSs __T287;
 struct _ZSs __T288;
 _ZSt6string __T289;
 struct _ZSaIcE __T290;
 struct _ZN6OpenMM15OpenMMExceptionE *__T291;
 const _ZSt6string *__T292;
# 189 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
((((((__T285 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T291 = __T285) , (void)(__T292 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T286), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T287), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T288), ((_ZNSsC1EPKcRKSaIcE((&__T289), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T290))) , (((const struct _ZSaIcE *)&__T290))))) , (((const struct _ZSs *)&__T289))), (cudaGetErrorString(__cuda_local_var_43305_27_non_const_status)))) , (((const struct _ZSs *)&__T288))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T287))), ((const char *)"kFindBlockBoundsPeriodic"))) , (((const _ZSt6string *)&__T286))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T291->__b_St9exception)))) , (void)(((__T291->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T291->message)), __T292)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T286)))) , (void)(_ZNSsD1Ev((&__T287)))) , (void)(_ZNSsD1Ev((&__T288)))) , (void)(_ZNSsD1Ev((&__T289)))) , (void)(_ZNSaIcED1Ev((&__T290))); } } ;
(cudaConfigureCall((((void)((__T229 = ((gpu->sim).interaction_blocks)) , (void)((((__T228.x) = __T229) , (void)((__T228.y) = 1U)) , ((__T228.z) = 1U)))) , __T228), (((void)((__T231 = ((gpu->sim).interaction_threads_per_block)) , (void)((((__T230.x) = __T231) , (void)((__T230.y) = 1U)) , ((__T230.z) = 1U)))) , __T230), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z42kFindBlocksWithInteractionsPeriodic_kernelv());
{  enum cudaError __cuda_local_var_43307_27_non_const_status;
# 191 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
__cuda_local_var_43307_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_43307_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T293;
 struct _ZSs __T294;
 struct _ZSs __T295;
 struct _ZSs __T296;
 _ZSt6string __T297;
 struct _ZSaIcE __T298;
 struct _ZN6OpenMM15OpenMMExceptionE *__T299;
 const _ZSt6string *__T2100;
# 191 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
((((((__T293 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T299 = __T293) , (void)(__T2100 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T294), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T295), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T296), ((_ZNSsC1EPKcRKSaIcE((&__T297), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T298))) , (((const struct _ZSaIcE *)&__T298))))) , (((const struct _ZSs *)&__T297))), (cudaGetErrorString(__cuda_local_var_43307_27_non_const_status)))) , (((const struct _ZSs *)&__T296))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T295))), ((const char *)"kFindBlocksWithInteractionsPeriodic"))) , (((const _ZSt6string *)&__T294))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T299->__b_St9exception)))) , (void)(((__T299->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T299->message)), __T2100)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T294)))) , (void)(_ZNSsD1Ev((&__T295)))) , (void)(_ZNSsD1Ev((&__T296)))) , (void)(_ZNSsD1Ev((&__T297)))) , (void)(_ZNSaIcED1Ev((&__T298))); } } ;
compactStream((((const struct compactionPlan *)&(gpu->compactPlan))), ((gpu->sim).pInteractingWorkUnit), ((const unsigned *)((gpu->sim).pWorkUnit)), ((const unsigned *)((gpu->sim).pInteractionFlag)), ((size_t)((gpu->sim).workUnits)), ((gpu->sim).pInteractionCount));
(cudaConfigureCall((((void)((__T233 = ((gpu->sim).nonbond_blocks)) , (void)((((__T232.x) = __T233) , (void)((__T232.y) = 1U)) , ((__T232.z) = 1U)))) , __T232), (((void)((__T235 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T234.x) = __T235) , (void)((__T234.y) = 1U)) , ((__T234.z) = 1U)))) , __T234), (4UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z44kFindInteractionsWithinBlocksPeriodic_kernelPj(((gpu->sim).pInteractingWorkUnit)));
...
if (gpu->bOutputBufferPerWarp) {  struct dim3 __T2101;
 unsigned __T2102;
 struct dim3 __T2103;
 unsigned __T2104;
# 208 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
(cudaConfigureCall((((void)((__T2102 = ((gpu->sim).nonbond_blocks)) , (void)((((__T2101.x) = __T2102) , (void)((__T2101.y) = 1U)) , ((__T2101.z) = 1U)))) , __T2101), (((void)((__T2104 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T2103.x) = __T2104) , (void)((__T2103.y) = 1U)) , ((__T2103.z) = 1U)))) , __T2103), (48UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z49kCalculateCDLJObcGbsaPeriodicByWarpForces1_kernelPj(((gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T2105;
 unsigned __T2106;
 struct dim3 __T2107;
 unsigned __T2108;
# 211 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
(cudaConfigureCall((((void)((__T2106 = ((gpu->sim).nonbond_blocks)) , (void)((((__T2105.x) = __T2106) , (void)((__T2105.y) = 1U)) , ((__T2105.z) = 1U)))) , __T2105), (((void)((__T2108 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T2107.x) = __T2108) , (void)((__T2107.y) = 1U)) , ((__T2107.z) = 1U)))) , __T2107), (48UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z43kCalculateCDLJObcGbsaPeriodicForces1_kernelPj(((gpu->sim).pInteractingWorkUnit))); }


{  enum cudaError __cuda_local_var_43330_27_non_const_status;
# 214 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
__cuda_local_var_43330_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_43330_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T2109;
 struct _ZSs __T2110;
 struct _ZSs __T2111;
 struct _ZSs __T2112;
 _ZSt6string __T2113;
 struct _ZSaIcE __T2114;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2115;
 const _ZSt6string *__T2116;
# 214 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJObcGbsaForces1.cu"
((((((__T2109 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2115 = __T2109) , (void)(__T2116 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2110), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2111), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2112), ((_ZNSsC1EPKcRKSaIcE((&__T2113), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2114))) , (((const struct _ZSaIcE *)&__T2114))))) , (((const struct _ZSs *)&__T2113))), (cudaGetErrorString(__cuda_local_var_43330_27_non_const_status)))) , (((const struct _ZSs *)&__T2112))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2111))), ((const char *)"kCalculateCDLJObcGbsaPeriodicForces1"))) , (((const _ZSt6string *)&__T2110))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2115->__b_St9exception)))) , (void)(((__T2115->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2115->message)), __T2116)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T2110)))) , (void)(_ZNSsD1Ev((&__T2111)))) , (void)(_ZNSsD1Ev((&__T2112)))) , (void)(_ZNSsD1Ev((&__T2113)))) , (void)(_ZNSaIcED1Ev((&__T2114))); } } ;
...
{  _ZNSs14allocator_typeE __T2117;
 struct _ZNSs4_RepE *__T2118;
 const struct _ZSaIcE *__T2119;
 void *__T2120;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T2118 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T2119 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T2117)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T2117))))) , (void)((__builtin_expect(((long)(__T2118 != ((__T2120 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T2120)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T2118->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T2118, __T2119)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T2117)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2121) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2122) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T2122);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T2123,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T2123, __lhs);
_ZNSs6appendEPKcm(__T2123, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T2124 = (*__mem)) , (void)((*__mem) += __val)) , __T2124; }



}
static void __sti___47_kCalculateCDLJObcGbsaForces1_compute_20_cpp1_ii_ed7be9d8(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kCalculateCDLJObcGbsaForces1.compute_11.cudafe1.stub.c"
