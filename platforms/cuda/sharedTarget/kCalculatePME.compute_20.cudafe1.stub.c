...
# 1 "kCalculatePME.compute_20.cudafe1.stub.c"
...
# 1 "kCalculatePME.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2391) {  __nv_dummy_param_ref(__T2391); __cudaRegisterEntry(__T2391, ((void ( *)(void))kGridInterpolateForce_kernel), _Z28kGridInterpolateForce_kernelv, 1024); __cudaRegisterEntry(__T2391, ((void ( *)(void))kReciprocalConvolution_kernel), _Z29kReciprocalConvolution_kernelv, 1024); __cudaRegisterEntry(__T2391, ((void ( *)(void))kGridSpreadCharge_kernel), _Z24kGridSpreadCharge_kernelv, (-1)); __cudaRegisterEntry(__T2391, ((void ( *)(void))kFindAtomRangeForGrid_kernel), _Z28kFindAtomRangeForGrid_kernelv, 1024); __cudaRegisterEntry(__T2391, ((void ( *)(void))kUpdateBsplines_kernel), _Z22kUpdateBsplines_kernelv, 1024); __cudaRegisterVariable(__T2391, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterGlobalTexture(__T2391, __text_var(bsplineThetaRef,bsplineThetaRef), 1, 0, 0); }
