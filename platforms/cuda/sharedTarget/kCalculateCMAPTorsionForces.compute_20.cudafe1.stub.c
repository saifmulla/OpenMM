...
# 1 "kCalculateCMAPTorsionForces.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2104) {  __nv_dummy_param_ref(__T2104); __cudaRegisterEntry(__T2104, ((void ( *)(int, int, struct float4 *, float *, struct float4 *, struct float4 *, struct int2 *, struct int4 *, int *))kCalculateCMAPTorsionForces_kernel), _Z34kCalculateCMAPTorsionForces_kerneliiP6float4PfS0_S0_P4int2P4int4Pi, 768); }
