# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
...
# 54 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
extern void _Z29SetCalculateObcGbsaForces2SimP11_gpuContext(gpuContext);
...
# 61 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
extern void _Z29GetCalculateObcGbsaForces2SimP11_gpuContext(gpuContext);
...
# 102 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
extern void _Z24kCalculateObcGbsaForces2P11_gpuContext(gpuContext);
...
static void __sti___43_kCalculateObcGbsaForces2_compute_20_cpp1_ii_0a063b54(void) __attribute__((__constructor__));
...
# 54 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
void _Z29SetCalculateObcGbsaForces2SimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_40901_17_non_const_status;
__cuda_local_var_40901_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_40901_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 61 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
void _Z29GetCalculateObcGbsaForces2SimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_40908_17_non_const_status;
__cuda_local_var_40908_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_40908_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 102 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
void _Z24kCalculateObcGbsaForces2P11_gpuContext( gpuContext gpu)
{

switch ((int)((gpu->sim).nonbondedMethod))
{
case 0:
if (gpu->bOutputBufferPerWarp) {  struct dim3 __T214;
 unsigned __T215;
 struct dim3 __T216;
 unsigned __T217;
# 109 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
(cudaConfigureCall((((void)((__T215 = ((gpu->sim).bornForce2_blocks)) , (void)((((__T214.x) = __T215) , (void)((__T214.y) = 1U)) , ((__T214.z) = 1U)))) , __T214), (((void)((__T217 = ((gpu->sim).bornForce2_threads_per_block)) , (void)((((__T216.x) = __T217) , (void)((__T216.y) = 1U)) , ((__T216.z) = 1U)))) , __T216), (36UL * ((unsigned long)((gpu->sim).bornForce2_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z39kCalculateObcGbsaN2ByWarpForces2_kernelPj(((gpu->sim).pWorkUnit))); } else  {  struct dim3 __T218;
 unsigned __T219;
 struct dim3 __T220;
 unsigned __T221;
# 112 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
(cudaConfigureCall((((void)((__T219 = ((gpu->sim).bornForce2_blocks)) , (void)((((__T218.x) = __T219) , (void)((__T218.y) = 1U)) , ((__T218.z) = 1U)))) , __T218), (((void)((__T221 = ((gpu->sim).bornForce2_threads_per_block)) , (void)((((__T220.x) = __T221) , (void)((__T220.y) = 1U)) , ((__T220.z) = 1U)))) , __T220), (36UL * ((unsigned long)((gpu->sim).bornForce2_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z33kCalculateObcGbsaN2Forces2_kernelPj(((gpu->sim).pWorkUnit))); }

goto __T222;
case 1:
if (gpu->bOutputBufferPerWarp) {  struct dim3 __T223;
 unsigned __T224;
 struct dim3 __T225;
 unsigned __T226;
# 117 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
(cudaConfigureCall((((void)((__T224 = ((gpu->sim).bornForce2_blocks)) , (void)((((__T223.x) = __T224) , (void)((__T223.y) = 1U)) , ((__T223.z) = 1U)))) , __T223), (((void)((__T226 = ((gpu->sim).bornForce2_threads_per_block)) , (void)((((__T225.x) = __T226) , (void)((__T225.y) = 1U)) , ((__T225.z) = 1U)))) , __T225), (48UL * ((unsigned long)((gpu->sim).bornForce2_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z43kCalculateObcGbsaCutoffByWarpForces2_kernelPj(((gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T227;
 unsigned __T228;
 struct dim3 __T229;
 unsigned __T230;
# 120 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
(cudaConfigureCall((((void)((__T228 = ((gpu->sim).bornForce2_blocks)) , (void)((((__T227.x) = __T228) , (void)((__T227.y) = 1U)) , ((__T227.z) = 1U)))) , __T227), (((void)((__T230 = ((gpu->sim).bornForce2_threads_per_block)) , (void)((((__T229.x) = __T230) , (void)((__T229.y) = 1U)) , ((__T229.z) = 1U)))) , __T229), (48UL * ((unsigned long)((gpu->sim).bornForce2_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z37kCalculateObcGbsaCutoffForces2_kernelPj(((gpu->sim).pInteractingWorkUnit))); }

goto __T222;
case 2:
if (gpu->bOutputBufferPerWarp) {  struct dim3 __T231;
 unsigned __T232;
 struct dim3 __T233;
 unsigned __T234;
# 125 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
(cudaConfigureCall((((void)((__T232 = ((gpu->sim).bornForce2_blocks)) , (void)((((__T231.x) = __T232) , (void)((__T231.y) = 1U)) , ((__T231.z) = 1U)))) , __T231), (((void)((__T234 = ((gpu->sim).bornForce2_threads_per_block)) , (void)((((__T233.x) = __T234) , (void)((__T233.y) = 1U)) , ((__T233.z) = 1U)))) , __T233), (48UL * ((unsigned long)((gpu->sim).bornForce2_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z45kCalculateObcGbsaPeriodicByWarpForces2_kernelPj(((gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T235;
 unsigned __T236;
 struct dim3 __T237;
 unsigned __T238;
# 128 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
(cudaConfigureCall((((void)((__T236 = ((gpu->sim).bornForce2_blocks)) , (void)((((__T235.x) = __T236) , (void)((__T235.y) = 1U)) , ((__T235.z) = 1U)))) , __T235), (((void)((__T238 = ((gpu->sim).bornForce2_threads_per_block)) , (void)((((__T237.x) = __T238) , (void)((__T237.y) = 1U)) , ((__T237.z) = 1U)))) , __T237), (48UL * ((unsigned long)((gpu->sim).bornForce2_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z39kCalculateObcGbsaPeriodicForces2_kernelPj(((gpu->sim).pInteractingWorkUnit))); }

goto __T222;
} __T222:;
{  enum cudaError __cuda_local_var_43091_19_non_const_status;
# 132 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
__cuda_local_var_43091_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_43091_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T239;
 struct _ZSs __T240;
 struct _ZSs __T241;
 struct _ZSs __T242;
 _ZSt6string __T243;
...
# 132 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateObcGbsaForces2.cu"
((((((__T239 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T245 = __T239) , (void)(__T246 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T240), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T241), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T242), ((_ZNSsC1EPKcRKSaIcE((&__T243), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T244))) , (((const struct _ZSaIcE *)&__T244))))) , (((const struct _ZSs *)&__T243))), (cudaGetErrorString(__cuda_local_var_43091_19_non_const_status)))) , (((const struct _ZSs *)&__T242))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T241))), ((const char *)"kCalculateObcGbsaForces2"))) , (((const _ZSt6string *)&__T240))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T245->__b_St9exception)))) , (void)(((__T245->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T245->message)), __T246)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T240)))) , (void)(_ZNSsD1Ev((&__T241)))) , (void)(_ZNSsD1Ev((&__T242)))) , (void)(_ZNSsD1Ev((&__T243)))) , (void)(_ZNSaIcED1Ev((&__T244))); } } ; 
...
static void __sti___43_kCalculateObcGbsaForces2_compute_20_cpp1_ii_0a063b54(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kCalculateObcGbsaForces2.compute_12.cudafe1.stub.c"
