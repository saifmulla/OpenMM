...
{
 enum cudaError __cuda_local_var_56800_17_non_const_status;
__cuda_local_var_56800_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_56800_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
{
 enum cudaError __cuda_local_var_56807_17_non_const_status;
__cuda_local_var_56807_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_56807_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
__cuda_local_var_57104_23_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_57104_23_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T218;
 struct _ZSs __T219;
 struct _ZSs __T220;
 struct _ZSs __T221;
 _ZSt6string __T222;
...
{  enum cudaError __cuda_local_var_57110_23_non_const_status;
# 71 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kVerletUpdate.cu"
__cuda_local_var_57110_23_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_57110_23_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T230;
 struct _ZSs __T231;
 struct _ZSs __T232;
 struct _ZSs __T233;
 _ZSt6string __T234;
...
{  enum cudaError __cuda_local_var_57120_23_non_const_status;
# 81 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kVerletUpdate.cu"
__cuda_local_var_57120_23_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_57120_23_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T242;
 struct _ZSs __T243;
 struct _ZSs __T244;
 struct _ZSs __T245;
 _ZSt6string __T246;
...
{  enum cudaError __cuda_local_var_57127_23_non_const_status;
# 88 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kVerletUpdate.cu"
__cuda_local_var_57127_23_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_57127_23_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T254;
 struct _ZSs __T255;
 struct _ZSs __T256;
 struct _ZSs __T257;
 _ZSt6string __T258;
...
{  enum cudaError __cuda_local_var_57182_19_non_const_status;
# 143 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kVerletUpdate.cu"
__cuda_local_var_57182_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_57182_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T265;
 struct _ZSs __T266;
 struct _ZSs __T267;
 struct _ZSs __T268;
 _ZSt6string __T269;
...
#include "kVerletUpdate.compute_20.cudafe1.stub.c"
