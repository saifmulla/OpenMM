...
# 1 "kCalculateObcGbsaForces2.compute_13.cudafe1.stub.c"
...
# 1 "kCalculateObcGbsaForces2.compute_13.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2133) {  __nv_dummy_param_ref(__T2133); __cudaRegisterEntry(__T2133, ((void ( *)(unsigned *))kCalculateObcGbsaPeriodicByWarpForces2_kernel), _Z45kCalculateObcGbsaPeriodicByWarpForces2_kernelPj, 320); __cudaRegisterEntry(__T2133, ((void ( *)(unsigned *))kCalculateObcGbsaPeriodicForces2_kernel), _Z39kCalculateObcGbsaPeriodicForces2_kernelPj, 320); __cudaRegisterEntry(__T2133, ((void ( *)(unsigned *))kCalculateObcGbsaCutoffByWarpForces2_kernel), _Z43kCalculateObcGbsaCutoffByWarpForces2_kernelPj, 320); __cudaRegisterEntry(__T2133, ((void ( *)(unsigned *))kCalculateObcGbsaCutoffForces2_kernel), _Z37kCalculateObcGbsaCutoffForces2_kernelPj, 320); __cudaRegisterEntry(__T2133, ((void ( *)(unsigned *))kCalculateObcGbsaN2ByWarpForces2_kernel), _Z39kCalculateObcGbsaN2ByWarpForces2_kernelPj, 320); __cudaRegisterEntry(__T2133, ((void ( *)(unsigned *))kCalculateObcGbsaN2Forces2_kernel), _Z33kCalculateObcGbsaN2Forces2_kernelPj, 320); __cudaRegisterVariable(__T2133, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
