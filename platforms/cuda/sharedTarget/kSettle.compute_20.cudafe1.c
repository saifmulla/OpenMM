...
{  enum cudaError __cuda_local_var_56997_23_non_const_status;
# 238 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kSettle.cu"
__cuda_local_var_56997_23_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_56997_23_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T218;
 struct _ZSs __T219;
 struct _ZSs __T220;
 struct _ZSs __T221;
 _ZSt6string __T222;
...
#include "kSettle.compute_20.cudafe1.stub.c"
