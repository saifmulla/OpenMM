...
{  enum cudaError __cuda_local_var_58858_19_non_const_status;
# 249 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCMAPTorsionForces.cu"
__cuda_local_var_58858_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_58858_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T24;
 struct _ZSs __T25;
 struct _ZSs __T26;
 struct _ZSs __T27;
 _ZSt6string __T28;
...
#include "kCalculateCMAPTorsionForces.compute_20.cudafe1.stub.c"
