# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
...
struct Atom;
# 65 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudatypes.h"
struct _Z10CUDAStreamI6float4E; struct _Z10CUDAStreamIfE;
...
# 56 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
extern void _Z25SetCalculateCDLJForcesSimP11_gpuContext(gpuContext);
...
# 63 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
extern void _Z25GetCalculateCDLJForcesSimP11_gpuContext(gpuContext);
...
# 132 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
extern void _Z13kCalculatePMEP11_gpuContext(gpuContext);

extern void _Z20kCalculateCDLJForcesP11_gpuContext(gpuContext);
...
static void __sti___39_kCalculateCDLJForces_compute_20_cpp1_ii_4603d722(void) __attribute__((__constructor__));
...
struct _Z7textureIfLi1EL19cudaTextureReadMode0EE __text_var(tabulatedErfcRef,tabulatedErfcRef);
...
# 56 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
void _Z25SetCalculateCDLJForcesSimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_58710_17_non_const_status;
__cuda_local_var_58710_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_58710_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 63 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
void _Z25GetCalculateCDLJForcesSimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_58717_17_non_const_status;
__cuda_local_var_58717_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_58717_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 134 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
void _Z20kCalculateCDLJForcesP11_gpuContext( gpuContext gpu)
{

switch ((int)((gpu->sim).nonbondedMethod))
{  struct dim3 __T221;
 unsigned __T222;
 struct dim3 __T223;
 struct dim3 __T224;
 ...
 unsigned __T253;
 int __T254;
# 190 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
 struct cudaChannelFormatDesc __cuda_local_var_62801_35_non_const_channelDesc;
# 139 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
case 0:
if (gpu->bOutputBufferPerWarp) {  struct dim3 __T255;
 unsigned __T256;
 struct dim3 __T257;
 unsigned __T258;
# 141 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
(cudaConfigureCall((((void)((__T256 = ((gpu->sim).nonbond_blocks)) , (void)((((__T255.x) = __T256) , (void)((__T255.y) = 1U)) , ((__T255.z) = 1U)))) , __T255), (((void)((__T258 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T257.x) = __T258) , (void)((__T257.y) = 1U)) , ((__T257.z) = 1U)))) , __T257), (36UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z35kCalculateCDLJN2ByWarpForces_kernelPj(((gpu->sim).pWorkUnit))); } else  {  struct dim3 __T259;
 unsigned __T260;
 struct dim3 __T261;
 unsigned __T262;
# 144 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
(cudaConfigureCall((((void)((__T260 = ((gpu->sim).nonbond_blocks)) , (void)((((__T259.x) = __T260) , (void)((__T259.y) = 1U)) , ((__T259.z) = 1U)))) , __T259), (((void)((__T262 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T261.x) = __T262) , (void)((__T261.y) = 1U)) , ((__T261.z) = 1U)))) , __T261), (36UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z29kCalculateCDLJN2Forces_kernelPj(((gpu->sim).pWorkUnit))); }

{  enum cudaError __cuda_local_var_62757_27_non_const_status;
# 146 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62757_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62757_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T263;
 struct _ZSs __T264;
 struct _ZSs __T265;
 struct _ZSs __T266;
 _ZSt6string __T267;
 struct _ZSaIcE __T268;
 struct _ZN6OpenMM15OpenMMExceptionE *__T269;
 const _ZSt6string *__T270;
# 146 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T263 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T269 = __T263) , (void)(__T270 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T264), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T265), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T266), ((_ZNSsC1EPKcRKSaIcE((&__T267), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T268))) , (((const struct _ZSaIcE *)&__T268))))) , (((const struct _ZSs *)&__T267))), (cudaGetErrorString(__cuda_local_var_62757_27_non_const_status)))) , (((const struct _ZSs *)&__T266))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T265))), ((const char *)"kCalculateCDLJN2Forces"))) , (((const _ZSt6string *)&__T264))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T269->__b_St9exception)))) , (void)(((__T269->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T269->message)), __T270)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T264)))) , (void)(_ZNSsD1Ev((&__T265)))) , (void)(_ZNSsD1Ev((&__T266)))) , (void)(_ZNSsD1Ev((&__T267)))) , (void)(_ZNSaIcED1Ev((&__T268))); } } ;
goto __T271;
case 1:
(cudaConfigureCall((((void)((__T222 = ((((gpu->psGridBoundingBox)->_length) + 63U) / 64U)) , (void)((((__T221.x) = __T222) , (void)((__T221.y) = 1U)) , ((__T221.z) = 1U)))) , __T221), (((void)((((__T223.x) = 64U) , (void)((__T223.y) = 1U)) , (void)((__T223.z) = 1U))) , __T223), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z29kFindBlockBoundsCutoff_kernelv());
{  enum cudaError __cuda_local_var_62761_27_non_const_status;
# 150 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62761_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62761_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T272;
 struct _ZSs __T273;
 struct _ZSs __T274;
 struct _ZSs __T275;
 _ZSt6string __T276;
 struct _ZSaIcE __T277;
 struct _ZN6OpenMM15OpenMMExceptionE *__T278;
 const _ZSt6string *__T279;
# 150 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T272 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T278 = __T272) , (void)(__T279 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T273), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T274), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T275), ((_ZNSsC1EPKcRKSaIcE((&__T276), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T277))) , (((const struct _ZSaIcE *)&__T277))))) , (((const struct _ZSs *)&__T276))), (cudaGetErrorString(__cuda_local_var_62761_27_non_const_status)))) , (((const struct _ZSs *)&__T275))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T274))), ((const char *)"kFindBlockBoundsCutoff"))) , (((const _ZSt6string *)&__T273))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T278->__b_St9exception)))) , (void)(((__T278->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T278->message)), __T279)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T273)))) , (void)(_ZNSsD1Ev((&__T274)))) , (void)(_ZNSsD1Ev((&__T275)))) , (void)(_ZNSsD1Ev((&__T276)))) , (void)(_ZNSaIcED1Ev((&__T277))); } } ;
(cudaConfigureCall((((void)((__T225 = ((gpu->sim).interaction_blocks)) , (void)((((__T224.x) = __T225) , (void)((__T224.y) = 1U)) , ((__T224.z) = 1U)))) , __T224), (((void)((__T227 = ((gpu->sim).interaction_threads_per_block)) , (void)((((__T226.x) = __T227) , (void)((__T226.y) = 1U)) , ((__T226.z) = 1U)))) , __T226), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z40kFindBlocksWithInteractionsCutoff_kernelv());
{  enum cudaError __cuda_local_var_62763_27_non_const_status;
# 152 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62763_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62763_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T280;
 struct _ZSs __T281;
 struct _ZSs __T282;
 struct _ZSs __T283;
 _ZSt6string __T284;
 struct _ZSaIcE __T285;
 struct _ZN6OpenMM15OpenMMExceptionE *__T286;
 const _ZSt6string *__T287;
# 152 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T280 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T286 = __T280) , (void)(__T287 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T281), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T282), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T283), ((_ZNSsC1EPKcRKSaIcE((&__T284), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T285))) , (((const struct _ZSaIcE *)&__T285))))) , (((const struct _ZSs *)&__T284))), (cudaGetErrorString(__cuda_local_var_62763_27_non_const_status)))) , (((const struct _ZSs *)&__T283))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T282))), ((const char *)"kFindBlocksWithInteractionsCutoff"))) , (((const _ZSt6string *)&__T281))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T286->__b_St9exception)))) , (void)(((__T286->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T286->message)), __T287)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T281)))) , (void)(_ZNSsD1Ev((&__T282)))) , (void)(_ZNSsD1Ev((&__T283)))) , (void)(_ZNSsD1Ev((&__T284)))) , (void)(_ZNSaIcED1Ev((&__T285))); } } ;
compactStream((((const struct compactionPlan *)&(gpu->compactPlan))), ((gpu->sim).pInteractingWorkUnit), ((const unsigned *)((gpu->sim).pWorkUnit)), ((const unsigned *)((gpu->sim).pInteractionFlag)), ((size_t)((gpu->sim).workUnits)), ((gpu->sim).pInteractionCount));
(cudaConfigureCall((((void)((__T229 = ((gpu->sim).nonbond_blocks)) , (void)((((__T228.x) = __T229) , (void)((__T228.y) = 1U)) , ((__T228.z) = 1U)))) , __T228), (((void)((__T231 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T230.x) = __T231) , (void)((__T230.y) = 1U)) , ((__T230.z) = 1U)))) , __T230), (4UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z42kFindInteractionsWithinBlocksCutoff_kernelPj(((gpu->sim).pInteractingWorkUnit)));

if (gpu->bOutputBufferPerWarp) {  struct dim3 __T288;
 unsigned __T289;
 struct dim3 __T290;
 unsigned __T291;
# 157 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
(cudaConfigureCall((((void)((__T289 = ((gpu->sim).nonbond_blocks)) , (void)((((__T288.x) = __T289) , (void)((__T288.y) = 1U)) , ((__T288.z) = 1U)))) , __T288), (((void)((__T291 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T290.x) = __T291) , (void)((__T290.y) = 1U)) , ((__T290.z) = 1U)))) , __T290), (48UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z39kCalculateCDLJCutoffByWarpForces_kernelPj(((gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T292;
 unsigned __T293;
 struct dim3 __T294;
 unsigned __T295;
# 160 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
(cudaConfigureCall((((void)((__T293 = ((gpu->sim).nonbond_blocks)) , (void)((((__T292.x) = __T293) , (void)((__T292.y) = 1U)) , ((__T292.z) = 1U)))) , __T292), (((void)((__T295 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T294.x) = __T295) , (void)((__T294.y) = 1U)) , ((__T294.z) = 1U)))) , __T294), (48UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z33kCalculateCDLJCutoffForces_kernelPj(((gpu->sim).pInteractingWorkUnit))); }

{  enum cudaError __cuda_local_var_62773_27_non_const_status;
# 162 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62773_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62773_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T296;
 struct _ZSs __T297;
 struct _ZSs __T298;
 struct _ZSs __T299;
 _ZSt6string __T2100;
 struct _ZSaIcE __T2101;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2102;
 const _ZSt6string *__T2103;
# 162 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T296 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2102 = __T296) , (void)(__T2103 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T297), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T298), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T299), ((_ZNSsC1EPKcRKSaIcE((&__T2100), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2101))) , (((const struct _ZSaIcE *)&__T2101))))) , (((const struct _ZSs *)&__T2100))), (cudaGetErrorString(__cuda_local_var_62773_27_non_const_status)))) , (((const struct _ZSs *)&__T299))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T298))), ((const char *)"kCalculateCDLJCutoffForces"))) , (((const _ZSt6string *)&__T297))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2102->__b_St9exception)))) , (void)(((__T2102->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2102->message)), __T2103)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T297)))) , (void)(_ZNSsD1Ev((&__T298)))) , (void)(_ZNSsD1Ev((&__T299)))) , (void)(_ZNSsD1Ev((&__T2100)))) , (void)(_ZNSaIcED1Ev((&__T2101))); } } ;
goto __T271;
case 2:
(cudaConfigureCall((((void)((__T233 = ((((gpu->psGridBoundingBox)->_length) + 63U) / 64U)) , (void)((((__T232.x) = __T233) , (void)((__T232.y) = 1U)) , ((__T232.z) = 1U)))) , __T232), (((void)((((__T234.x) = 64U) , (void)((__T234.y) = 1U)) , (void)((__T234.z) = 1U))) , __T234), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z31kFindBlockBoundsPeriodic_kernelv());
{  enum cudaError __cuda_local_var_62777_27_non_const_status;
# 166 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62777_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62777_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T2104;
 struct _ZSs __T2105;
 struct _ZSs __T2106;
 struct _ZSs __T2107;
 _ZSt6string __T2108;
 struct _ZSaIcE __T2109;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2110;
 const _ZSt6string *__T2111;
# 166 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T2104 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2110 = __T2104) , (void)(__T2111 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2105), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2106), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2107), ((_ZNSsC1EPKcRKSaIcE((&__T2108), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2109))) , (((const struct _ZSaIcE *)&__T2109))))) , (((const struct _ZSs *)&__T2108))), (cudaGetErrorString(__cuda_local_var_62777_27_non_const_status)))) , (((const struct _ZSs *)&__T2107))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2106))), ((const char *)"kFindBlockBoundsPeriodic"))) , (((const _ZSt6string *)&__T2105))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2110->__b_St9exception)))) , (void)(((__T2110->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2110->message)), __T2111)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T2105)))) , (void)(_ZNSsD1Ev((&__T2106)))) , (void)(_ZNSsD1Ev((&__T2107)))) , (void)(_ZNSsD1Ev((&__T2108)))) , (void)(_ZNSaIcED1Ev((&__T2109))); } } ;
(cudaConfigureCall((((void)((__T236 = ((gpu->sim).interaction_blocks)) , (void)((((__T235.x) = __T236) , (void)((__T235.y) = 1U)) , ((__T235.z) = 1U)))) , __T235), (((void)((__T238 = ((gpu->sim).interaction_threads_per_block)) , (void)((((__T237.x) = __T238) , (void)((__T237.y) = 1U)) , ((__T237.z) = 1U)))) , __T237), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z42kFindBlocksWithInteractionsPeriodic_kernelv());
{  enum cudaError __cuda_local_var_62779_27_non_const_status;
# 168 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62779_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62779_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T2112;
 struct _ZSs __T2113;
 struct _ZSs __T2114;
 struct _ZSs __T2115;
 _ZSt6string __T2116;
 struct _ZSaIcE __T2117;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2118;
 const _ZSt6string *__T2119;
# 168 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T2112 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2118 = __T2112) , (void)(__T2119 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2113), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2114), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2115), ((_ZNSsC1EPKcRKSaIcE((&__T2116), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2117))) , (((const struct _ZSaIcE *)&__T2117))))) , (((const struct _ZSs *)&__T2116))), (cudaGetErrorString(__cuda_local_var_62779_27_non_const_status)))) , (((const struct _ZSs *)&__T2115))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2114))), ((const char *)"kFindBlocksWithInteractionsPeriodic"))) , (((const _ZSt6string *)&__T2113))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2118->__b_St9exception)))) , (void)(((__T2118->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2118->message)), __T2119)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T2113)))) , (void)(_ZNSsD1Ev((&__T2114)))) , (void)(_ZNSsD1Ev((&__T2115)))) , (void)(_ZNSsD1Ev((&__T2116)))) , (void)(_ZNSaIcED1Ev((&__T2117))); } } ;
compactStream((((const struct compactionPlan *)&(gpu->compactPlan))), ((gpu->sim).pInteractingWorkUnit), ((const unsigned *)((gpu->sim).pWorkUnit)), ((const unsigned *)((gpu->sim).pInteractionFlag)), ((size_t)((gpu->sim).workUnits)), ((gpu->sim).pInteractionCount));
(cudaConfigureCall((((void)((__T240 = ((gpu->sim).nonbond_blocks)) , (void)((((__T239.x) = __T240) , (void)((__T239.y) = 1U)) , ((__T239.z) = 1U)))) , __T239), (((void)((__T242 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T241.x) = __T242) , (void)((__T241.y) = 1U)) , ((__T241.z) = 1U)))) , __T241), (4UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z44kFindInteractionsWithinBlocksPeriodic_kernelPj(((gpu->sim).pInteractingWorkUnit)));

if (gpu->bOutputBufferPerWarp) {  struct dim3 __T2120;
 unsigned __T2121;
 struct dim3 __T2122;
 unsigned __T2123;
# 173 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
(cudaConfigureCall((((void)((__T2121 = ((gpu->sim).nonbond_blocks)) , (void)((((__T2120.x) = __T2121) , (void)((__T2120.y) = 1U)) , ((__T2120.z) = 1U)))) , __T2120), (((void)((__T2123 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T2122.x) = __T2123) , (void)((__T2122.y) = 1U)) , ((__T2122.z) = 1U)))) , __T2122), (48UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z41kCalculateCDLJPeriodicByWarpForces_kernelPj(((gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T2124;
 unsigned __T2125;
 struct dim3 __T2126;
 unsigned __T2127;
# 176 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
(cudaConfigureCall((((void)((__T2125 = ((gpu->sim).nonbond_blocks)) , (void)((((__T2124.x) = __T2125) , (void)((__T2124.y) = 1U)) , ((__T2124.z) = 1U)))) , __T2124), (((void)((__T2127 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T2126.x) = __T2127) , (void)((__T2126.y) = 1U)) , ((__T2126.z) = 1U)))) , __T2126), (48UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z35kCalculateCDLJPeriodicForces_kernelPj(((gpu->sim).pInteractingWorkUnit))); }

{  enum cudaError __cuda_local_var_62789_27_non_const_status;
# 178 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62789_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62789_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T2128;
 struct _ZSs __T2129;
 struct _ZSs __T2130;
 struct _ZSs __T2131;
 _ZSt6string __T2132;
 struct _ZSaIcE __T2133;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2134;
 const _ZSt6string *__T2135;
# 178 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T2128 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2134 = __T2128) , (void)(__T2135 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2129), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2130), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2131), ((_ZNSsC1EPKcRKSaIcE((&__T2132), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2133))) , (((const struct _ZSaIcE *)&__T2133))))) , (((const struct _ZSs *)&__T2132))), (cudaGetErrorString(__cuda_local_var_62789_27_non_const_status)))) , (((const struct _ZSs *)&__T2131))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2130))), ((const char *)"kCalculateCDLJPeriodicForces"))) , (((const _ZSt6string *)&__T2129))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2134->__b_St9exception)))) , (void)(((__T2134->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2134->message)), __T2135)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T2129)))) , (void)(_ZNSsD1Ev((&__T2130)))) , (void)(_ZNSsD1Ev((&__T2131)))) , (void)(_ZNSsD1Ev((&__T2132)))) , (void)(_ZNSaIcED1Ev((&__T2133))); } } ;
goto __T271;
case 3:
case 4:
(cudaConfigureCall((((void)((__T244 = ((((gpu->psGridBoundingBox)->_length) + 63U) / 64U)) , (void)((((__T243.x) = __T244) , (void)((__T243.y) = 1U)) , ((__T243.z) = 1U)))) , __T243), (((void)((((__T245.x) = 64U) , (void)((__T245.y) = 1U)) , (void)((__T245.z) = 1U))) , __T245), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z31kFindBlockBoundsPeriodic_kernelv());
{  enum cudaError __cuda_local_var_62794_27_non_const_status;
# 183 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62794_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62794_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T2136;
 struct _ZSs __T2137;
 struct _ZSs __T2138;
 struct _ZSs __T2139;
 _ZSt6string __T2140;
 struct _ZSaIcE __T2141;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2142;
 const _ZSt6string *__T2143;
# 183 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T2136 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2142 = __T2136) , (void)(__T2143 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2137), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2138), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2139), ((_ZNSsC1EPKcRKSaIcE((&__T2140), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2141))) , (((const struct _ZSaIcE *)&__T2141))))) , (((const struct _ZSs *)&__T2140))), (cudaGetErrorString(__cuda_local_var_62794_27_non_const_status)))) , (((const struct _ZSs *)&__T2139))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2138))), ((const char *)"kFindBlockBoundsPeriodic"))) , (((const _ZSt6string *)&__T2137))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2142->__b_St9exception)))) , (void)(((__T2142->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2142->message)), __T2143)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T2137)))) , (void)(_ZNSsD1Ev((&__T2138)))) , (void)(_ZNSsD1Ev((&__T2139)))) , (void)(_ZNSsD1Ev((&__T2140)))) , (void)(_ZNSaIcED1Ev((&__T2141))); } } ;
(cudaConfigureCall((((void)((__T247 = ((gpu->sim).interaction_blocks)) , (void)((((__T246.x) = __T247) , (void)((__T246.y) = 1U)) , ((__T246.z) = 1U)))) , __T246), (((void)((__T249 = ((gpu->sim).interaction_threads_per_block)) , (void)((((__T248.x) = __T249) , (void)((__T248.y) = 1U)) , ((__T248.z) = 1U)))) , __T248), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z42kFindBlocksWithInteractionsPeriodic_kernelv());
{  enum cudaError __cuda_local_var_62796_27_non_const_status;
# 185 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62796_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62796_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T2144;
 struct _ZSs __T2145;
 struct _ZSs __T2146;
 struct _ZSs __T2147;
 _ZSt6string __T2148;
 struct _ZSaIcE __T2149;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2150;
 const _ZSt6string *__T2151;
# 185 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T2144 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2150 = __T2144) , (void)(__T2151 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2145), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2146), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2147), ((_ZNSsC1EPKcRKSaIcE((&__T2148), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2149))) , (((const struct _ZSaIcE *)&__T2149))))) , (((const struct _ZSs *)&__T2148))), (cudaGetErrorString(__cuda_local_var_62796_27_non_const_status)))) , (((const struct _ZSs *)&__T2147))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2146))), ((const char *)"kFindBlocksWithInteractionsPeriodic"))) , (((const _ZSt6string *)&__T2145))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2150->__b_St9exception)))) , (void)(((__T2150->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2150->message)), __T2151)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T2145)))) , (void)(_ZNSsD1Ev((&__T2146)))) , (void)(_ZNSsD1Ev((&__T2147)))) , (void)(_ZNSsD1Ev((&__T2148)))) , (void)(_ZNSaIcED1Ev((&__T2149))); } } ;
compactStream((((const struct compactionPlan *)&(gpu->compactPlan))), ((gpu->sim).pInteractingWorkUnit), ((const unsigned *)((gpu->sim).pWorkUnit)), ((const unsigned *)((gpu->sim).pInteractionFlag)), ((size_t)((gpu->sim).workUnits)), ((gpu->sim).pInteractionCount));
(cudaConfigureCall((((void)((__T251 = ((gpu->sim).nonbond_blocks)) , (void)((((__T250.x) = __T251) , (void)((__T250.y) = 1U)) , ((__T250.z) = 1U)))) , __T250), (((void)((__T253 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T252.x) = __T253) , (void)((__T252.y) = 1U)) , ((__T252.z) = 1U)))) , __T252), (4UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z44kFindInteractionsWithinBlocksPeriodic_kernelPj(((gpu->sim).pInteractingWorkUnit)));

{  enum cudaError __cuda_local_var_62800_27_non_const_status;
# 189 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62800_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62800_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T2152;
 struct _ZSs __T2153;
 struct _ZSs __T2154;
 struct _ZSs __T2155;
 _ZSt6string __T2156;
 struct _ZSaIcE __T2157;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2158;
 const _ZSt6string *__T2159;
# 189 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T2152 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2158 = __T2152) , (void)(__T2159 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2153), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2154), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2155), ((_ZNSsC1EPKcRKSaIcE((&__T2156), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2157))) , (((const struct _ZSaIcE *)&__T2157))))) , (((const struct _ZSs *)&__T2156))), (cudaGetErrorString(__cuda_local_var_62800_27_non_const_status)))) , (((const struct _ZSs *)&__T2155))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2154))), ((const char *)"kFindInteractionsWithinBlocksPeriodic"))) , (((const _ZSt6string *)&__T2153))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2158->__b_St9exception)))) , (void)(((__T2158->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2158->message)), __T2159)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T2153)))) , (void)(_ZNSsD1Ev((&__T2154)))) , (void)(_ZNSsD1Ev((&__T2155)))) , (void)(_ZNSsD1Ev((&__T2156)))) , (void)(_ZNSaIcED1Ev((&__T2157))); } } ;
__cuda_local_var_62801_35_non_const_channelDesc = ((__T254 = 32) , (cudaCreateChannelDesc(__T254, 0, 0, 0, cudaChannelFormatKindFloat)));
cudaBindTexture(((size_t *)0LL), ((const struct textureReference *)(&__text_var(tabulatedErfcRef,tabulatedErfcRef).__b_16textureReference)), ((const void *)((gpu->psTabulatedErfc)->_pDevData)), ((const struct cudaChannelFormatDesc *)(&__cuda_local_var_62801_35_non_const_channelDesc)), (((unsigned long)((gpu->psTabulatedErfc)->_length)) * 4UL));
if (gpu->bOutputBufferPerWarp) {  struct dim3 __T2160;
 unsigned __T2161;
 struct dim3 __T2162;
 unsigned __T2163;
# 193 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
(cudaConfigureCall((((void)((__T2161 = ((gpu->sim).nonbond_blocks)) , (void)((((__T2160.x) = __T2161) , (void)((__T2160.y) = 1U)) , ((__T2160.z) = 1U)))) , __T2160), (((void)((__T2163 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T2162.x) = __T2163) , (void)((__T2162.y) = 1U)) , ((__T2162.z) = 1U)))) , __T2162), (48UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z38kCalculateCDLJEwaldByWarpForces_kernelPj(((gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T2164;
 unsigned __T2165;
 struct dim3 __T2166;
 unsigned __T2167;
# 196 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
(cudaConfigureCall((((void)((__T2165 = ((gpu->sim).nonbond_blocks)) , (void)((((__T2164.x) = __T2165) , (void)((__T2164.y) = 1U)) , ((__T2164.z) = 1U)))) , __T2164), (((void)((__T2167 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T2166.x) = __T2167) , (void)((__T2166.y) = 1U)) , ((__T2166.z) = 1U)))) , __T2166), (48UL * ((unsigned long)((gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z32kCalculateCDLJEwaldForces_kernelPj(((gpu->sim).pInteractingWorkUnit))); }

{  enum cudaError __cuda_local_var_62809_27_non_const_status;
# 198 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62809_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62809_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T2168;
 struct _ZSs __T2169;
 struct _ZSs __T2170;
 struct _ZSs __T2171;
 _ZSt6string __T2172;
 struct _ZSaIcE __T2173;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2174;
 const _ZSt6string *__T2175;
# 198 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T2168 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2174 = __T2168) , (void)(__T2175 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2169), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2170), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2171), ((_ZNSsC1EPKcRKSaIcE((&__T2172), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2173))) , (((const struct _ZSaIcE *)&__T2173))))) , (((const struct _ZSs *)&__T2172))), (cudaGetErrorString(__cuda_local_var_62809_27_non_const_status)))) , (((const struct _ZSs *)&__T2171))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2170))), ((const char *)"kCalculateCDLJEwaldForces"))) , (((const _ZSt6string *)&__T2169))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2174->__b_St9exception)))) , (void)(((__T2174->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2174->message)), __T2175)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T2169)))) , (void)(_ZNSsD1Ev((&__T2170)))) , (void)(_ZNSsD1Ev((&__T2171)))) , (void)(_ZNSsD1Ev((&__T2172)))) , (void)(_ZNSaIcED1Ev((&__T2173))); } } ;
if (((int)((gpu->sim).nonbondedMethod)) == 3)
{  struct dim3 __T2176;
 unsigned __T2177;
 struct dim3 __T2178;
 unsigned __T2179;
 ...
 struct dim3 __T2182;
 unsigned __T2183;
# 201 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
(cudaConfigureCall((((void)((__T2177 = ((gpu->sim).nonbond_blocks)) , (void)((((__T2176.x) = __T2177) , (void)((__T2176.y) = 1U)) , ((__T2176.z) = 1U)))) , __T2176), (((void)((__T2179 = ((gpu->sim).nonbond_threads_per_block)) , (void)((((__T2178.x) = __T2179) , (void)((__T2178.y) = 1U)) , ((__T2178.z) = 1U)))) , __T2178), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z36kCalculateEwaldFastCosSinSums_kernelv());
{  enum cudaError __cuda_local_var_62813_31_non_const_status;
# 202 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62813_31_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62813_31_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T2184;
 struct _ZSs __T2185;
 struct _ZSs __T2186;
 struct _ZSs __T2187;
 _ZSt6string __T2188;
 struct _ZSaIcE __T2189;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2190;
 const _ZSt6string *__T2191;
# 202 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T2184 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2190 = __T2184) , (void)(__T2191 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2185), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2186), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2187), ((_ZNSsC1EPKcRKSaIcE((&__T2188), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2189))) , (((const struct _ZSaIcE *)&__T2189))))) , (((const struct _ZSs *)&__T2188))), (cudaGetErrorString(__cuda_local_var_62813_31_non_const_status)))) , (((const struct _ZSs *)&__T2187))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2186))), ((const char *)"kCalculateEwaldFastCosSinSums"))) , (((const _ZSt6string *)&__T2185))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2190->__b_St9exception)))) , (void)(((__T2190->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2190->message)), __T2191)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T2185)))) , (void)(_ZNSsD1Ev((&__T2186)))) , (void)(_ZNSsD1Ev((&__T2187)))) , (void)(_ZNSsD1Ev((&__T2188)))) , (void)(_ZNSaIcED1Ev((&__T2189))); } } ;
(cudaConfigureCall((((void)((__T2181 = ((gpu->sim).blocks)) , (void)((((__T2180.x) = __T2181) , (void)((__T2180.y) = 1U)) , ((__T2180.z) = 1U)))) , __T2180), (((void)((__T2183 = ((gpu->sim).update_threads_per_block)) , (void)((((__T2182.x) = __T2183) , (void)((__T2182.y) = 1U)) , ((__T2182.z) = 1U)))) , __T2182), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z32kCalculateEwaldFastForces_kernelv());
{  enum cudaError __cuda_local_var_62815_31_non_const_status;
# 204 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
__cuda_local_var_62815_31_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_62815_31_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T2192;
 struct _ZSs __T2193;
 struct _ZSs __T2194;
 struct _ZSs __T2195;
 _ZSt6string __T2196;
 struct _ZSaIcE __T2197;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2198;
 const _ZSt6string *__T2199;
# 204 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
((((((__T2192 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2198 = __T2192) , (void)(__T2199 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2193), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2194), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2195), ((_ZNSsC1EPKcRKSaIcE((&__T2196), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2197))) , (((const struct _ZSaIcE *)&__T2197))))) , (((const struct _ZSs *)&__T2196))), (cudaGetErrorString(__cuda_local_var_62815_31_non_const_status)))) , (((const struct _ZSs *)&__T2195))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2194))), ((const char *)"kCalculateEwaldFastForces"))) , (((const _ZSt6string *)&__T2193))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2198->__b_St9exception)))) , (void)(((__T2198->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2198->message)), __T2199)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T2193)))) , (void)(_ZNSsD1Ev((&__T2194)))) , (void)(_ZNSsD1Ev((&__T2195)))) , (void)(_ZNSsD1Ev((&__T2196)))) , (void)(_ZNSaIcED1Ev((&__T2197))); } } ;
} else  {

_Z13kCalculatePMEP11_gpuContext(gpu); }
} __T271:; 
}
__asm__(".align 2");
# 76 "/usr/local/cuda-5.0/include/cuda_texture_types.h"
...
((this->__b_16textureReference).channelDesc) = ((__T2275 = 32) , (cudaCreateChannelDesc(__T2275, 0, 0, 0, cudaChannelFormatKindFloat)));
((this->__b_16textureReference).sRGB) = 0; 
}
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN7textureIfLi1EL19cudaTextureReadMode0EEC2Ei21cudaTextureFilterMode22cudaTextureAddressMode */ __inline__ void _ZN7textureIfLi1EL19cudaTextureReadMode0EEC2Ei21cudaTextureFilterMode22cudaTextureAddressMode( struct _Z7textureIfLi1EL19cudaTextureReadMode0EE *const this,  int __T2276,  enum cudaTextureFilterMode __T2277,  enum cudaTextureAddressMode __T2278) {  _ZN7textureIfLi1EL19cudaTextureReadMode0EEC1Ei21cudaTextureFilterMode22cudaTextureAddressMode(this, __T2276, __T2277, __T2278);  }
__asm__(".align 2");
# 62 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/exception" 3
...
{  _ZNSs14allocator_typeE __T2279;
 struct _ZNSs4_RepE *__T2280;
 const struct _ZSaIcE *__T2281;
 void *__T2282;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T2280 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T2281 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T2279)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T2279))))) , (void)((__builtin_expect(((long)(__T2280 != ((__T2282 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T2282)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T2280->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T2280, __T2281)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T2279)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2283) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2284) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T2284);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T2285,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T2285, __lhs);
_ZNSs6appendEPKcm(__T2285, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T2286 = (*__mem)) , (void)((*__mem) += __val)) , __T2286; }



}
static void __sti___39_kCalculateCDLJForces_compute_20_cpp1_ii_4603d722(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));
# 70 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCDLJForces.cu"
_ZN7textureIfLi1EL19cudaTextureReadMode0EEC1Ei21cudaTextureFilterMode22cudaTextureAddressMode((&__text_var(tabulatedErfcRef,tabulatedErfcRef)), 0, cudaFilterModePoint, cudaAddressModeClamp);  }

#include "kCalculateCDLJForces.compute_20.cudafe1.stub.c"
