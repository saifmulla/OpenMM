# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//bbsort_kernel.cu"
...
static void __sti___32_bbsort_kernel_compute_20_cpp1_ii_d2f2e07f(void) __attribute__((__constructor__));
...
((this->__b_16textureReference).channelDesc) = ((__T20 = 32) , (cudaCreateChannelDesc(__T20, 0, 0, 0, cudaChannelFormatKindUnsigned)));
((this->__b_16textureReference).sRGB) = 0; 
}
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN7textureIjLi1EL19cudaTextureReadMode0EEC2Ei21cudaTextureFilterMode22cudaTextureAddressMode */ __inline__ void _ZN7textureIjLi1EL19cudaTextureReadMode0EEC2Ei21cudaTextureFilterMode22cudaTextureAddressMode( struct _Z7textureIjLi1EL19cudaTextureReadMode0EE *const this,  int __T21,  enum cudaTextureFilterMode __T22,  enum cudaTextureAddressMode __T23) {  _ZN7textureIjLi1EL19cudaTextureReadMode0EEC1Ei21cudaTextureFilterMode22cudaTextureAddressMode(this, __T21, __T22, __T23);  }
static void __sti___32_bbsort_kernel_compute_20_cpp1_ii_d2f2e07f(void) {
# 17 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//bbsort_kernel.cu"
...
#include "bbsort_kernel.compute_13.cudafe1.stub.c"
