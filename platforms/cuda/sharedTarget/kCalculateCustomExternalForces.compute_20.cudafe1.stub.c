...
# 1 "kCalculateCustomExternalForces.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2119) {  __nv_dummy_param_ref(__T2119); __cudaRegisterEntry(__T2119, ((void ( *)(void))kCalculateCustomExternalForces_kernel), _Z37kCalculateCustomExternalForces_kernelv, 1024); __cudaRegisterVariable(__T2119, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T2119, __shadow_var(forceExpX,forceExpX), 0, 2056, 1, 0); __cudaRegisterVariable(__T2119, __shadow_var(forceExpY,forceExpY), 0, 2056, 1, 0); __cudaRegisterVariable(__T2119, __shadow_var(forceExpZ,forceExpZ), 0, 2056, 1, 0); __cudaRegisterVariable(__T2119, __shadow_var(energyExp,energyExp), 0, 2056, 1, 0); __cudaRegisterVariable(__T2119, __shadow_var(globalParams,globalParams), 0, 32, 1, 0); __cudaRegisterGlobalTexture(__T2119, __text_var(texRef0,texRef0), 1, 0, 0); __cudaRegisterGlobalTexture(__T2119, __text_var(texRef1,texRef1), 1, 0, 0); __cudaRegisterGlobalTexture(__T2119, __text_var(texRef2,texRef2), 1, 0, 0); __cudaRegisterGlobalTexture(__T2119, __text_var(texRef3,texRef3), 1, 0, 0); }
