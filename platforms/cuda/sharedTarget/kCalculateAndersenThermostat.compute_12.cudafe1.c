...
{  enum cudaError __cuda_local_var_38933_19_non_const_status;
# 92 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateAndersenThermostat.cu"
__cuda_local_var_38933_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_38933_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T218;
 struct _ZSs __T219;
 struct _ZSs __T220;
 struct _ZSs __T221;
 _ZSt6string __T222;
...
#include "kCalculateAndersenThermostat.compute_12.cudafe1.stub.c"
