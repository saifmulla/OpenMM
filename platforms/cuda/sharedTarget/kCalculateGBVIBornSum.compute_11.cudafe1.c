...
{
 enum cudaError __cuda_local_var_40745_17_non_const_status;
__cuda_local_var_40745_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_40745_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
{
 enum cudaError __cuda_local_var_40752_17_non_const_status;
__cuda_local_var_40752_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_40752_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
{  enum cudaError __cuda_local_var_42150_19_non_const_status;
# 242 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
__cuda_local_var_42150_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_42150_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T217;
 struct _ZSs __T218;
 struct _ZSs __T219;
 struct _ZSs __T220;
 _ZSt6string __T221;
...
# 259 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
 int __cuda_local_var_42167_9_non_const_printOnlyOnNan;
 int __cuda_local_var_42168_9_non_const_foundNan;
...
__cuda_local_var_42167_9_non_const_printOnlyOnNan = 1;
__cuda_local_var_42168_9_non_const_foundNan = 0;
if (__cuda_local_var_42167_9_non_const_printOnlyOnNan) { {
 unsigned ii;
# 262 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
ii = 0U; for (; ((ii < ((gpu->sim).paddedNumberOfAtoms)) && (__cuda_local_var_42168_9_non_const_foundNan == 0)); ii++) {
__cuda_local_var_42168_9_non_const_foundNan += (_Z15isNanOrInfinityf((((gpu->psBornRadii)->_pSysData)[ii])));
__cuda_local_var_42168_9_non_const_foundNan += (_Z15isNanOrInfinityf((((gpu->psBornForce)->_pSysData)[ii])));
__cuda_local_var_42168_9_non_const_foundNan += (_Z15isNanOrInfinityf((((gpu->psGBVISwitchDerivative)->_pSysData)[ii])));
} }
if (__cuda_local_var_42168_9_non_const_foundNan) {
log = stderr;
...
if ((!(__cuda_local_var_42167_9_non_const_printOnlyOnNan)) || (__cuda_local_var_42168_9_non_const_foundNan)) {
...
{  enum cudaError __cuda_local_var_42248_19_non_const_status;
# 340 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIBornSum.cu"
__cuda_local_var_42248_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_42248_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T250;
 struct _ZSs __T251;
 struct _ZSs __T252;
 struct _ZSs __T253;
 _ZSt6string __T254;
...
#include "kCalculateGBVIBornSum.compute_11.cudafe1.stub.c"
