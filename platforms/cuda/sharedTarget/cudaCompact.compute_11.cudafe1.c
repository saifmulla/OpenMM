...
void planCompaction( struct compactionPlan *d,  char stageOutput) {
 int __cuda_local_var_15050_9_non_const_device;

 struct cudaDeviceProp __cuda_local_var_15052_20_non_const_deviceProp;
# 188 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudaCompact.cu"
cudaGetDevice((&__cuda_local_var_15050_9_non_const_device));

cudaGetDeviceProperties((&__cuda_local_var_15052_20_non_const_deviceProp), __cuda_local_var_15050_9_non_const_device);
(d->nThreadBlocks) = ((unsigned)(16 * (__cuda_local_var_15052_20_non_const_deviceProp.multiProcessorCount)));
...
int compactStream( const struct compactionPlan *d,  T *dOut,  const T *dIn,  const unsigned *dValid,  size_t len,  size_t *dNumValid) {  struct dim3 __T20;
 ...
 unsigned __cuda_local_var_15070_18_non_const_numBlocks;


 size_t __cuda_local_var_15073_18_non_const_eltsPerBlock;
# 203 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudaCompact.cu"
if (!(d->valid)) {
return (-1);
}

__cuda_local_var_15070_18_non_const_numBlocks = (d->nThreadBlocks);
if (((unsigned long)(__cuda_local_var_15070_18_non_const_numBlocks * 128U)) > len) {
__cuda_local_var_15070_18_non_const_numBlocks = ((unsigned)((len + 127UL) / 128UL)); }
__cuda_local_var_15073_18_non_const_eltsPerBlock = ((len / ((unsigned long)__cuda_local_var_15070_18_non_const_numBlocks)) + ((unsigned long)((len % ((unsigned long)__cuda_local_var_15070_18_non_const_numBlocks)) ? 1 : 0)));



(cudaConfigureCall((((void)((((__T20.x) = __cuda_local_var_15070_18_non_const_numBlocks) , (void)((__T20.y) = 1U)) , (void)((__T20.z) = 1U))) , __T20), (((void)((((__T21.x) = 128U) , (void)((__T21.y) = 1U)) , (void)((__T21.z) = 1U))) , __T21), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z9countEltsPjPKjmm((d->dgBlockCounts), dValid, __cuda_local_var_15073_18_non_const_eltsPerBlock, len));


if (d->stageOutput) {  struct dim3 __T22;
 struct dim3 __T23;
# 218 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudaCompact.cu"
(cudaConfigureCall((((void)((((__T22.x) = __cuda_local_var_15070_18_non_const_numBlocks) , (void)((__T22.y) = 1U)) , (void)((__T22.z) = 1U))) , __T22), (((void)((((__T23.x) = 128U) , (void)((__T23.y) = 1U)) , (void)((__T23.z) = 1U))) , __T23), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z23moveValidElementsStagedPKjPjS0_S0_mmPm(dIn, dOut, dValid, ((const unsigned *)(d->dgBlockCounts)), __cuda_local_var_15073_18_non_const_eltsPerBlock, len, dNumValid));
} else  {  struct dim3 __T24;
 struct dim3 __T25;
# 220 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudaCompact.cu"
(cudaConfigureCall((((void)((((__T24.x) = __cuda_local_var_15070_18_non_const_numBlocks) , (void)((__T24.y) = 1U)) , (void)((__T24.z) = 1U))) , __T24), (((void)((((__T25.x) = 128U) , (void)((__T25.y) = 1U)) , (void)((__T25.z) = 1U))) , __T25), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z26moveValidElementsScatteredPKjPjS0_S0_mmPm(dIn, dOut, dValid, ((const unsigned *)(d->dgBlockCounts)), __cuda_local_var_15073_18_non_const_eltsPerBlock, len, dNumValid));
}
return 0;
}
static void __sti___30_cudaCompact_compute_20_cpp1_ii_a1db1d0a(void) {   }

#include "cudaCompact.compute_11.cudafe1.stub.c"
