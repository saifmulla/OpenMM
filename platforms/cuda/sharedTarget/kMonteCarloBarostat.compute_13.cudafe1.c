# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kMonteCarloBarostat.cu"
...
# 83 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kMonteCarloBarostat.cu"
extern void _Z21kScaleAtomCoordinatesP11_gpuContextfR10CUDAStreamIiES3_(gpuContext, float, struct _Z10CUDAStreamIiE *, struct _Z10CUDAStreamIiE *);
...
static void __sti___38_kMonteCarloBarostat_compute_20_cpp1_ii_b149c460(void) __attribute__((__constructor__));
...
# 83 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kMonteCarloBarostat.cu"
void _Z21kScaleAtomCoordinatesP11_gpuContextfR10CUDAStreamIiES3_( gpuContext gpu,  float scale,  struct _Z10CUDAStreamIiE *moleculeAtoms,  struct _Z10CUDAStreamIiE *moleculeStartIndex)
{  struct dim3 __T20;
 unsigned __T21;
 struct dim3 __T22;
 unsigned __T23;
 ...
 float __T26;
 struct float3 __T27;
# 86 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kMonteCarloBarostat.cu"
(cudaConfigureCall((((void)((__T21 = ((gpu->sim).blocks)) , (void)((((__T20.x) = __T21) , (void)((__T20.y) = 1U)) , ((__T20.z) = 1U)))) , __T20), (((void)((__T23 = ((gpu->sim).update_threads_per_block)) , (void)((((__T22.x) = __T23) , (void)((__T22.y) = 1U)) , ((__T22.z) = 1U)))) , __T22), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z28kScaleAtomCoordinates_kernelfi6float3P6float4PiS2_(scale, ((int)((moleculeStartIndex->_length) - 1U)), ((((__T24 = ((gpu->sim).periodicBoxSizeX)) , (void)(__T25 = ((gpu->sim).periodicBoxSizeY))) , (void)(__T26 = ((gpu->sim).periodicBoxSizeZ))) , (((((__T27.x) = __T24) , (void)((__T27.y) = __T25)) , (void)((__T27.z) = __T26)) , __T27)), ((gpu->sim).pPosq), (moleculeAtoms->_pDevData), (moleculeStartIndex->_pDevData)));


{  enum cudaError __cuda_local_var_39143_19_non_const_status;
# 89 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kMonteCarloBarostat.cu"
__cuda_local_var_39143_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39143_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T28;
 struct _ZSs __T29;
 struct _ZSs __T210;
 struct _ZSs __T211;
 _ZSt6string __T212;
...
# 89 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kMonteCarloBarostat.cu"
((((((__T28 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T214 = __T28) , (void)(__T215 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T29), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T210), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T211), ((_ZNSsC1EPKcRKSaIcE((&__T212), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T213))) , (((const struct _ZSaIcE *)&__T213))))) , (((const struct _ZSs *)&__T212))), (cudaGetErrorString(__cuda_local_var_39143_19_non_const_status)))) , (((const struct _ZSs *)&__T211))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T210))), ((const char *)"kScaleAtomCoordinates"))) , (((const _ZSt6string *)&__T29))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T214->__b_St9exception)))) , (void)(((__T214->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T214->message)), __T215)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T29)))) , (void)(_ZNSsD1Ev((&__T210)))) , (void)(_ZNSsD1Ev((&__T211)))) , (void)(_ZNSsD1Ev((&__T212)))) , (void)(_ZNSaIcED1Ev((&__T213))); } } ; 
}
__asm__(".align 2");
# 62 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/exception" 3
...
{  _ZNSs14allocator_typeE __T225;
 struct _ZNSs4_RepE *__T226;
 const struct _ZSaIcE *__T227;
 void *__T228;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T226 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T227 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T225)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T225))))) , (void)((__builtin_expect(((long)(__T226 != ((__T228 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T228)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T226->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T226, __T227)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T225)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T229) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T230) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T230);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T231,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T231, __lhs);
_ZNSs6appendEPKcm(__T231, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T232 = (*__mem)) , (void)((*__mem) += __val)) , __T232; }



}
static void __sti___38_kMonteCarloBarostat_compute_20_cpp1_ii_b149c460(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kMonteCarloBarostat.compute_13.cudafe1.stub.c"
