# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCMAPTorsionForces.cu"
...
SM_20};
# 65 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudatypes.h"
struct _Z10CUDAStreamI6float2E; struct _Z10CUDAStreamIjE; struct _Z10CUDAStreamImE; struct _Z10CUDAStreamI5uint4E;
...
struct _gpuContext;
# 65 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//cudatypes.h"
struct _Z10CUDAStreamIiE; struct _Z10CUDAStreamI6float4E; struct _Z10CUDAStreamI4int2E; struct _Z10CUDAStreamI4int4E;
...
# 244 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCMAPTorsionForces.cu"
extern void _Z27kCalculateCMAPTorsionForcesP11_gpuContextR10CUDAStreamI6float4ERS1_I4int2ERS1_I4int4ERS1_IiE(gpuContext, struct _Z10CUDAStreamI6float4E *, struct _Z10CUDAStreamI4int2E *, struct _Z10CUDAStreamI4int4E *, struct _Z10CUDAStreamIiE *);
...
static void __sti___46_kCalculateCMAPTorsionForces_compute_20_cpp1_ii_64cc5735(void) __attribute__((__constructor__));
...
# 244 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCMAPTorsionForces.cu"
void _Z27kCalculateCMAPTorsionForcesP11_gpuContextR10CUDAStreamI6float4ERS1_I4int2ERS1_I4int4ERS1_IiE( gpuContext gpu,  struct _Z10CUDAStreamI6float4E *coefficients,  struct _Z10CUDAStreamI4int2E *mapPositions,  struct _Z10CUDAStreamI4int4E *torsionIndices,  struct _Z10CUDAStreamIiE *torsionMaps)
{  struct dim3 __T20;
 unsigned __T21;
 struct dim3 __T22;
 unsigned __T23;
# 246 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCMAPTorsionForces.cu"
(cudaConfigureCall((((void)((__T21 = ((gpu->sim).blocks)) , (void)((((__T20.x) = __T21) , (void)((__T20.y) = 1U)) , ((__T20.z) = 1U)))) , __T20), (((void)((__T23 = ((gpu->sim).localForces_threads_per_block)) , (void)((((__T22.x) = __T23) , (void)((__T22.y) = 1U)) , ((__T22.z) = 1U)))) , __T22), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z34kCalculateCMAPTorsionForces_kerneliiP6float4PfS0_S0_P4int2P4int4Pi(((int)((gpu->sim).stride)), ((int)(torsionMaps->_length)), ((gpu->sim).pForce4), ((gpu->sim).pEnergy), ((gpu->sim).pPosq), (coefficients->_pDevData), (mapPositions->_pDevData), (torsionIndices->_pDevData), (torsionMaps->_pDevData)));


{  enum cudaError __cuda_local_var_40896_19_non_const_status;
# 249 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCMAPTorsionForces.cu"
__cuda_local_var_40896_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_40896_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T24;
 struct _ZSs __T25;
 struct _ZSs __T26;
 struct _ZSs __T27;
 _ZSt6string __T28;
...
# 249 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateCMAPTorsionForces.cu"
((((((__T24 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T210 = __T24) , (void)(__T211 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T25), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T26), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T27), ((_ZNSsC1EPKcRKSaIcE((&__T28), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T29))) , (((const struct _ZSaIcE *)&__T29))))) , (((const struct _ZSs *)&__T28))), (cudaGetErrorString(__cuda_local_var_40896_19_non_const_status)))) , (((const struct _ZSs *)&__T27))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T26))), ((const char *)"kCalculateCMAPTorsionForces"))) , (((const _ZSt6string *)&__T25))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T210->__b_St9exception)))) , (void)(((__T210->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T210->message)), __T211)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T25)))) , (void)(_ZNSsD1Ev((&__T26)))) , (void)(_ZNSsD1Ev((&__T27)))) , (void)(_ZNSsD1Ev((&__T28)))) , (void)(_ZNSaIcED1Ev((&__T29))); } } ; 
}
__asm__(".align 2");
# 62 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/exception" 3
...
(((__T297 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T298 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T296)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T296))))) , (void)((__builtin_expect(((long)(__T297 != ((__T299 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T299)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T297->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T297, __T298)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T296)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2100) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2101) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T2101);  }
__asm__(".align 2");
...
_ZNSs6appendEPKcm(__T2102, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T2103 = (*__mem)) , (void)((*__mem) += __val)) , __T2103; }



}
static void __sti___46_kCalculateCMAPTorsionForces_compute_20_cpp1_ii_64cc5735(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kCalculateCMAPTorsionForces.compute_11.cudafe1.stub.c"
