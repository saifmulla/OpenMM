...
# 1 "kCCMA.compute_11.cudafe1.stub.c"
...
# 1 "kCCMA.compute_11.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T252) {  __nv_dummy_param_ref(__T252); __cudaRegisterEntry(__T252, ((void ( *)(struct float4 *, int))kUpdateCCMAAtomPositions), _Z24kUpdateCCMAAtomPositionsP6float4i, 256); __cudaRegisterEntry(__T252, ((void ( *)(void))kMultiplyByCCMAConstraintMatrix), _Z31kMultiplyByCCMAConstraintMatrixv, 256); __cudaRegisterEntry(__T252, ((void ( *)(struct float4 *, bool))kComputeCCMAConstraintForces), _Z28kComputeCCMAConstraintForcesP6float4b, 256); __cudaRegisterEntry(__T252, ((void ( *)(void))kComputeCCMAConstraintDirections), _Z32kComputeCCMAConstraintDirectionsv, 256); __cudaRegisterVariable(__T252, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
