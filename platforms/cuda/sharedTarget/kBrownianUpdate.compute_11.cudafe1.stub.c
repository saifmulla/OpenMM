...
# 1 "kBrownianUpdate.compute_11.cudafe1.stub.c"
...
# 1 "kBrownianUpdate.compute_11.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T246) {  __nv_dummy_param_ref(__T246); __cudaRegisterEntry(__T246, ((void ( *)(void))kBrownianUpdatePart2_kernel), _Z27kBrownianUpdatePart2_kernelv, 192); __cudaRegisterEntry(__T246, ((void ( *)(void))kBrownianUpdatePart1_kernel), _Z27kBrownianUpdatePart1_kernelv, 192); __cudaRegisterVariable(__T246, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
