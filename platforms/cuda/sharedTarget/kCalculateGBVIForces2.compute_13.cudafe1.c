# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIForces2.cu"
...
# 60 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIForces2.cu"
extern void _Z26SetCalculateGBVIForces2SimP11_gpuContext(gpuContext);
...
# 67 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIForces2.cu"
extern void _Z26GetCalculateGBVIForces2SimP11_gpuContext(gpuContext);
...
# 109 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIForces2.cu"
extern void _Z21kCalculateGBVIForces2P11_gpuContext(gpuContext);
...
static void __sti___40_kCalculateGBVIForces2_compute_20_cpp1_ii_0628a6c8(void) __attribute__((__constructor__));
...
# 60 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIForces2.cu"
void _Z26SetCalculateGBVIForces2SimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_41703_17_non_const_status;
__cuda_local_var_41703_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41703_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 67 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIForces2.cu"
void _Z26GetCalculateGBVIForces2SimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_41710_17_non_const_status;
__cuda_local_var_41710_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_41710_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 109 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIForces2.cu"
void _Z21kCalculateGBVIForces2P11_gpuContext( gpuContext gpu)
{
...
if (gpu->bOutputBufferPerWarp) {  struct dim3 __T231;
 ...
 struct dim3 __T233;
 unsigned __T234;
# 137 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIForces2.cu"
(cudaConfigureCall((((void)((__T232 = ((gpu->sim).bornForce2_blocks)) , (void)((((__T231.x) = __T232) , (void)((__T231.y) = 1U)) , ((__T231.z) = 1U)))) , __T231), (((void)((__T234 = ((gpu->sim).bornForce2_threads_per_block)) , (void)((((__T233.x) = __T234) , (void)((__T233.y) = 1U)) , ((__T233.z) = 1U)))) , __T233), (48UL * ((unsigned long)((gpu->sim).bornForce2_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z42kCalculateGBVIPeriodicByWarpForces2_kernelPj(((gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T235;
 unsigned __T236;
 struct dim3 __T237;
 unsigned __T238;
# 140 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIForces2.cu"
(cudaConfigureCall((((void)((__T236 = ((gpu->sim).bornForce2_blocks)) , (void)((((__T235.x) = __T236) , (void)((__T235.y) = 1U)) , ((__T235.z) = 1U)))) , __T235), (((void)((__T238 = ((gpu->sim).bornForce2_threads_per_block)) , (void)((((__T237.x) = __T238) , (void)((__T237.y) = 1U)) , ((__T237.z) = 1U)))) , __T237), (48UL * ((unsigned long)((gpu->sim).bornForce2_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z36kCalculateGBVIPeriodicForces2_kernelPj(((gpu->sim).pInteractingWorkUnit))); }

goto __T222;

} __T222:;
{  enum cudaError __cuda_local_var_43604_19_non_const_status;
# 145 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIForces2.cu"
__cuda_local_var_43604_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_43604_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T239;
 struct _ZSs __T240;
 struct _ZSs __T241;
 struct _ZSs __T242;
 _ZSt6string __T243;
...
# 145 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCalculateGBVIForces2.cu"
((((((__T239 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T245 = __T239) , (void)(__T246 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T240), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T241), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T242), ((_ZNSsC1EPKcRKSaIcE((&__T243), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T244))) , (((const struct _ZSaIcE *)&__T244))))) , (((const struct _ZSs *)&__T243))), (cudaGetErrorString(__cuda_local_var_43604_19_non_const_status)))) , (((const struct _ZSs *)&__T242))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T241))), ((const char *)"kCalculateGBVIForces2"))) , (((const _ZSt6string *)&__T240))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T245->__b_St9exception)))) , (void)(((__T245->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T245->message)), __T246)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T240)))) , (void)(_ZNSsD1Ev((&__T241)))) , (void)(_ZNSsD1Ev((&__T242)))) , (void)(_ZNSsD1Ev((&__T243)))) , (void)(_ZNSaIcED1Ev((&__T244))); } } ; 
...
{  _ZNSs14allocator_typeE __T247;
 struct _ZNSs4_RepE *__T248;
 const struct _ZSaIcE *__T249;
 void *__T250;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T248 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T249 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T247)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T247))))) , (void)((__builtin_expect(((long)(__T248 != ((__T250 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T250)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T248->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T248, __T249)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T247)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T251) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T252) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T252);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T253,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T253, __lhs);
_ZNSs6appendEPKcm(__T253, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T254 = (*__mem)) , (void)((*__mem) += __val)) , __T254; }



}
static void __sti___40_kCalculateGBVIForces2_compute_20_cpp1_ii_0628a6c8(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kCalculateGBVIForces2.compute_13.cudafe1.stub.c"
