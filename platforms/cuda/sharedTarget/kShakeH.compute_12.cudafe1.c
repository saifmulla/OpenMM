# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kShakeH.cu"
...
# 53 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kShakeH.cu"
extern void _Z12SetShakeHSimP11_gpuContext(gpuContext);
...
# 60 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kShakeH.cu"
extern void _Z12GetShakeHSimP11_gpuContext(gpuContext);
...
# 227 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kShakeH.cu"
...
static void __sti___26_kShakeH_compute_20_cpp1_ii_b4171ffd(void) __attribute__((__constructor__));
...
# 53 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kShakeH.cu"
void _Z12SetShakeHSimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_38896_17_non_const_status;
__cuda_local_var_38896_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_38896_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 60 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kShakeH.cu"
void _Z12GetShakeHSimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_38903_17_non_const_status;
__cuda_local_var_38903_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_38903_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 227 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kShakeH.cu"
void _Z11kApplyShakeP11_gpuContext( gpuContext gpu)
{

if (((gpu->sim).ShakeConstraints) > 0U)
{  struct dim3 __T214;
 unsigned __T215;
 struct dim3 __T216;
 unsigned __T217;
# 232 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kShakeH.cu"
(cudaConfigureCall((((void)((__T215 = ((gpu->sim).blocks)) , (void)((((__T214.x) = __T215) , (void)((__T214.y) = 1U)) , ((__T214.z) = 1U)))) , __T214), (((void)((__T217 = ((gpu->sim).shake_threads_per_block)) , (void)((((__T216.x) = __T217) , (void)((__T216.y) = 1U)) , ((__T216.z) = 1U)))) , __T216), (60UL * ((unsigned long)((gpu->sim).shake_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z18kApplyShake_kernelv());
{  enum cudaError __cuda_local_var_39074_23_non_const_status;
# 233 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kShakeH.cu"
__cuda_local_var_39074_23_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_39074_23_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T218;
 struct _ZSs __T219;
 struct _ZSs __T220;
 struct _ZSs __T221;
 _ZSt6string __T222;
...
# 233 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kShakeH.cu"
((((((__T218 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T224 = __T218) , (void)(__T225 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T219), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T220), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T221), ((_ZNSsC1EPKcRKSaIcE((&__T222), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T223))) , (((const struct _ZSaIcE *)&__T223))))) , (((const struct _ZSs *)&__T222))), (cudaGetErrorString(__cuda_local_var_39074_23_non_const_status)))) , (((const struct _ZSs *)&__T221))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T220))), ((const char *)"kApplyShake"))) , (((const _ZSt6string *)&__T219))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T224->__b_St9exception)))) , (void)(((__T224->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T224->message)), __T225)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T219)))) , (void)(_ZNSsD1Ev((&__T220)))) , (void)(_ZNSsD1Ev((&__T221)))) , (void)(_ZNSsD1Ev((&__T222)))) , (void)(_ZNSaIcED1Ev((&__T223))); } } ;
} 
