# 1 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
...
extern enum cudaError cudaEventRecord(struct CUevent_st *, struct CUstream_st *);
...
extern void _Z10SetCCMASimP11_gpuContext(gpuContext);
...
# 44 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
extern void _Z10GetCCMASimP11_gpuContext(gpuContext);
...
# 190 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
extern void _Z10kApplyCCMAP11_gpuContextP6float4b(gpuContext, struct float4 *, char);
# 208 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
extern void _Z10kApplyCCMAP11_gpuContext(gpuContext);
...
static void __sti___24_kCCMA_compute_20_cpp1_ii_6b692385(void) __attribute__((__constructor__));
...
# 37 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
void _Z10SetCCMASimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_38820_17_non_const_status;
__cuda_local_var_38820_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_38820_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 44 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
void _Z10GetCCMASimP11_gpuContext( gpuContext gpu)
{
 enum cudaError __cuda_local_var_38827_17_non_const_status;
__cuda_local_var_38827_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_38827_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 190 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
void _Z10kApplyCCMAP11_gpuContextP6float4b( gpuContext gpu,  struct float4 *posq,  char addOldPosition)
{  struct dim3 __T214;
 unsigned __T215;
 struct dim3 __T216;
 unsigned __T217;
# 194 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
 int __cuda_local_var_38975_15_const_checkInterval;
# 192 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
(cudaConfigureCall((((void)((__T215 = ((gpu->sim).blocks)) , (void)((((__T214.x) = __T215) , (void)((__T214.y) = 1U)) , ((__T214.z) = 1U)))) , __T214), (((void)((__T217 = ((gpu->sim).ccma_threads_per_block)) , (void)((((__T216.x) = __T217) , (void)((__T216.y) = 1U)) , ((__T216.z) = 1U)))) , __T216), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z32kComputeCCMAConstraintDirectionsv());
{  enum cudaError __cuda_local_var_38974_19_non_const_status;
# 193 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
__cuda_local_var_38974_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_38974_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T218;
 struct _ZSs __T219;
 struct _ZSs __T220;
 struct _ZSs __T221;
 _ZSt6string __T222;
...
# 193 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
((((((__T218 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T224 = __T218) , (void)(__T225 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T219), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T220), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T221), ((_ZNSsC1EPKcRKSaIcE((&__T222), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T223))) , (((const struct _ZSaIcE *)&__T223))))) , (((const struct _ZSs *)&__T222))), (cudaGetErrorString(__cuda_local_var_38974_19_non_const_status)))) , (((const struct _ZSs *)&__T221))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T220))), ((const char *)"kComputeCCMAConstraintDirections"))) , (((const _ZSt6string *)&__T219))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T224->__b_St9exception)))) , (void)(((__T224->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T224->message)), __T225)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T219)))) , (void)(_ZNSsD1Ev((&__T220)))) , (void)(_ZNSsD1Ev((&__T221)))) , (void)(_ZNSsD1Ev((&__T222)))) , (void)(_ZNSaIcED1Ev((&__T223))); } } ;
__cuda_local_var_38975_15_const_checkInterval = 3; {
 int i;
# 195 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
i = 0; for (; (i < 150); i++) {  struct dim3 __T226;
 unsigned __T227;
 struct dim3 __T228;
 unsigned __T229;
 struct dim3 __T230;
 ...
 struct dim3 __T236;
 unsigned __T237;
# 196 "/home/saifmulla/openmm/OpenMM/platforms/cuda/./src/kernels//kCCMA.cu"
if (((i + 1) % 3) == 0) {
(*(gpu->ccmaConvergedHostMarker)) = 1; }
(cudaConfigureCall((((void)((__T227 = ((gpu->sim).blocks)) , (void)((((__T226.x) = __T227) , (void)((__T226.y) = 1U)) , ((__T226.z) = 1U)))) , __T226), (((void)((__T229 = ((gpu->sim).ccma_threads_per_block)) , (void)((((__T228.x) = __T229) , (void)((__T228.y) = 1U)) , ((__T228.z) = 1U)))) , __T228), (((unsigned long)((gpu->sim).ccma_threads_per_block)) * 4UL), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z28kComputeCCMAConstraintForcesP6float4b(posq, addOldPosition));
cudaEventRecord((gpu->ccmaEvent), ((struct CUstream_st *)0LL));
(cudaConfigureCall((((void)((__T231 = ((gpu->sim).blocks)) , (void)((((__T230.x) = __T231) , (void)((__T230.y) = 1U)) , ((__T230.z) = 1U)))) , __T230), (((void)((__T233 = ((gpu->sim).ccma_threads_per_block)) , (void)((((__T232.x) = __T233) , (void)((__T232.y) = 1U)) , ((__T232.z) = 1U)))) , __T232), (((unsigned long)((gpu->sim).ccma_threads_per_block)) * 4UL), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z31kMultiplyByCCMAConstraintMatrixv());
(cudaConfigureCall((((void)((__T235 = ((gpu->sim).blocks)) , (void)((((__T234.x) = __T235) , (void)((__T234.y) = 1U)) , ((__T234.z) = 1U)))) , __T234), (((void)((__T237 = ((gpu->sim).ccma_threads_per_block)) , (void)((((__T236.x) = __T237) , (void)((__T236.y) = 1U)) , ((__T236.z) = 1U)))) , __T236), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z24kUpdateCCMAAtomPositionsP6float4i(posq, ((3 * i) + 2)));
cudaEventSynchronize((gpu->ccmaEvent));
if ((((i + 1) % 3) == 0) && (*(gpu->ccmaConvergedHostMarker))) {
goto __T238; }
} } __T238:; 
}

void _Z10kApplyCCMAP11_gpuContext( gpuContext gpu)
{

if (((gpu->sim).ccmaConstraints) > 0U) {
_Z10kApplyCCMAP11_gpuContextP6float4b(gpu, ((gpu->sim).pPosqP), ((char)1)); } 
}
__asm__(".align 2");
# 62 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/exception" 3
...
{  _ZNSs14allocator_typeE __T244;
 struct _ZNSs4_RepE *__T245;
 const struct _ZSaIcE *__T246;
 void *__T247;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T245 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T246 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T244)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T244))))) , (void)((__builtin_expect(((long)(__T245 != ((__T247 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T247)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T245->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T245, __T246)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T244)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T248) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T249) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T249);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T250,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T250, __lhs);
_ZNSs6appendEPKcm(__T250, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T251 = (*__mem)) , (void)((*__mem) += __val)) , __T251; }



}
static void __sti___24_kCCMA_compute_20_cpp1_ii_6b692385(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kCCMA.compute_11.cudafe1.stub.c"
