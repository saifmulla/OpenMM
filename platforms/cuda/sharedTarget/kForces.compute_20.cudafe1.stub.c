...
# 1 "kForces.compute_20.cudafe1.stub.c"
...
# 1 "kForces.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2107) {  __nv_dummy_param_ref(__T2107); __cudaRegisterEntry(__T2107, ((void ( *)(void))kReduceGBVIBornForces_kernel), _Z28kReduceGBVIBornForces_kernelv, 512); __cudaRegisterEntry(__T2107, ((void ( *)(void))kReduceObcGbsaBornForces_kernel), _Z31kReduceObcGbsaBornForces_kernelv, 512); __cudaRegisterEntry(__T2107, ((void ( *)(void))kReduceForces_kernel), _Z20kReduceForces_kernelv, 512); __cudaRegisterEntry(__T2107, ((void ( *)(void))kReduceBornSumAndForces_kernel), _Z30kReduceBornSumAndForces_kernelv, 512); __cudaRegisterEntry(__T2107, ((void ( *)(void))kClearEnergy_kernel), _Z19kClearEnergy_kernelv, 384); __cudaRegisterEntry(__T2107, ((void ( *)(void))kClearBornSumAndForces_kernel), _Z29kClearBornSumAndForces_kernelv, 384); __cudaRegisterEntry(__T2107, ((void ( *)(void))kClearForces_kernel), _Z19kClearForces_kernelv, 384); __cudaRegisterVariable(__T2107, __shadow_var(cSim,cSim), 0, 1224, 1, 0); }
