...
# 1 "kCalculateObcGbsaSoftcoreBornSum.compute_11.cudafe1.stub.c"
...
# 1 "kCalculateObcGbsaSoftcoreBornSum.compute_11.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2283) {  __nv_dummy_param_ref(__T2283); __cudaRegisterEntry(__T2283, ((void ( *)(void))kReduceObcGbsaSoftcoreBornSum_kernel), _Z36kReduceObcGbsaSoftcoreBornSum_kernelv, 256); __cudaRegisterEntry(__T2283, ((void ( *)(unsigned *))kCalculateObcGbsaSoftcorePeriodicByWarpBornSum_kernel), _Z53kCalculateObcGbsaSoftcorePeriodicByWarpBornSum_kernelPj, 256); __cudaRegisterEntry(__T2283, ((void ( *)(unsigned *))kCalculateObcGbsaSoftcorePeriodicBornSum_kernel), _Z47kCalculateObcGbsaSoftcorePeriodicBornSum_kernelPj, 256); __cudaRegisterEntry(__T2283, ((void ( *)(unsigned *))kCalculateObcGbsaSoftcoreCutoffByWarpBornSum_kernel), _Z51kCalculateObcGbsaSoftcoreCutoffByWarpBornSum_kernelPj, 256); __cudaRegisterEntry(__T2283, ((void ( *)(unsigned *))kCalculateObcGbsaSoftcoreCutoffBornSum_kernel), _Z45kCalculateObcGbsaSoftcoreCutoffBornSum_kernelPj, 256); __cudaRegisterEntry(__T2283, ((void ( *)(unsigned *))kCalculateObcGbsaSoftcoreN2ByWarpBornSum_kernel), _Z47kCalculateObcGbsaSoftcoreN2ByWarpBornSum_kernelPj, 256); __cudaRegisterEntry(__T2283, ((void ( *)(unsigned *))kCalculateObcGbsaSoftcoreN2BornSum_kernel), _Z41kCalculateObcGbsaSoftcoreN2BornSum_kernelPj, 256); __cudaRegisterEntry(__T2283, ((void ( *)(void))kReduceObcGbsaSoftcoreBornForces_kernel), _Z39kReduceObcGbsaSoftcoreBornForces_kernelv, 256); __cudaRegisterEntry(__T2283, ((void ( *)(void))kClearSoftcoreBornForces_kernel), _Z31kClearSoftcoreBornForces_kernelv, 256); __cudaRegisterEntry(__T2283, ((void ( *)(void))kClearObcGbsaSoftcoreBornSum_kernel), _Z35kClearObcGbsaSoftcoreBornSum_kernelv, 256); __cudaRegisterVariable(__T2283, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T2283, __shadow_var(gbsaSimDev,gbsaSimDev), 0, 128, 1, 0); }
