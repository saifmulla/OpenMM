# 1 "kCalculateLocalSoftcoreForces.compute_11.cudafe1.gpu"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kCalculateLocalSoftcoreForces.compute_11.cudafe1.gpu"
...
(__cuda_local_var_41322_20_non_const_d.x) -= ((floorf((( fdividef((__cuda_local_var_41322_20_non_const_d.x) , (cSim.periodicBoxSizeX))) + (0.5F)))) * (cSim.periodicBoxSizeX));
# 239 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
(__cuda_local_var_41322_20_non_const_d.y) -= ((floorf((( fdividef((__cuda_local_var_41322_20_non_const_d.y) , (cSim.periodicBoxSizeY))) + (0.5F)))) * (cSim.periodicBoxSizeY));
# 240 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
(__cuda_local_var_41322_20_non_const_d.z) -= ((floorf((( fdividef((__cuda_local_var_41322_20_non_const_d.z) , (cSim.periodicBoxSizeZ))) + (0.5F)))) * (cSim.periodicBoxSizeZ));
# 241 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
