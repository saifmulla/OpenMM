# 1 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
...
extern enum cudaError cudaGetDeviceCount(int *);
...
# 43 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
extern void SetCalculateCDLJSoftcoreGpuSim(freeEnergyGpuContext);
...
# 53 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
extern char gpuIsAvailableSoftcore(void);
# 116 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
extern void kCalculateCDLJSoftcoreForces(freeEnergyGpuContext);
...
static void __sti___46_kCalculateNonbondedSoftcore_compute_20_cpp1_ii_7c2e594b(void) __attribute__((__constructor__));
...
void SetCalculateCDLJSoftcoreGpuSim( freeEnergyGpuContext freeEnergyGpu) {
 enum cudaError __cuda_local_var_41719_17_non_const_status;
__cuda_local_var_41719_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&((freeEnergyGpu->gpuContext)->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41719_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 46 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
(((((__T20 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T25 = __T20) , (void)(__T26 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T21), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T22), ((_ZNSsC1EPKcRKSaIcE((&__T23), ((const char *)"cudaMemcpyToSymbol: SetCalculateCDLJSoftcoreGpuSim copy to cSim failed"), ((_ZNSaIcEC1Ev((&__T24))) , (((const struct _ZSaIcE *)&__T24))))) , (((const struct _ZSs *)&__T23))), ((const char *)" "))) , (((const struct _ZSs *)&__T22))), (cudaGetErrorString(__cuda_local_var_41719_17_non_const_status)))) , (((const _ZSt6string *)&__T21))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T25->__b_St9exception)))) , (void)(((__T25->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T25->message)), __T26)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T21)))) , (void)(_ZNSsD1Ev((&__T22)))) , (void)(_ZNSsD1Ev((&__T23)))) , (void)(_ZNSaIcED1Ev((&__T24))); } ;

__cuda_local_var_41719_17_non_const_status = (_Z18cudaMemcpyToSymbolI27cudaFreeEnergyGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaFreeEnergyGmxSimulation *)&feSimDev)), ((const void *)(&(freeEnergyGpu->freeEnergySim))), 128UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41719_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 53 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
char gpuIsAvailableSoftcore(void)
{
 int __cuda_local_var_41730_9_non_const_deviceCount;
cudaGetDeviceCount((&__cuda_local_var_41730_9_non_const_deviceCount));
return (char)(__cuda_local_var_41730_9_non_const_deviceCount > 0);
}
# 116 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
void kCalculateCDLJSoftcoreForces( freeEnergyGpuContext freeEnergyGpu)
{

 gpuContext __cuda_local_var_44457_16_non_const_gpu;
# 119 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
__cuda_local_var_44457_16_non_const_gpu = (freeEnergyGpu->gpuContext);
...
# 122 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
case 0:

if (__cuda_local_var_44457_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T241;
 unsigned __T242;
 struct dim3 __T243;
 unsigned __T244;
# 125 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
(cudaConfigureCall((((void)((__T242 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T241.x) = __T242) , (void)((__T241.y) = 1U)) , ((__T241.z) = 1U)))) , __T241), (((void)((__T244 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block)) , (void)((((__T243.x) = __T244) , (void)((__T243.y) = 1U)) , ((__T243.z) = 1U)))) , __T243), (40UL * ((unsigned long)((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z53kCalculateCDLJSoftcoreN2SoftcoreLJByWarpForces_kernelPj(((__cuda_local_var_44457_16_non_const_gpu->sim).pWorkUnit))); } else  {  struct dim3 __T245;
 unsigned __T246;
 struct dim3 __T247;
 unsigned __T248;
# 128 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
(cudaConfigureCall((((void)((__T246 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T245.x) = __T246) , (void)((__T245.y) = 1U)) , ((__T245.z) = 1U)))) , __T245), (((void)((__T248 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block)) , (void)((((__T247.x) = __T248) , (void)((__T247.y) = 1U)) , ((__T247.z) = 1U)))) , __T247), (40UL * ((unsigned long)((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z47kCalculateCDLJSoftcoreN2SoftcoreLJForces_kernelPj(((__cuda_local_var_44457_16_non_const_gpu->sim).pWorkUnit))); }

{  enum cudaError __cuda_local_var_44468_27_non_const_status;
# 130 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
__cuda_local_var_44468_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_44468_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T249;
 struct _ZSs __T250;
 struct _ZSs __T251;
 struct _ZSs __T252;
 _ZSt6string __T253;
 struct _ZSaIcE __T254;
 struct _ZN6OpenMM15OpenMMExceptionE *__T255;
 const _ZSt6string *__T256;
# 130 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
((((((__T249 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T255 = __T249) , (void)(__T256 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T250), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T251), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T252), ((_ZNSsC1EPKcRKSaIcE((&__T253), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T254))) , (((const struct _ZSaIcE *)&__T254))))) , (((const struct _ZSs *)&__T253))), (cudaGetErrorString(__cuda_local_var_44468_27_non_const_status)))) , (((const struct _ZSs *)&__T252))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T251))), ((const char *)"kCalculateCDLJSoftcoreN2Forces"))) , (((const _ZSt6string *)&__T250))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T255->__b_St9exception)))) , (void)(((__T255->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T255->message)), __T256)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T250)))) , (void)(_ZNSsD1Ev((&__T251)))) , (void)(_ZNSsD1Ev((&__T252)))) , (void)(_ZNSsD1Ev((&__T253)))) , (void)(_ZNSaIcED1Ev((&__T254))); } } ;

goto __T257;

case 1:

(cudaConfigureCall((((void)((__T215 = ((((__cuda_local_var_44457_16_non_const_gpu->psGridBoundingBox)->_length) + 63U) / 64U)) , (void)((((__T214.x) = __T215) , (void)((__T214.y) = 1U)) , ((__T214.z) = 1U)))) , __T214), (((void)((((__T216.x) = 64U) , (void)((__T216.y) = 1U)) , (void)((__T216.z) = 1U))) , __T216), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z29kFindBlockBoundsCutoff_kernelv());
{  enum cudaError __cuda_local_var_44475_27_non_const_status;
# 137 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
__cuda_local_var_44475_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_44475_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T258;
 struct _ZSs __T259;
 struct _ZSs __T260;
 struct _ZSs __T261;
 _ZSt6string __T262;
 struct _ZSaIcE __T263;
 struct _ZN6OpenMM15OpenMMExceptionE *__T264;
 const _ZSt6string *__T265;
# 137 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
((((((__T258 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T264 = __T258) , (void)(__T265 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T259), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T260), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T261), ((_ZNSsC1EPKcRKSaIcE((&__T262), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T263))) , (((const struct _ZSaIcE *)&__T263))))) , (((const struct _ZSs *)&__T262))), (cudaGetErrorString(__cuda_local_var_44475_27_non_const_status)))) , (((const struct _ZSs *)&__T261))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T260))), ((const char *)"kFindBlockBoundsCutoff"))) , (((const _ZSt6string *)&__T259))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T264->__b_St9exception)))) , (void)(((__T264->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T264->message)), __T265)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T259)))) , (void)(_ZNSsD1Ev((&__T260)))) , (void)(_ZNSsD1Ev((&__T261)))) , (void)(_ZNSsD1Ev((&__T262)))) , (void)(_ZNSaIcED1Ev((&__T263))); } } ;
(cudaConfigureCall((((void)((__T218 = ((__cuda_local_var_44457_16_non_const_gpu->sim).interaction_blocks)) , (void)((((__T217.x) = __T218) , (void)((__T217.y) = 1U)) , ((__T217.z) = 1U)))) , __T217), (((void)((__T220 = ((__cuda_local_var_44457_16_non_const_gpu->sim).interaction_threads_per_block)) , (void)((((__T219.x) = __T220) , (void)((__T219.y) = 1U)) , ((__T219.z) = 1U)))) , __T219), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z40kFindBlocksWithInteractionsCutoff_kernelv());
{  enum cudaError __cuda_local_var_44477_27_non_const_status;
# 139 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
__cuda_local_var_44477_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_44477_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T266;
 struct _ZSs __T267;
 struct _ZSs __T268;
 struct _ZSs __T269;
 _ZSt6string __T270;
...
# 139 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
((((((__T266 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T272 = __T266) , (void)(__T273 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T267), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T268), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T269), ((_ZNSsC1EPKcRKSaIcE((&__T270), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T271))) , (((const struct _ZSaIcE *)&__T271))))) , (((const struct _ZSs *)&__T270))), (cudaGetErrorString(__cuda_local_var_44477_27_non_const_status)))) , (((const struct _ZSs *)&__T269))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T268))), ((const char *)"kFindBlocksWithInteractionsCutoff"))) , (((const _ZSt6string *)&__T267))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T272->__b_St9exception)))) , (void)(((__T272->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T272->message)), __T273)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T267)))) , (void)(_ZNSsD1Ev((&__T268)))) , (void)(_ZNSsD1Ev((&__T269)))) , (void)(_ZNSsD1Ev((&__T270)))) , (void)(_ZNSaIcED1Ev((&__T271))); } } ;
compactStream((((const struct compactionPlan *)&(__cuda_local_var_44457_16_non_const_gpu->compactPlan))), ((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractingWorkUnit), ((const unsigned *)((__cuda_local_var_44457_16_non_const_gpu->sim).pWorkUnit)), ((const unsigned *)((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractionFlag)), ((size_t)((__cuda_local_var_44457_16_non_const_gpu->sim).workUnits)), ((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractionCount));
(cudaConfigureCall((((void)((__T222 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T221.x) = __T222) , (void)((__T221.y) = 1U)) , ((__T221.z) = 1U)))) , __T221), (((void)((__T224 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block)) , (void)((((__T223.x) = __T224) , (void)((__T223.y) = 1U)) , ((__T223.z) = 1U)))) , __T223), (4UL * ((unsigned long)((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z42kFindInteractionsWithinBlocksCutoff_kernelPj(((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractingWorkUnit)));


if (__cuda_local_var_44457_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T274;
 unsigned __T275;
 struct dim3 __T276;
 unsigned __T277;
# 145 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
(cudaConfigureCall((((void)((__T275 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T274.x) = __T275) , (void)((__T274.y) = 1U)) , ((__T274.z) = 1U)))) , __T274), (((void)((__T277 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block)) , (void)((((__T276.x) = __T277) , (void)((__T276.y) = 1U)) , ((__T276.z) = 1U)))) , __T276), (52UL * ((unsigned long)((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z47kCalculateCDLJSoftcoreCutoffByWarpForces_kernelPj(((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T278;
 unsigned __T279;
 struct dim3 __T280;
 unsigned __T281;
# 148 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
(cudaConfigureCall((((void)((__T279 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T278.x) = __T279) , (void)((__T278.y) = 1U)) , ((__T278.z) = 1U)))) , __T278), (((void)((__T281 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block)) , (void)((((__T280.x) = __T281) , (void)((__T280.y) = 1U)) , ((__T280.z) = 1U)))) , __T280), (52UL * ((unsigned long)((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z41kCalculateCDLJSoftcoreCutoffForces_kernelPj(((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractingWorkUnit))); }


{  enum cudaError __cuda_local_var_44489_27_non_const_status;
# 151 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
__cuda_local_var_44489_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_44489_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T282;
 struct _ZSs __T283;
 struct _ZSs __T284;
 struct _ZSs __T285;
 _ZSt6string __T286;
...
# 151 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
((((((__T282 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T288 = __T282) , (void)(__T289 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T283), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T284), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T285), ((_ZNSsC1EPKcRKSaIcE((&__T286), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T287))) , (((const struct _ZSaIcE *)&__T287))))) , (((const struct _ZSs *)&__T286))), (cudaGetErrorString(__cuda_local_var_44489_27_non_const_status)))) , (((const struct _ZSs *)&__T285))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T284))), ((const char *)"kCalculateCDLJSoftcoreCutoffForces"))) , (((const _ZSt6string *)&__T283))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T288->__b_St9exception)))) , (void)(((__T288->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T288->message)), __T289)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T283)))) , (void)(_ZNSsD1Ev((&__T284)))) , (void)(_ZNSsD1Ev((&__T285)))) , (void)(_ZNSsD1Ev((&__T286)))) , (void)(_ZNSaIcED1Ev((&__T287))); } } ;
goto __T257;

case 2:

(cudaConfigureCall((((void)((__T226 = ((((__cuda_local_var_44457_16_non_const_gpu->psGridBoundingBox)->_length) + 63U) / 64U)) , (void)((((__T225.x) = __T226) , (void)((__T225.y) = 1U)) , ((__T225.z) = 1U)))) , __T225), (((void)((((__T227.x) = 64U) , (void)((__T227.y) = 1U)) , (void)((__T227.z) = 1U))) , __T227), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z31kFindBlockBoundsPeriodic_kernelv());
{  enum cudaError __cuda_local_var_44495_27_non_const_status;
# 157 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
__cuda_local_var_44495_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_44495_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T290;
 struct _ZSs __T291;
 struct _ZSs __T292;
 struct _ZSs __T293;
 _ZSt6string __T294;
 struct _ZSaIcE __T295;
 struct _ZN6OpenMM15OpenMMExceptionE *__T296;
 const _ZSt6string *__T297;
# 157 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
((((((__T290 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T296 = __T290) , (void)(__T297 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T291), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T292), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T293), ((_ZNSsC1EPKcRKSaIcE((&__T294), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T295))) , (((const struct _ZSaIcE *)&__T295))))) , (((const struct _ZSs *)&__T294))), (cudaGetErrorString(__cuda_local_var_44495_27_non_const_status)))) , (((const struct _ZSs *)&__T293))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T292))), ((const char *)"kFindBlockBoundsPeriodic"))) , (((const _ZSt6string *)&__T291))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T296->__b_St9exception)))) , (void)(((__T296->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T296->message)), __T297)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T291)))) , (void)(_ZNSsD1Ev((&__T292)))) , (void)(_ZNSsD1Ev((&__T293)))) , (void)(_ZNSsD1Ev((&__T294)))) , (void)(_ZNSaIcED1Ev((&__T295))); } } ;
(cudaConfigureCall((((void)((__T229 = ((__cuda_local_var_44457_16_non_const_gpu->sim).interaction_blocks)) , (void)((((__T228.x) = __T229) , (void)((__T228.y) = 1U)) , ((__T228.z) = 1U)))) , __T228), (((void)((__T231 = ((__cuda_local_var_44457_16_non_const_gpu->sim).interaction_threads_per_block)) , (void)((((__T230.x) = __T231) , (void)((__T230.y) = 1U)) , ((__T230.z) = 1U)))) , __T230), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z42kFindBlocksWithInteractionsPeriodic_kernelv());
{  enum cudaError __cuda_local_var_44497_27_non_const_status;
# 159 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
__cuda_local_var_44497_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_44497_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T298;
 struct _ZSs __T299;
 struct _ZSs __T2100;
 struct _ZSs __T2101;
 _ZSt6string __T2102;
 struct _ZSaIcE __T2103;
 struct _ZN6OpenMM15OpenMMExceptionE *__T2104;
 const _ZSt6string *__T2105;
# 159 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
((((((__T298 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2104 = __T298) , (void)(__T2105 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T299), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2100), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2101), ((_ZNSsC1EPKcRKSaIcE((&__T2102), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2103))) , (((const struct _ZSaIcE *)&__T2103))))) , (((const struct _ZSs *)&__T2102))), (cudaGetErrorString(__cuda_local_var_44497_27_non_const_status)))) , (((const struct _ZSs *)&__T2101))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2100))), ((const char *)"kFindBlocksWithInteractionsPeriodic"))) , (((const _ZSt6string *)&__T299))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2104->__b_St9exception)))) , (void)(((__T2104->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2104->message)), __T2105)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T299)))) , (void)(_ZNSsD1Ev((&__T2100)))) , (void)(_ZNSsD1Ev((&__T2101)))) , (void)(_ZNSsD1Ev((&__T2102)))) , (void)(_ZNSaIcED1Ev((&__T2103))); } } ;
compactStream((((const struct compactionPlan *)&(__cuda_local_var_44457_16_non_const_gpu->compactPlan))), ((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractingWorkUnit), ((const unsigned *)((__cuda_local_var_44457_16_non_const_gpu->sim).pWorkUnit)), ((const unsigned *)((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractionFlag)), ((size_t)((__cuda_local_var_44457_16_non_const_gpu->sim).workUnits)), ((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractionCount));
(cudaConfigureCall((((void)((__T233 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T232.x) = __T233) , (void)((__T232.y) = 1U)) , ((__T232.z) = 1U)))) , __T232), (((void)((__T235 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block)) , (void)((((__T234.x) = __T235) , (void)((__T234.y) = 1U)) , ((__T234.z) = 1U)))) , __T234), (4UL * ((unsigned long)((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z44kFindInteractionsWithinBlocksPeriodic_kernelPj(((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractingWorkUnit)));

if (__cuda_local_var_44457_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T2106;
 unsigned __T2107;
 struct dim3 __T2108;
 unsigned __T2109;
# 164 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
(cudaConfigureCall((((void)((__T2107 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T2106.x) = __T2107) , (void)((__T2106.y) = 1U)) , ((__T2106.z) = 1U)))) , __T2106), (((void)((__T2109 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block)) , (void)((((__T2108.x) = __T2109) , (void)((__T2108.y) = 1U)) , ((__T2108.z) = 1U)))) , __T2108), (52UL * ((unsigned long)((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z49kCalculateCDLJSoftcorePeriodicByWarpForces_kernelPj(((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T2110;
 unsigned __T2111;
 struct dim3 __T2112;
 unsigned __T2113;
# 167 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
(cudaConfigureCall((((void)((__T2111 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T2110.x) = __T2111) , (void)((__T2110.y) = 1U)) , ((__T2110.z) = 1U)))) , __T2110), (((void)((__T2113 = ((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block)) , (void)((((__T2112.x) = __T2113) , (void)((__T2112.y) = 1U)) , ((__T2112.z) = 1U)))) , __T2112), (52UL * ((unsigned long)((__cuda_local_var_44457_16_non_const_gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z43kCalculateCDLJSoftcorePeriodicForces_kernelPj(((__cuda_local_var_44457_16_non_const_gpu->sim).pInteractingWorkUnit))); }

{  enum cudaError __cuda_local_var_44507_27_non_const_status;
# 169 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
__cuda_local_var_44507_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_44507_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T2114;
 struct _ZSs __T2115;
 struct _ZSs __T2116;
 struct _ZSs __T2117;
 _ZSt6string __T2118;
...
# 169 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateNonbondedSoftcore.cu"
((((((__T2114 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T2120 = __T2114) , (void)(__T2121 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2115), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2116), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T2117), ((_ZNSsC1EPKcRKSaIcE((&__T2118), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T2119))) , (((const struct _ZSaIcE *)&__T2119))))) , (((const struct _ZSs *)&__T2118))), (cudaGetErrorString(__cuda_local_var_44507_27_non_const_status)))) , (((const struct _ZSs *)&__T2117))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T2116))), ((const char *)"kCalculateCDLJSoftcorePeriodicForces"))) , (((const _ZSt6string *)&__T2115))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T2120->__b_St9exception)))) , (void)(((__T2120->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T2120->message)), __T2121)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T2115)))) , (void)(_ZNSsD1Ev((&__T2116)))) , (void)(_ZNSsD1Ev((&__T2117)))) , (void)(_ZNSsD1Ev((&__T2118)))) , (void)(_ZNSaIcED1Ev((&__T2119))); } } ;
goto __T257;

default:
(((__T236 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T239 = __T236) , (void)(__T240 = ((_ZNSsC1EPKcRKSaIcE((((_ZSt6string *)&__T237)), ((const char *)"Nonbonded softcore method not recognized."), ((_ZNSaIcEC1Ev((&__T238))) , (((const struct _ZSaIcE *)&__T238))))) , ((const _ZSt6string *)&__T237)))) , (void)(((_ZNSt9exceptionC1Ev((&(__T239->__b_St9exception)))) , (void)(((__T239->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T239->message)), __T240)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev(((struct _ZSs *)((const _ZSt6string *)&__T237))))) , (void)(_ZNSaIcED1Ev((&__T238)));
...
{  _ZNSs14allocator_typeE __T2162;
 struct _ZNSs4_RepE *__T2163;
 const struct _ZSaIcE *__T2164;
 void *__T2165;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T2163 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T2164 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T2162)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T2162))))) , (void)((__builtin_expect(((long)(__T2163 != ((__T2165 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T2165)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T2163->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T2163, __T2164)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T2162)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2166) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2167) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T2167);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T2168,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T2168, __lhs);
_ZNSs6appendEPKcm(__T2168, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 75 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/atomicity.h" 3
...
return ((__T2169 = (*__mem)) , (void)((*__mem) += __val)) , __T2169; }



}
static void __sti___46_kCalculateNonbondedSoftcore_compute_20_cpp1_ii_7c2e594b(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kCalculateNonbondedSoftcore.compute_11.cudafe1.stub.c"
