...
{
 enum cudaError __cuda_local_var_43097_17_non_const_status;
__cuda_local_var_43097_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&((gpu->gpuContext)->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_43097_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 106 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
 unsigned __cuda_local_var_45006_18_non_const_threadsPerBlock;


 gpuContext __cuda_local_var_45009_16_non_const_gpu;
 unsigned __cuda_local_var_45010_18_non_const_methodIndex;
# 109 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
__cuda_local_var_45009_16_non_const_gpu = (freeEnergyGpu->gpuContext);
__cuda_local_var_45010_18_non_const_methodIndex = ((unsigned)((freeEnergyGpu->freeEnergySim).nonbondedMethod));

if (__cuda_local_var_45010_18_non_const_methodIndex > 2U) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 _ZSt6string __T28;
...
if (((natoms)[__cuda_local_var_45010_18_non_const_methodIndex]) != ((unsigned)(__cuda_local_var_45009_16_non_const_gpu->natoms))) {  unsigned __T212;
 unsigned __cuda_local_var_45017_22_non_const_extra;
# 117 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
__cuda_local_var_45017_22_non_const_extra = ((unsigned)((__cuda_local_var_45010_18_non_const_methodIndex == 0U) ? 0UL : 12UL));
((threadsPerBlockPerMethod)[__cuda_local_var_45010_18_non_const_methodIndex]) = (*(_ZSt3minIjERKT_S2_S2_(((__T212 = (getThreadsPerBlockFEP(freeEnergyGpu, ((unsigned)(40UL + ((unsigned long)__cuda_local_var_45017_22_non_const_extra))), (__cuda_local_var_45009_16_non_const_gpu->sharedMemoryPerBlock)))) , (((const unsigned *)&__T212))), (((const unsigned *)&((__cuda_local_var_45009_16_non_const_gpu->sim).nonbond_threads_per_block))))));
((natoms)[__cuda_local_var_45010_18_non_const_methodIndex]) = ((unsigned)(__cuda_local_var_45009_16_non_const_gpu->natoms));
}
__cuda_local_var_45006_18_non_const_threadsPerBlock = ((threadsPerBlockPerMethod)[__cuda_local_var_45010_18_non_const_methodIndex]);
...
if (__cuda_local_var_45009_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T213;
 unsigned __T214;
 struct dim3 __T215;
# 129 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T214 = ((__cuda_local_var_45009_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T213.x) = __T214) , (void)((__T213.y) = 1U)) , ((__T213.z) = 1U)))) , __T213), (((void)((((__T215.x) = __cuda_local_var_45006_18_non_const_threadsPerBlock) , (void)((__T215.y) = 1U)) , (void)((__T215.z) = 1U))) , __T215), (40UL * ((unsigned long)__cuda_local_var_45006_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z44kCalculateGBVISoftcoreN2ByWarpForces2_kernelPj(((__cuda_local_var_45009_16_non_const_gpu->sim).pWorkUnit))); } else  {  struct dim3 __T216;
 unsigned __T217;
 struct dim3 __T218;
(cudaConfigureCall((((void)((__T217 = ((__cuda_local_var_45009_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T216.x) = __T217) , (void)((__T216.y) = 1U)) , ((__T216.z) = 1U)))) , __T216), (((void)((((__T218.x) = __cuda_local_var_45006_18_non_const_threadsPerBlock) , (void)((__T218.y) = 1U)) , (void)((__T218.z) = 1U))) , __T218), (40UL * ((unsigned long)__cuda_local_var_45006_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z38kCalculateGBVISoftcoreN2Forces2_kernelPj(((__cuda_local_var_45009_16_non_const_gpu->sim).pWorkUnit))); }

goto __T219;

case 1:

if (__cuda_local_var_45009_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T220;
 unsigned __T221;
 struct dim3 __T222;
# 139 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T221 = ((__cuda_local_var_45009_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T220.x) = __T221) , (void)((__T220.y) = 1U)) , ((__T220.z) = 1U)))) , __T220), (((void)((((__T222.x) = __cuda_local_var_45006_18_non_const_threadsPerBlock) , (void)((__T222.y) = 1U)) , (void)((__T222.z) = 1U))) , __T222), (52UL * ((unsigned long)__cuda_local_var_45006_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z48kCalculateGBVISoftcoreCutoffByWarpForces2_kernelPj(((__cuda_local_var_45009_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T223;
 unsigned __T224;
 struct dim3 __T225;
(cudaConfigureCall((((void)((__T224 = ((__cuda_local_var_45009_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T223.x) = __T224) , (void)((__T223.y) = 1U)) , ((__T223.z) = 1U)))) , __T223), (((void)((((__T225.x) = __cuda_local_var_45006_18_non_const_threadsPerBlock) , (void)((__T225.y) = 1U)) , (void)((__T225.z) = 1U))) , __T225), (52UL * ((unsigned long)__cuda_local_var_45006_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z42kCalculateGBVISoftcoreCutoffForces2_kernelPj(((__cuda_local_var_45009_16_non_const_gpu->sim).pInteractingWorkUnit))); }

goto __T219;

case 2:

if (__cuda_local_var_45009_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T226;
 unsigned __T227;
 struct dim3 __T228;
# 149 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T227 = ((__cuda_local_var_45009_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T226.x) = __T227) , (void)((__T226.y) = 1U)) , ((__T226.z) = 1U)))) , __T226), (((void)((((__T228.x) = __cuda_local_var_45006_18_non_const_threadsPerBlock) , (void)((__T228.y) = 1U)) , (void)((__T228.z) = 1U))) , __T228), (52UL * ((unsigned long)__cuda_local_var_45006_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z50kCalculateGBVISoftcorePeriodicByWarpForces2_kernelPj(((__cuda_local_var_45009_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T229;
 unsigned __T230;
 struct dim3 __T231;
(cudaConfigureCall((((void)((__T230 = ((__cuda_local_var_45009_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T229.x) = __T230) , (void)((__T229.y) = 1U)) , ((__T229.z) = 1U)))) , __T229), (((void)((((__T231.x) = __cuda_local_var_45006_18_non_const_threadsPerBlock) , (void)((__T231.y) = 1U)) , (void)((__T231.z) = 1U))) , __T231), (52UL * ((unsigned long)__cuda_local_var_45006_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z44kCalculateGBVISoftcorePeriodicForces2_kernelPj(((__cuda_local_var_45009_16_non_const_gpu->sim).pInteractingWorkUnit))); }

goto __T219;

} __T219:;
{  enum cudaError __cuda_local_var_45057_19_non_const_status;
# 157 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
__cuda_local_var_45057_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_45057_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T232;
 struct _ZSs __T233;
 struct _ZSs __T234;
 struct _ZSs __T235;
 _ZSt6string __T236;
...
#include "kCalculateGBVISoftcoreForces2.compute_12.cudafe1.stub.c"
