...
{
 enum cudaError __cuda_local_var_60933_17_non_const_status;
__cuda_local_var_60933_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&((freeEnergyGpu->gpuContext)->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_60933_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 103 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
 unsigned __cuda_local_var_63163_18_non_const_threadsPerBlock;


 gpuContext __cuda_local_var_63166_16_non_const_gpu;
 unsigned __cuda_local_var_63167_18_non_const_methodIndex;
# 106 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
__cuda_local_var_63166_16_non_const_gpu = (freeEnergyGpu->gpuContext);
__cuda_local_var_63167_18_non_const_methodIndex = ((unsigned)((freeEnergyGpu->freeEnergySim).nonbondedMethod));

if (__cuda_local_var_63167_18_non_const_methodIndex > 2U) {  struct _ZN6OpenMM15OpenMMExceptionE *__T214;
 _ZSt6string __T215;
...
if (((natoms)[__cuda_local_var_63167_18_non_const_methodIndex]) != ((unsigned)(__cuda_local_var_63166_16_non_const_gpu->natoms))) {  unsigned __T219;
 unsigned __cuda_local_var_63174_22_non_const_extra;
# 114 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
__cuda_local_var_63174_22_non_const_extra = ((unsigned)((__cuda_local_var_63167_18_non_const_methodIndex == 0U) ? 0UL : 12UL));
((threadsPerBlockPerMethod)[__cuda_local_var_63167_18_non_const_methodIndex]) = (*(_ZSt3minIjERKT_S2_S2_(((__T219 = (getThreadsPerBlockFEP(freeEnergyGpu, ((unsigned)(40UL + ((unsigned long)__cuda_local_var_63174_22_non_const_extra))), (__cuda_local_var_63166_16_non_const_gpu->sharedMemoryPerBlock)))) , (((const unsigned *)&__T219))), (((const unsigned *)&((__cuda_local_var_63166_16_non_const_gpu->sim).nonbond_threads_per_block))))));
((natoms)[__cuda_local_var_63167_18_non_const_methodIndex]) = ((unsigned)(__cuda_local_var_63166_16_non_const_gpu->natoms));
}
__cuda_local_var_63163_18_non_const_threadsPerBlock = ((threadsPerBlockPerMethod)[__cuda_local_var_63167_18_non_const_methodIndex]);

switch ((int)((freeEnergyGpu->freeEnergySim).nonbondedMethod))
{
case 0:

if (__cuda_local_var_63166_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T220;
 unsigned __T221;
 struct dim3 __T222;
# 125 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T221 = ((__cuda_local_var_63166_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T220.x) = __T221) , (void)((__T220.y) = 1U)) , ((__T220.z) = 1U)))) , __T220), (((void)((((__T222.x) = __cuda_local_var_63163_18_non_const_threadsPerBlock) , (void)((__T222.y) = 1U)) , (void)((__T222.z) = 1U))) , __T222), (40UL * ((unsigned long)__cuda_local_var_63163_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z47kCalculateObcGbsaSoftcoreN2ByWarpForces2_kernelPj(((__cuda_local_var_63166_16_non_const_gpu->sim).pWorkUnit))); } else  {  struct dim3 __T223;
 unsigned __T224;
 struct dim3 __T225;
(cudaConfigureCall((((void)((__T224 = ((__cuda_local_var_63166_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T223.x) = __T224) , (void)((__T223.y) = 1U)) , ((__T223.z) = 1U)))) , __T223), (((void)((((__T225.x) = __cuda_local_var_63163_18_non_const_threadsPerBlock) , (void)((__T225.y) = 1U)) , (void)((__T225.z) = 1U))) , __T225), (40UL * ((unsigned long)__cuda_local_var_63163_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z41kCalculateObcGbsaSoftcoreN2Forces2_kernelPj(((__cuda_local_var_63166_16_non_const_gpu->sim).pWorkUnit))); }

goto __T226;

case 1:

if (__cuda_local_var_63166_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T227;
 unsigned __T228;
 struct dim3 __T229;
# 135 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T228 = ((__cuda_local_var_63166_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T227.x) = __T228) , (void)((__T227.y) = 1U)) , ((__T227.z) = 1U)))) , __T227), (((void)((((__T229.x) = __cuda_local_var_63163_18_non_const_threadsPerBlock) , (void)((__T229.y) = 1U)) , (void)((__T229.z) = 1U))) , __T229), (52UL * ((unsigned long)__cuda_local_var_63163_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z51kCalculateObcGbsaSoftcoreCutoffByWarpForces2_kernelPj(((__cuda_local_var_63166_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T230;
 unsigned __T231;
 struct dim3 __T232;
(cudaConfigureCall((((void)((__T231 = ((__cuda_local_var_63166_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T230.x) = __T231) , (void)((__T230.y) = 1U)) , ((__T230.z) = 1U)))) , __T230), (((void)((((__T232.x) = __cuda_local_var_63163_18_non_const_threadsPerBlock) , (void)((__T232.y) = 1U)) , (void)((__T232.z) = 1U))) , __T232), (52UL * ((unsigned long)__cuda_local_var_63163_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z45kCalculateObcGbsaSoftcoreCutoffForces2_kernelPj(((__cuda_local_var_63166_16_non_const_gpu->sim).pInteractingWorkUnit))); }

goto __T226;

case 2:

if (__cuda_local_var_63166_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T233;
 unsigned __T234;
 struct dim3 __T235;
# 145 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T234 = ((__cuda_local_var_63166_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T233.x) = __T234) , (void)((__T233.y) = 1U)) , ((__T233.z) = 1U)))) , __T233), (((void)((((__T235.x) = __cuda_local_var_63163_18_non_const_threadsPerBlock) , (void)((__T235.y) = 1U)) , (void)((__T235.z) = 1U))) , __T235), (52UL * ((unsigned long)__cuda_local_var_63163_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z53kCalculateObcGbsaSoftcorePeriodicByWarpForces2_kernelPj(((__cuda_local_var_63166_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T236;
 unsigned __T237;
 struct dim3 __T238;
(cudaConfigureCall((((void)((__T237 = ((__cuda_local_var_63166_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T236.x) = __T237) , (void)((__T236.y) = 1U)) , ((__T236.z) = 1U)))) , __T236), (((void)((((__T238.x) = __cuda_local_var_63163_18_non_const_threadsPerBlock) , (void)((__T238.y) = 1U)) , (void)((__T238.z) = 1U))) , __T238), (52UL * ((unsigned long)__cuda_local_var_63163_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z47kCalculateObcGbsaSoftcorePeriodicForces2_kernelPj(((__cuda_local_var_63166_16_non_const_gpu->sim).pInteractingWorkUnit))); }

goto __T226;
} __T226:;
{  enum cudaError __cuda_local_var_63212_19_non_const_status;
# 152 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
__cuda_local_var_63212_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_63212_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T239;
 struct _ZSs __T240;
 struct _ZSs __T241;
 struct _ZSs __T242;
 _ZSt6string __T243;
...
#include "kCalculateObcGbsaSoftcoreForces2.compute_20.cudafe1.stub.c"
