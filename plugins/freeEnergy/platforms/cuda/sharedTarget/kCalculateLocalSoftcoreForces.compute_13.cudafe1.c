...
{
 enum cudaError __cuda_local_var_41385_17_non_const_status;
__cuda_local_var_41385_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&((gpu->gpuContext)->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41385_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 54 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
 unsigned __cuda_local_var_41399_18_non_const_LJ14s;



 struct _Z10CUDAStreamI4int4E *__cuda_local_var_41403_23_non_const_psLJ14ID;



 struct _Z10CUDAStreamI6float4E *__cuda_local_var_41407_25_non_const_psLJ14Parameter;


 struct _ZSt6vectorIiSaIiEE __cuda_local_var_41410_22_non_const_outputBufferCounter;
# 54 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
__cuda_local_var_41399_18_non_const_LJ14s = ((unsigned)(_ZNKSt6vectorIiSaIiEE4sizeEv(atom1)));
((gpu->freeEnergySim).LJ14_count) = __cuda_local_var_41399_18_non_const_LJ14s;

(((__T214 = 0) , (void)(__T215 = 0)) , (void)(__T216 = 0)) , (void)((((gpu->psLJ14ID) = ((struct _Z10CUDAStreamI4int4E *)((__T217 = ((struct _Z10CUDAStreamI4int4E *)(_Znwm(64UL)))) ? ((((__T216 = 1) , (void)(_ZN10CUDAStreamI4int4EC1EjiSs(__T217, __cuda_local_var_41399_18_non_const_LJ14s, 1, ((_ZNSsC1EPKcRKSaIcE((&__T218), ((const char *)"LJ14SoftcoreID"), ((_ZNSaIcEC1Ev((&__T219))) , ((__T215 = 1) , (((const struct _ZSaIcE *)&__T219)))))) , ((__T214 = 1) , (&__T218)))))) , (void)(__T216 = 0)) , __T217) : ((struct _Z10CUDAStreamI4int4E *)0LL)))) , (void)((__T214) ? ((_ZNSsD1Ev((&__T218))) , (void)((void)0)) : ((void)0))) , (void)((__T215) ? ((_ZNSaIcED1Ev((&__T219))) , (void)((void)0)) : ((void)0)));
__cuda_local_var_41403_23_non_const_psLJ14ID = (gpu->psLJ14ID);
((gpu->freeEnergySim).pLJ14ID) = (__cuda_local_var_41403_23_non_const_psLJ14ID->_pDevData);

(((__T220 = 0) , (void)(__T221 = 0)) , (void)(__T222 = 0)) , (void)((((gpu->psLJ14Parameter) = ((struct _Z10CUDAStreamI6float4E *)((__T223 = ((struct _Z10CUDAStreamI6float4E *)(_Znwm(64UL)))) ? ((((__T222 = 1) , (void)(_ZN10CUDAStreamI6float4EC1EjiSs(__T223, __cuda_local_var_41399_18_non_const_LJ14s, 1, ((_ZNSsC1EPKcRKSaIcE((&__T224), ((const char *)"LJ14SoftcoreParameter"), ((_ZNSaIcEC1Ev((&__T225))) , ((__T221 = 1) , (((const struct _ZSaIcE *)&__T225)))))) , ((__T220 = 1) , (&__T224)))))) , (void)(__T222 = 0)) , __T223) : ((struct _Z10CUDAStreamI6float4E *)0LL)))) , (void)((__T220) ? ((_ZNSsD1Ev((&__T224))) , (void)((void)0)) : ((void)0))) , (void)((__T221) ? ((_ZNSaIcED1Ev((&__T225))) , (void)((void)0)) : ((void)0)));
__cuda_local_var_41407_25_non_const_psLJ14Parameter = (gpu->psLJ14Parameter);
((gpu->freeEnergySim).pLJ14Parameter) = (__cuda_local_var_41407_25_non_const_psLJ14Parameter->_pDevData);

_ZNSt6vectorIiSaIiEEC1EmRKiRKS0_((&__cuda_local_var_41410_22_non_const_outputBufferCounter), ((_ZNSt6vectorIiSaIiEE9size_typeE)(((gpu->gpuContext)->sim).atoms)), ((__T226 = 0) , (((const _ZNSt6vectorIiSaIiEE10value_typeE *)&__T226))), ((_ZNSaIiEC1Ev((&__T227))) , (((const _ZNSt6vectorIiSaIiEE14allocator_typeE *)&__T227)))); _ZNSaIiED1Ev((&__T227)); {

 int ii;
# 67 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
ii = 0; for (; (((unsigned)ii) < __cuda_local_var_41399_18_non_const_LJ14s); ii++) {
# 74 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
 float __cuda_local_var_41419_15_non_const_p0;
# 74 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
 float __cuda_local_var_41419_19_non_const_p1;
# 74 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
 float __cuda_local_var_41419_23_non_const_p2;
# 74 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
 float __cuda_local_var_41419_27_non_const_p3;
# 69 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
((_ZN10CUDAStreamI4int4EixEi(__cuda_local_var_41403_23_non_const_psLJ14ID, ii))->x) = (*(_ZNKSt6vectorIiSaIiEEixEm(atom1, ((_ZNSt6vectorIiSaIiEE9size_typeE)ii))));
((_ZN10CUDAStreamI4int4EixEi(__cuda_local_var_41403_23_non_const_psLJ14ID, ii))->y) = (*(_ZNKSt6vectorIiSaIiEEixEm(atom2, ((_ZNSt6vectorIiSaIiEE9size_typeE)ii))));
((_ZN10CUDAStreamI4int4EixEi(__cuda_local_var_41403_23_non_const_psLJ14ID, ii))->z) = ((*(_ZNSt6vectorIiSaIiEEixEm((&__cuda_local_var_41410_22_non_const_outputBufferCounter), ((_ZNSt6vectorIiSaIiEE9size_typeE)(*(_ZNKSt6vectorIiSaIiEEixEm(atom1, ((_ZNSt6vectorIiSaIiEE9size_typeE)ii))))))))++);
((_ZN10CUDAStreamI4int4EixEi(__cuda_local_var_41403_23_non_const_psLJ14ID, ii))->w) = ((*(_ZNSt6vectorIiSaIiEEixEm((&__cuda_local_var_41410_22_non_const_outputBufferCounter), ((_ZNSt6vectorIiSaIiEE9size_typeE)(*(_ZNKSt6vectorIiSaIiEEixEm(atom2, ((_ZNSt6vectorIiSaIiEE9size_typeE)ii))))))))++);


if ((*(_ZNKSt6vectorIfSaIfEEixEm(c12, ((_ZNSt6vectorIfSaIfEE9size_typeE)ii)))) == (0.0F)) {
__cuda_local_var_41419_15_non_const_p0 = (0.0F);
__cuda_local_var_41419_19_non_const_p1 = (1.0F);

} else  {  float __T228;
__cuda_local_var_41419_15_non_const_p0 = (((*(_ZNKSt6vectorIfSaIfEEixEm(c6, ((_ZNSt6vectorIfSaIfEE9size_typeE)ii)))) * (*(_ZNKSt6vectorIfSaIfEEixEm(c6, ((_ZNSt6vectorIfSaIfEE9size_typeE)ii))))) / (*(_ZNKSt6vectorIfSaIfEEixEm(c12, ((_ZNSt6vectorIfSaIfEE9size_typeE)ii)))));
__cuda_local_var_41419_19_non_const_p1 = ((__T228 = ((*(_ZNKSt6vectorIfSaIfEEixEm(c12, ((_ZNSt6vectorIfSaIfEE9size_typeE)ii)))) / (*(_ZNKSt6vectorIfSaIfEEixEm(c6, ((_ZNSt6vectorIfSaIfEE9size_typeE)ii)))))) , (__builtin_powf(__T228, (0.1666666716F))));
}

__cuda_local_var_41419_23_non_const_p2 = (epsfac * (*(_ZNKSt6vectorIfSaIfEEixEm(qProd, ((_ZNSt6vectorIfSaIfEE9size_typeE)ii)))));
__cuda_local_var_41419_27_non_const_p3 = (*(_ZNKSt6vectorIfSaIfEEixEm(softcoreLJLambdaArray, ((_ZNSt6vectorIfSaIfEE9size_typeE)ii))));

((_ZN10CUDAStreamI6float4EixEi(__cuda_local_var_41407_25_non_const_psLJ14Parameter, ii))->x) = __cuda_local_var_41419_15_non_const_p0;
((_ZN10CUDAStreamI6float4EixEi(__cuda_local_var_41407_25_non_const_psLJ14Parameter, ii))->y) = __cuda_local_var_41419_19_non_const_p1;
((_ZN10CUDAStreamI6float4EixEi(__cuda_local_var_41407_25_non_const_psLJ14Parameter, ii))->z) = __cuda_local_var_41419_23_non_const_p2;
((_ZN10CUDAStreamI6float4EixEi(__cuda_local_var_41407_25_non_const_psLJ14Parameter, ii))->w) = __cuda_local_var_41419_27_non_const_p3;
} }
...
if (gpu->log) {
 ...
 unsigned __cuda_local_var_41443_22_non_const_maxPrint;
...
__cuda_local_var_41443_22_non_const_maxPrint = 10U; {
 unsigned ii;
# 99 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
ii = 0U; for (; (ii < __cuda_local_var_41399_18_non_const_LJ14s); ii++) {
(void)(fprintf((gpu->log), ((const char *)"    %5d [%5d %5d %5d %5d] %15.7e %15.7e %15.7e %15.7e\n"), ii, ((_ZN10CUDAStreamI4int4EixEi(__cuda_local_var_41403_23_non_const_psLJ14ID, ((int)ii)))->x), ((_ZN10CUDAStreamI4int4EixEi(__cuda_local_var_41403_23_non_const_psLJ14ID, ((int)ii)))->y), ((_ZN10CUDAStreamI4int4EixEi(__cuda_local_var_41403_23_non_const_psLJ14ID, ((int)ii)))->z), ((_ZN10CUDAStreamI4int4EixEi(__cuda_local_var_41403_23_non_const_psLJ14ID, ((int)ii)))->w), ((double)((_ZN10CUDAStreamI6float4EixEi(__cuda_local_var_41407_25_non_const_psLJ14Parameter, ((int)ii)))->x)), ((double)((_ZN10CUDAStreamI6float4EixEi(__cuda_local_var_41407_25_non_const_psLJ14Parameter, ((int)ii)))->y)), ((double)(((_ZN10CUDAStreamI6float4EixEi(__cuda_local_var_41407_25_non_const_psLJ14Parameter, ((int)ii)))->z) / epsfac)), ((double)((_ZN10CUDAStreamI6float4EixEi(__cuda_local_var_41407_25_non_const_psLJ14Parameter, ((int)ii)))->w))));



if (ii == __cuda_local_var_41443_22_non_const_maxPrint) {
(void)(fprintf((gpu->log), ((const char *)"\n")));
ii = (__cuda_local_var_41399_18_non_const_LJ14s - __cuda_local_var_41443_22_non_const_maxPrint);
if (ii < __cuda_local_var_41443_22_non_const_maxPrint) { ii = __cuda_local_var_41443_22_non_const_maxPrint; }
}
} }
(void)(fprintf((gpu->log), ((const char *)"\n")));
...
(*((void (**)(struct _Z10CUDAStreamI4int4E *const))(((__cuda_local_var_41403_23_non_const_psLJ14ID->__b_15SoADeviceObject).__vptr) + 2)))(__cuda_local_var_41403_23_non_const_psLJ14ID);
(*((void (**)(struct _Z10CUDAStreamI6float4E *const))(((__cuda_local_var_41407_25_non_const_psLJ14Parameter->__b_15SoADeviceObject).__vptr) + 2)))(__cuda_local_var_41407_25_non_const_psLJ14Parameter); {

_ZNSt6vectorIiSaIiEED1Ev((&__cuda_local_var_41410_22_non_const_outputBufferCounter)); return; }
}
# 284 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
...
# 286 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
 gpuContext __cuda_local_var_41631_16_non_const_gpu;
# 286 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
__cuda_local_var_41631_16_non_const_gpu = (freeEnergyGpuContext->gpuContext);
(cudaConfigureCall((((void)((__T230 = ((__cuda_local_var_41631_16_non_const_gpu->sim).blocks)) , (void)((((__T229.x) = __T230) , (void)((__T229.y) = 1U)) , ((__T229.z) = 1U)))) , __T229), (((void)((__T232 = ((__cuda_local_var_41631_16_non_const_gpu->sim).localForces_threads_per_block)) , (void)((((__T231.x) = __T232) , (void)((__T231.y) = 1U)) , ((__T231.z) = 1U)))) , __T231), (((unsigned long)((__cuda_local_var_41631_16_non_const_gpu->sim).localForces_threads_per_block)) * 36UL), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z36kCalculateLocalSoftcoreForces_kernelv());
{  enum cudaError __cuda_local_var_41633_19_non_const_status;
# 288 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateLocalSoftcoreForces.cu"
__cuda_local_var_41633_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_41633_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T233;
 struct _ZSs __T234;
 struct _ZSs __T235;
 struct _ZSs __T236;
 _ZSt6string __T237;
...
{
 enum cudaError __cuda_local_var_35828_17_non_const_status;
...
__cuda_local_var_35828_17_non_const_status = (cudaMalloc(((void **)(&(this->_pDevData))), (((unsigned long)((this->_stride) * (this->_subStreams))) * 16UL)));
if (((int)__cuda_local_var_35828_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T244;
 struct _ZSs __T245;
 struct _ZSs __T246;
 _ZSt6string __T247;
 struct _ZSs __T248;
...
__cuda_local_var_35828_17_non_const_status = (cudaMalloc(((void **)(&(this->_pDevData))), (((unsigned long)((this->_stride) * (this->_subStreams))) * 16UL)));
if (((int)__cuda_local_var_35828_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T277;
 struct _ZSs __T278;
 struct _ZSs __T279;
 _ZSt6string __T280;
 struct _ZSs __T281;
...
{
 _ZNSt6vectorIiSaIiEE10value_typeE __cuda_local_var_18678_17_non_const___tmp;
# 756 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/stl_algobase.h" 3
__cuda_local_var_18678_17_non_const___tmp = (*__value);
for (; (__n > 0UL); (--__n) , (void)(++__first)) {
(*__first) = __cuda_local_var_18678_17_non_const___tmp; }
return __first;
}
# 119 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/stl_construct.h" 3
...
#include "kCalculateLocalSoftcoreForces.compute_13.cudafe1.stub.c"
