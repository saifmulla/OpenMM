...
# 1 "kCalculateGBVISoftcoreBornSum.compute_20.cudafe1.stub.c"
...
# 1 "kCalculateGBVISoftcoreBornSum.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2211) {  __nv_dummy_param_ref(__T2211); __cudaRegisterEntry(__T2211, ((void ( *)(void))kReduceGBVIBornForcesQuinticScaling_kernel), _Z42kReduceGBVIBornForcesQuinticScaling_kernelv, 512); __cudaRegisterEntry(__T2211, ((void ( *)(void))kReduceGBVIBornSumQuinticScaling_kernel), _Z39kReduceGBVIBornSumQuinticScaling_kernelv, 512); __cudaRegisterEntry(__T2211, ((void ( *)(unsigned *))kCalculateGBVISoftcorePeriodicByWarpBornSum_kernel), _Z50kCalculateGBVISoftcorePeriodicByWarpBornSum_kernelPj, 768); __cudaRegisterEntry(__T2211, ((void ( *)(unsigned *))kCalculateGBVISoftcorePeriodicBornSum_kernel), _Z44kCalculateGBVISoftcorePeriodicBornSum_kernelPj, 768); __cudaRegisterEntry(__T2211, ((void ( *)(unsigned *))kCalculateGBVISoftcoreCutoffByWarpBornSum_kernel), _Z48kCalculateGBVISoftcoreCutoffByWarpBornSum_kernelPj, 768); __cudaRegisterEntry(__T2211, ((void ( *)(unsigned *))kCalculateGBVISoftcoreCutoffBornSum_kernel), _Z42kCalculateGBVISoftcoreCutoffBornSum_kernelPj, 768); __cudaRegisterEntry(__T2211, ((void ( *)(unsigned *))kCalculateGBVISoftcoreN2ByWarpBornSum_kernel), _Z44kCalculateGBVISoftcoreN2ByWarpBornSum_kernelPj, 768); __cudaRegisterEntry(__T2211, ((void ( *)(unsigned *))kCalculateGBVISoftcoreN2BornSum_kernel), _Z38kCalculateGBVISoftcoreN2BornSum_kernelPj, 768); __cudaRegisterEntry(__T2211, ((void ( *)(void))kReduceGBVISoftcoreBornSum_kernel), _Z33kReduceGBVISoftcoreBornSum_kernelv, 512); __cudaRegisterEntry(__T2211, ((void ( *)(void))kReduceGBVISoftcoreBornForces_kernel), _Z36kReduceGBVISoftcoreBornForces_kernelv, 512); __cudaRegisterEntry(__T2211, ((void ( *)(void))kClearGBVISoftcoreBornSum_kernel), _Z32kClearGBVISoftcoreBornSum_kernelv, 512); __cudaRegisterVariable(__T2211, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T2211, __shadow_var(gbviSimDev,gbviSimDev), 0, 128, 1, 0); }
