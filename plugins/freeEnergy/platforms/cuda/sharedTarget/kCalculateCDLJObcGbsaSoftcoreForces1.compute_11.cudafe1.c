# 1 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
...
# 60 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
extern void SetCalculateCDLJObcGbsaSoftcoreGpu1Sim(freeEnergyGpuContext);
...
# 117 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
extern void _Z36kCalculateCDLJObcGbsaSoftcoreForces1P21_freeEnergyGpuContext(freeEnergyGpuContext);
...
static void __sti___55_kCalculateCDLJObcGbsaSoftcoreForces1_compute_20_cpp1_ii_16fab60b(void) __attribute__((__constructor__));
...
void SetCalculateCDLJObcGbsaSoftcoreGpu1Sim( freeEnergyGpuContext freeEnergyGpu) {
 ...
 enum cudaError __cuda_local_var_41864_17_non_const_status;
__cuda_local_var_41864_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&((freeEnergyGpu->gpuContext)->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41864_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 64 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
(((((__T20 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T25 = __T20) , (void)(__T26 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T21), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T22), ((_ZNSsC1EPKcRKSaIcE((&__T23), ((const char *)"cudaMemcpyToSymbol: SetCalculateCDLJObcGbsaSoftcoreGpu1Sim copy to cSim failed"), ((_ZNSaIcEC1Ev((&__T24))) , (((const struct _ZSaIcE *)&__T24))))) , (((const struct _ZSs *)&__T23))), ((const char *)" "))) , (((const struct _ZSs *)&__T22))), (cudaGetErrorString(__cuda_local_var_41864_17_non_const_status)))) , (((const _ZSt6string *)&__T21))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T25->__b_St9exception)))) , (void)(((__T25->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T25->message)), __T26)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T21)))) , (void)(_ZNSsD1Ev((&__T22)))) , (void)(_ZNSsD1Ev((&__T23)))) , (void)(_ZNSaIcED1Ev((&__T24))); } ;

__cuda_local_var_41864_17_non_const_status = (_Z18cudaMemcpyToSymbolI27cudaFreeEnergyGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaFreeEnergyGmxSimulation *)&feSimDev)), ((const void *)(&(freeEnergyGpu->freeEnergySim))), 128UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41864_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 117 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
void _Z36kCalculateCDLJObcGbsaSoftcoreForces1P21_freeEnergyGpuContext( freeEnergyGpuContext freeEnergyGpu)
{

static unsigned threadsPerBlockPerMethod[3] = {0U,0U,0U};
static unsigned natoms[3] = {0U,0U,0U};
# 119 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
 unsigned __cuda_local_var_45135_18_non_const_threadsPerBlock;


 gpuContext __cuda_local_var_45138_16_non_const_gpu;
 unsigned __cuda_local_var_45139_18_non_const_methodIndex;
# 122 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
__cuda_local_var_45138_16_non_const_gpu = (freeEnergyGpu->gpuContext);
__cuda_local_var_45139_18_non_const_methodIndex = ((unsigned)((freeEnergyGpu->freeEnergySim).nonbondedMethod));

if (__cuda_local_var_45139_18_non_const_methodIndex > 2U) {  struct _ZN6OpenMM15OpenMMExceptionE *__T214;
 _ZSt6string __T215;
 struct _ZSaIcE __T216;
 struct _ZN6OpenMM15OpenMMExceptionE *__T217;
 const _ZSt6string *__T218;
# 126 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
(((__T214 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T217 = __T214) , (void)(__T218 = ((_ZNSsC1EPKcRKSaIcE((((_ZSt6string *)&__T215)), ((const char *)"kCalculateCDLJObcGbsaSoftcoreForces1 method index invalid."), ((_ZNSaIcEC1Ev((&__T216))) , (((const struct _ZSaIcE *)&__T216))))) , ((const _ZSt6string *)&__T215)))) , (void)(((_ZNSt9exceptionC1Ev((&(__T217->__b_St9exception)))) , (void)(((__T217->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T217->message)), __T218)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev(((struct _ZSs *)((const _ZSt6string *)&__T215))))) , (void)(_ZNSaIcED1Ev((&__T216)));
}

if (((natoms)[__cuda_local_var_45139_18_non_const_methodIndex]) != ((unsigned)(__cuda_local_var_45138_16_non_const_gpu->natoms))) {  unsigned __T219;
 unsigned __cuda_local_var_45146_22_non_const_extra;
# 130 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
__cuda_local_var_45146_22_non_const_extra = ((unsigned)((__cuda_local_var_45139_18_non_const_methodIndex == 0U) ? 0UL : 4UL));
((threadsPerBlockPerMethod)[__cuda_local_var_45139_18_non_const_methodIndex]) = (*(_ZSt3minIjERKT_S2_S2_(((__T219 = (getThreadsPerBlockFEP(freeEnergyGpu, ((unsigned)(48UL + ((unsigned long)__cuda_local_var_45146_22_non_const_extra))), (__cuda_local_var_45138_16_non_const_gpu->sharedMemoryPerBlock)))) , (((const unsigned *)&__T219))), (((const unsigned *)&((__cuda_local_var_45138_16_non_const_gpu->sim).nonbond_threads_per_block))))));
((natoms)[__cuda_local_var_45139_18_non_const_methodIndex]) = ((unsigned)(__cuda_local_var_45138_16_non_const_gpu->natoms));
}
__cuda_local_var_45135_18_non_const_threadsPerBlock = ((threadsPerBlockPerMethod)[__cuda_local_var_45139_18_non_const_methodIndex]);
...
if (__cuda_local_var_45138_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T220;
 unsigned __T221;
 struct dim3 __T222;
# 142 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
(cudaConfigureCall((((void)((__T221 = ((__cuda_local_var_45138_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T220.x) = __T221) , (void)((__T220.y) = 1U)) , ((__T220.z) = 1U)))) , __T220), (((void)((((__T222.x) = __cuda_local_var_45135_18_non_const_threadsPerBlock) , (void)((__T222.y) = 1U)) , (void)((__T222.z) = 1U))) , __T222), (48UL * ((unsigned long)__cuda_local_var_45135_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z51kCalculateCDLJObcGbsaSoftcoreN2ByWarpForces1_kernelPj(((__cuda_local_var_45138_16_non_const_gpu->sim).pWorkUnit))); } else  {  struct dim3 __T223;
 unsigned __T224;
 struct dim3 __T225;
(cudaConfigureCall((((void)((__T224 = ((__cuda_local_var_45138_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T223.x) = __T224) , (void)((__T223.y) = 1U)) , ((__T223.z) = 1U)))) , __T223), (((void)((((__T225.x) = __cuda_local_var_45135_18_non_const_threadsPerBlock) , (void)((__T225.y) = 1U)) , (void)((__T225.z) = 1U))) , __T225), (48UL * ((unsigned long)__cuda_local_var_45135_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z45kCalculateCDLJObcGbsaSoftcoreN2Forces1_kernelPj(((__cuda_local_var_45138_16_non_const_gpu->sim).pWorkUnit))); }


{  enum cudaError __cuda_local_var_45164_27_non_const_status;
# 148 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
__cuda_local_var_45164_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_45164_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T226;
 struct _ZSs __T227;
 struct _ZSs __T228;
 struct _ZSs __T229;
 _ZSt6string __T230;
 struct _ZSaIcE __T231;
 struct _ZN6OpenMM15OpenMMExceptionE *__T232;
 const _ZSt6string *__T233;
# 148 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
((((((__T226 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T232 = __T226) , (void)(__T233 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T227), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T228), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T229), ((_ZNSsC1EPKcRKSaIcE((&__T230), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T231))) , (((const struct _ZSaIcE *)&__T231))))) , (((const struct _ZSs *)&__T230))), (cudaGetErrorString(__cuda_local_var_45164_27_non_const_status)))) , (((const struct _ZSs *)&__T229))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T228))), ((const char *)"kCalculateCDLJObcGbsaSoftcoreForces1"))) , (((const _ZSt6string *)&__T227))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T232->__b_St9exception)))) , (void)(((__T232->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T232->message)), __T233)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T227)))) , (void)(_ZNSsD1Ev((&__T228)))) , (void)(_ZNSsD1Ev((&__T229)))) , (void)(_ZNSsD1Ev((&__T230)))) , (void)(_ZNSaIcED1Ev((&__T231))); } } ;
goto __T234;

case 1:

if (__cuda_local_var_45138_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T235;
 unsigned __T236;
 struct dim3 __T237;
# 154 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
(cudaConfigureCall((((void)((__T236 = ((__cuda_local_var_45138_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T235.x) = __T236) , (void)((__T235.y) = 1U)) , ((__T235.z) = 1U)))) , __T235), (((void)((((__T237.x) = __cuda_local_var_45135_18_non_const_threadsPerBlock) , (void)((__T237.y) = 1U)) , (void)((__T237.z) = 1U))) , __T237), (52UL * ((unsigned long)__cuda_local_var_45135_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z55kCalculateCDLJObcGbsaSoftcoreCutoffByWarpForces1_kernelPj(((__cuda_local_var_45138_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T238;
 unsigned __T239;
 struct dim3 __T240;
(cudaConfigureCall((((void)((__T239 = ((__cuda_local_var_45138_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T238.x) = __T239) , (void)((__T238.y) = 1U)) , ((__T238.z) = 1U)))) , __T238), (((void)((((__T240.x) = __cuda_local_var_45135_18_non_const_threadsPerBlock) , (void)((__T240.y) = 1U)) , (void)((__T240.z) = 1U))) , __T240), (52UL * ((unsigned long)__cuda_local_var_45135_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z49kCalculateCDLJObcGbsaSoftcoreCutoffForces1_kernelPj(((__cuda_local_var_45138_16_non_const_gpu->sim).pInteractingWorkUnit))); }


{  enum cudaError __cuda_local_var_45176_27_non_const_status;
# 160 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
__cuda_local_var_45176_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_45176_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T241;
 struct _ZSs __T242;
 struct _ZSs __T243;
 struct _ZSs __T244;
 _ZSt6string __T245;
...
# 160 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
((((((__T241 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T247 = __T241) , (void)(__T248 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T242), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T243), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T244), ((_ZNSsC1EPKcRKSaIcE((&__T245), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T246))) , (((const struct _ZSaIcE *)&__T246))))) , (((const struct _ZSs *)&__T245))), (cudaGetErrorString(__cuda_local_var_45176_27_non_const_status)))) , (((const struct _ZSs *)&__T244))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T243))), ((const char *)"kCalculateCDLJObcGbsaSoftcoreCutoffForces1"))) , (((const _ZSt6string *)&__T242))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T247->__b_St9exception)))) , (void)(((__T247->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T247->message)), __T248)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T242)))) , (void)(_ZNSsD1Ev((&__T243)))) , (void)(_ZNSsD1Ev((&__T244)))) , (void)(_ZNSsD1Ev((&__T245)))) , (void)(_ZNSaIcED1Ev((&__T246))); } } ;

goto __T234;

case 2:

if (__cuda_local_var_45138_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T249;
 unsigned __T250;
 struct dim3 __T251;
# 167 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
(cudaConfigureCall((((void)((__T250 = ((__cuda_local_var_45138_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T249.x) = __T250) , (void)((__T249.y) = 1U)) , ((__T249.z) = 1U)))) , __T249), (((void)((((__T251.x) = __cuda_local_var_45135_18_non_const_threadsPerBlock) , (void)((__T251.y) = 1U)) , (void)((__T251.z) = 1U))) , __T251), (52UL * ((unsigned long)__cuda_local_var_45135_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z57kCalculateCDLJObcGbsaSoftcorePeriodicByWarpForces1_kernelPj(((__cuda_local_var_45138_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T252;
 unsigned __T253;
 struct dim3 __T254;
(cudaConfigureCall((((void)((__T253 = ((__cuda_local_var_45138_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T252.x) = __T253) , (void)((__T252.y) = 1U)) , ((__T252.z) = 1U)))) , __T252), (((void)((((__T254.x) = __cuda_local_var_45135_18_non_const_threadsPerBlock) , (void)((__T254.y) = 1U)) , (void)((__T254.z) = 1U))) , __T254), (52UL * ((unsigned long)__cuda_local_var_45135_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z51kCalculateCDLJObcGbsaSoftcorePeriodicForces1_kernelPj(((__cuda_local_var_45138_16_non_const_gpu->sim).pInteractingWorkUnit))); }


{  enum cudaError __cuda_local_var_45189_27_non_const_status;
# 173 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
__cuda_local_var_45189_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_45189_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T255;
 struct _ZSs __T256;
 struct _ZSs __T257;
 struct _ZSs __T258;
 _ZSt6string __T259;
 struct _ZSaIcE __T260;
 struct _ZN6OpenMM15OpenMMExceptionE *__T261;
 const _ZSt6string *__T262;
# 173 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
((((((__T255 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T261 = __T255) , (void)(__T262 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T256), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T257), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T258), ((_ZNSsC1EPKcRKSaIcE((&__T259), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T260))) , (((const struct _ZSaIcE *)&__T260))))) , (((const struct _ZSs *)&__T259))), (cudaGetErrorString(__cuda_local_var_45189_27_non_const_status)))) , (((const struct _ZSs *)&__T258))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T257))), ((const char *)"kCalculateCDLJObcGbsaSoftcorePeriodicForces1"))) , (((const _ZSt6string *)&__T256))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T261->__b_St9exception)))) , (void)(((__T261->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T261->message)), __T262)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T256)))) , (void)(_ZNSsD1Ev((&__T257)))) , (void)(_ZNSsD1Ev((&__T258)))) , (void)(_ZNSsD1Ev((&__T259)))) , (void)(_ZNSaIcED1Ev((&__T260))); } } ;
goto __T234;
} __T234:; 
...
{  _ZNSs14allocator_typeE __T263;
 struct _ZNSs4_RepE *__T264;
 const struct _ZSaIcE *__T265;
 void *__T266;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T264 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T265 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T263)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T263))))) , (void)((__builtin_expect(((long)(__T264 != ((__T266 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T266)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T264->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T264, __T265)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T263)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T267) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T268) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T268);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T269,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T269, __lhs);
_ZNSs6appendEPKcm(__T269, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 186 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/stl_algobase.h" 3
...
return ((__T270 = (*__mem)) , (void)((*__mem) += __val)) , __T270; }



}
static void __sti___55_kCalculateCDLJObcGbsaSoftcoreForces1_compute_20_cpp1_ii_16fab60b(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kCalculateCDLJObcGbsaSoftcoreForces1.compute_11.cudafe1.stub.c"
