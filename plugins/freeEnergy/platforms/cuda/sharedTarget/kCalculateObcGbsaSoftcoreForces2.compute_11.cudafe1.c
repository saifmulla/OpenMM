# 1 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
...
# 57 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
extern void SetCalculateObcGbsaSoftcoreForces2Sim(freeEnergyGpuContext);
...
# 101 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
extern void _Z32kCalculateObcGbsaSoftcoreForces2P21_freeEnergyGpuContext(freeEnergyGpuContext);
...
static void __sti___51_kCalculateObcGbsaSoftcoreForces2_compute_20_cpp1_ii_f7c755ae(void) __attribute__((__constructor__));
...
{
 enum cudaError __cuda_local_var_42968_17_non_const_status;
__cuda_local_var_42968_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&((freeEnergyGpu->gpuContext)->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_42968_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 61 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
(((((__T20 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T25 = __T20) , (void)(__T26 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T21), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T22), ((_ZNSsC1EPKcRKSaIcE((&__T23), ((const char *)"cudaMemcpyToSymbol: SetCalculateObcGbsaSoftcoreForces2Sim copy to cSim failed"), ((_ZNSaIcEC1Ev((&__T24))) , (((const struct _ZSaIcE *)&__T24))))) , (((const struct _ZSs *)&__T23))), ((const char *)" "))) , (((const struct _ZSs *)&__T22))), (cudaGetErrorString(__cuda_local_var_42968_17_non_const_status)))) , (((const _ZSt6string *)&__T21))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T25->__b_St9exception)))) , (void)(((__T25->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T25->message)), __T26)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T21)))) , (void)(_ZNSsD1Ev((&__T22)))) , (void)(_ZNSsD1Ev((&__T23)))) , (void)(_ZNSaIcED1Ev((&__T24))); } ;

__cuda_local_var_42968_17_non_const_status = (_Z18cudaMemcpyToSymbolI27cudaFreeEnergyGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaFreeEnergyGmxSimulation *)&feSimDev)), ((const void *)(&(freeEnergyGpu->freeEnergySim))), 128UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_42968_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 101 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
void _Z32kCalculateObcGbsaSoftcoreForces2P21_freeEnergyGpuContext( freeEnergyGpuContext freeEnergyGpu)
{

static unsigned threadsPerBlockPerMethod[3] = {0U,0U,0U};
static unsigned natoms[3] = {0U,0U,0U};
# 103 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
 unsigned __cuda_local_var_45198_18_non_const_threadsPerBlock;


 gpuContext __cuda_local_var_45201_16_non_const_gpu;
 unsigned __cuda_local_var_45202_18_non_const_methodIndex;
# 106 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
__cuda_local_var_45201_16_non_const_gpu = (freeEnergyGpu->gpuContext);
__cuda_local_var_45202_18_non_const_methodIndex = ((unsigned)((freeEnergyGpu->freeEnergySim).nonbondedMethod));

if (__cuda_local_var_45202_18_non_const_methodIndex > 2U) {  struct _ZN6OpenMM15OpenMMExceptionE *__T214;
 _ZSt6string __T215;
 struct _ZSaIcE __T216;
 struct _ZN6OpenMM15OpenMMExceptionE *__T217;
 const _ZSt6string *__T218;
# 110 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
(((__T214 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T217 = __T214) , (void)(__T218 = ((_ZNSsC1EPKcRKSaIcE((((_ZSt6string *)&__T215)), ((const char *)"kCalculateObcGbsaSoftcoreForces2 method index invalid."), ((_ZNSaIcEC1Ev((&__T216))) , (((const struct _ZSaIcE *)&__T216))))) , ((const _ZSt6string *)&__T215)))) , (void)(((_ZNSt9exceptionC1Ev((&(__T217->__b_St9exception)))) , (void)(((__T217->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T217->message)), __T218)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev(((struct _ZSs *)((const _ZSt6string *)&__T215))))) , (void)(_ZNSaIcED1Ev((&__T216)));
}

if (((natoms)[__cuda_local_var_45202_18_non_const_methodIndex]) != ((unsigned)(__cuda_local_var_45201_16_non_const_gpu->natoms))) {  unsigned __T219;
 unsigned __cuda_local_var_45209_22_non_const_extra;
# 114 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
__cuda_local_var_45209_22_non_const_extra = ((unsigned)((__cuda_local_var_45202_18_non_const_methodIndex == 0U) ? 0UL : 12UL));
((threadsPerBlockPerMethod)[__cuda_local_var_45202_18_non_const_methodIndex]) = (*(_ZSt3minIjERKT_S2_S2_(((__T219 = (getThreadsPerBlockFEP(freeEnergyGpu, ((unsigned)(40UL + ((unsigned long)__cuda_local_var_45209_22_non_const_extra))), (__cuda_local_var_45201_16_non_const_gpu->sharedMemoryPerBlock)))) , (((const unsigned *)&__T219))), (((const unsigned *)&((__cuda_local_var_45201_16_non_const_gpu->sim).nonbond_threads_per_block))))));
((natoms)[__cuda_local_var_45202_18_non_const_methodIndex]) = ((unsigned)(__cuda_local_var_45201_16_non_const_gpu->natoms));
}
__cuda_local_var_45198_18_non_const_threadsPerBlock = ((threadsPerBlockPerMethod)[__cuda_local_var_45202_18_non_const_methodIndex]);

switch ((int)((freeEnergyGpu->freeEnergySim).nonbondedMethod))
{
case 0:

if (__cuda_local_var_45201_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T220;
 unsigned __T221;
 struct dim3 __T222;
# 125 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T221 = ((__cuda_local_var_45201_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T220.x) = __T221) , (void)((__T220.y) = 1U)) , ((__T220.z) = 1U)))) , __T220), (((void)((((__T222.x) = __cuda_local_var_45198_18_non_const_threadsPerBlock) , (void)((__T222.y) = 1U)) , (void)((__T222.z) = 1U))) , __T222), (40UL * ((unsigned long)__cuda_local_var_45198_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z47kCalculateObcGbsaSoftcoreN2ByWarpForces2_kernelPj(((__cuda_local_var_45201_16_non_const_gpu->sim).pWorkUnit))); } else  {  struct dim3 __T223;
 unsigned __T224;
 struct dim3 __T225;
(cudaConfigureCall((((void)((__T224 = ((__cuda_local_var_45201_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T223.x) = __T224) , (void)((__T223.y) = 1U)) , ((__T223.z) = 1U)))) , __T223), (((void)((((__T225.x) = __cuda_local_var_45198_18_non_const_threadsPerBlock) , (void)((__T225.y) = 1U)) , (void)((__T225.z) = 1U))) , __T225), (40UL * ((unsigned long)__cuda_local_var_45198_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z41kCalculateObcGbsaSoftcoreN2Forces2_kernelPj(((__cuda_local_var_45201_16_non_const_gpu->sim).pWorkUnit))); }

goto __T226;

case 1:

if (__cuda_local_var_45201_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T227;
 unsigned __T228;
 struct dim3 __T229;
# 135 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T228 = ((__cuda_local_var_45201_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T227.x) = __T228) , (void)((__T227.y) = 1U)) , ((__T227.z) = 1U)))) , __T227), (((void)((((__T229.x) = __cuda_local_var_45198_18_non_const_threadsPerBlock) , (void)((__T229.y) = 1U)) , (void)((__T229.z) = 1U))) , __T229), (52UL * ((unsigned long)__cuda_local_var_45198_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z51kCalculateObcGbsaSoftcoreCutoffByWarpForces2_kernelPj(((__cuda_local_var_45201_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T230;
 unsigned __T231;
 struct dim3 __T232;
(cudaConfigureCall((((void)((__T231 = ((__cuda_local_var_45201_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T230.x) = __T231) , (void)((__T230.y) = 1U)) , ((__T230.z) = 1U)))) , __T230), (((void)((((__T232.x) = __cuda_local_var_45198_18_non_const_threadsPerBlock) , (void)((__T232.y) = 1U)) , (void)((__T232.z) = 1U))) , __T232), (52UL * ((unsigned long)__cuda_local_var_45198_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z45kCalculateObcGbsaSoftcoreCutoffForces2_kernelPj(((__cuda_local_var_45201_16_non_const_gpu->sim).pInteractingWorkUnit))); }

goto __T226;

case 2:

if (__cuda_local_var_45201_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T233;
 unsigned __T234;
 struct dim3 __T235;
# 145 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T234 = ((__cuda_local_var_45201_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T233.x) = __T234) , (void)((__T233.y) = 1U)) , ((__T233.z) = 1U)))) , __T233), (((void)((((__T235.x) = __cuda_local_var_45198_18_non_const_threadsPerBlock) , (void)((__T235.y) = 1U)) , (void)((__T235.z) = 1U))) , __T235), (52UL * ((unsigned long)__cuda_local_var_45198_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z53kCalculateObcGbsaSoftcorePeriodicByWarpForces2_kernelPj(((__cuda_local_var_45201_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T236;
 unsigned __T237;
 struct dim3 __T238;
(cudaConfigureCall((((void)((__T237 = ((__cuda_local_var_45201_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T236.x) = __T237) , (void)((__T236.y) = 1U)) , ((__T236.z) = 1U)))) , __T236), (((void)((((__T238.x) = __cuda_local_var_45198_18_non_const_threadsPerBlock) , (void)((__T238.y) = 1U)) , (void)((__T238.z) = 1U))) , __T238), (52UL * ((unsigned long)__cuda_local_var_45198_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z47kCalculateObcGbsaSoftcorePeriodicForces2_kernelPj(((__cuda_local_var_45201_16_non_const_gpu->sim).pInteractingWorkUnit))); }

goto __T226;
} __T226:;
{  enum cudaError __cuda_local_var_45247_19_non_const_status;
# 152 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
__cuda_local_var_45247_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_45247_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T239;
 struct _ZSs __T240;
 struct _ZSs __T241;
 struct _ZSs __T242;
 _ZSt6string __T243;
...
# 152 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateObcGbsaSoftcoreForces2.cu"
((((((__T239 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T245 = __T239) , (void)(__T246 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T240), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T241), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T242), ((_ZNSsC1EPKcRKSaIcE((&__T243), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T244))) , (((const struct _ZSaIcE *)&__T244))))) , (((const struct _ZSs *)&__T243))), (cudaGetErrorString(__cuda_local_var_45247_19_non_const_status)))) , (((const struct _ZSs *)&__T242))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T241))), ((const char *)"kCalculateObcGbsaSoftcoreForces2"))) , (((const _ZSt6string *)&__T240))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T245->__b_St9exception)))) , (void)(((__T245->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T245->message)), __T246)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T240)))) , (void)(_ZNSsD1Ev((&__T241)))) , (void)(_ZNSsD1Ev((&__T242)))) , (void)(_ZNSsD1Ev((&__T243)))) , (void)(_ZNSaIcED1Ev((&__T244))); } } ; 
}
__asm__(".align 2");
# 62 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/exception" 3
...
{  _ZNSs14allocator_typeE __T2125;
 struct _ZNSs4_RepE *__T2126;
 const struct _ZSaIcE *__T2127;
 void *__T2128;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T2126 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T2127 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T2125)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T2125))))) , (void)((__builtin_expect(((long)(__T2126 != ((__T2128 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T2128)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T2126->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T2126, __T2127)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T2125)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2129) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T2130) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T2130);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T2131,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T2131, __lhs);
_ZNSs6appendEPKcm(__T2131, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 186 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/stl_algobase.h" 3
...
return ((__T2132 = (*__mem)) , (void)((*__mem) += __val)) , __T2132; }



}
static void __sti___51_kCalculateObcGbsaSoftcoreForces2_compute_20_cpp1_ii_f7c755ae(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kCalculateObcGbsaSoftcoreForces2.compute_11.cudafe1.stub.c"
