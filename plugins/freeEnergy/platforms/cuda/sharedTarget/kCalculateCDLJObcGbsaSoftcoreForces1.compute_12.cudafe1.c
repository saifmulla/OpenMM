...
void SetCalculateCDLJObcGbsaSoftcoreGpu1Sim( freeEnergyGpuContext freeEnergyGpu) {
 ...
 enum cudaError __cuda_local_var_41908_17_non_const_status;
__cuda_local_var_41908_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&((freeEnergyGpu->gpuContext)->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41908_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 119 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
 unsigned __cuda_local_var_45179_18_non_const_threadsPerBlock;


 gpuContext __cuda_local_var_45182_16_non_const_gpu;
 unsigned __cuda_local_var_45183_18_non_const_methodIndex;
# 122 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
__cuda_local_var_45182_16_non_const_gpu = (freeEnergyGpu->gpuContext);
__cuda_local_var_45183_18_non_const_methodIndex = ((unsigned)((freeEnergyGpu->freeEnergySim).nonbondedMethod));

if (__cuda_local_var_45183_18_non_const_methodIndex > 2U) {  struct _ZN6OpenMM15OpenMMExceptionE *__T214;
 _ZSt6string __T215;
...
if (((natoms)[__cuda_local_var_45183_18_non_const_methodIndex]) != ((unsigned)(__cuda_local_var_45182_16_non_const_gpu->natoms))) {  unsigned __T219;
 unsigned __cuda_local_var_45190_22_non_const_extra;
# 130 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
__cuda_local_var_45190_22_non_const_extra = ((unsigned)((__cuda_local_var_45183_18_non_const_methodIndex == 0U) ? 0UL : 4UL));
((threadsPerBlockPerMethod)[__cuda_local_var_45183_18_non_const_methodIndex]) = (*(_ZSt3minIjERKT_S2_S2_(((__T219 = (getThreadsPerBlockFEP(freeEnergyGpu, ((unsigned)(48UL + ((unsigned long)__cuda_local_var_45190_22_non_const_extra))), (__cuda_local_var_45182_16_non_const_gpu->sharedMemoryPerBlock)))) , (((const unsigned *)&__T219))), (((const unsigned *)&((__cuda_local_var_45182_16_non_const_gpu->sim).nonbond_threads_per_block))))));
((natoms)[__cuda_local_var_45183_18_non_const_methodIndex]) = ((unsigned)(__cuda_local_var_45182_16_non_const_gpu->natoms));
}
__cuda_local_var_45179_18_non_const_threadsPerBlock = ((threadsPerBlockPerMethod)[__cuda_local_var_45183_18_non_const_methodIndex]);
...
if (__cuda_local_var_45182_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T220;
 unsigned __T221;
 struct dim3 __T222;
# 142 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
(cudaConfigureCall((((void)((__T221 = ((__cuda_local_var_45182_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T220.x) = __T221) , (void)((__T220.y) = 1U)) , ((__T220.z) = 1U)))) , __T220), (((void)((((__T222.x) = __cuda_local_var_45179_18_non_const_threadsPerBlock) , (void)((__T222.y) = 1U)) , (void)((__T222.z) = 1U))) , __T222), (48UL * ((unsigned long)__cuda_local_var_45179_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z51kCalculateCDLJObcGbsaSoftcoreN2ByWarpForces1_kernelPj(((__cuda_local_var_45182_16_non_const_gpu->sim).pWorkUnit))); } else  {  struct dim3 __T223;
 unsigned __T224;
 struct dim3 __T225;
(cudaConfigureCall((((void)((__T224 = ((__cuda_local_var_45182_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T223.x) = __T224) , (void)((__T223.y) = 1U)) , ((__T223.z) = 1U)))) , __T223), (((void)((((__T225.x) = __cuda_local_var_45179_18_non_const_threadsPerBlock) , (void)((__T225.y) = 1U)) , (void)((__T225.z) = 1U))) , __T225), (48UL * ((unsigned long)__cuda_local_var_45179_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z45kCalculateCDLJObcGbsaSoftcoreN2Forces1_kernelPj(((__cuda_local_var_45182_16_non_const_gpu->sim).pWorkUnit))); }


{  enum cudaError __cuda_local_var_45208_27_non_const_status;
# 148 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
__cuda_local_var_45208_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_45208_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T226;
 struct _ZSs __T227;
 struct _ZSs __T228;
 struct _ZSs __T229;
 _ZSt6string __T230;
...
# 148 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
((((((__T226 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T232 = __T226) , (void)(__T233 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T227), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T228), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T229), ((_ZNSsC1EPKcRKSaIcE((&__T230), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T231))) , (((const struct _ZSaIcE *)&__T231))))) , (((const struct _ZSs *)&__T230))), (cudaGetErrorString(__cuda_local_var_45208_27_non_const_status)))) , (((const struct _ZSs *)&__T229))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T228))), ((const char *)"kCalculateCDLJObcGbsaSoftcoreForces1"))) , (((const _ZSt6string *)&__T227))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T232->__b_St9exception)))) , (void)(((__T232->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T232->message)), __T233)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T227)))) , (void)(_ZNSsD1Ev((&__T228)))) , (void)(_ZNSsD1Ev((&__T229)))) , (void)(_ZNSsD1Ev((&__T230)))) , (void)(_ZNSaIcED1Ev((&__T231))); } } ;
goto __T234;

case 1:

if (__cuda_local_var_45182_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T235;
 unsigned __T236;
 struct dim3 __T237;
# 154 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
(cudaConfigureCall((((void)((__T236 = ((__cuda_local_var_45182_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T235.x) = __T236) , (void)((__T235.y) = 1U)) , ((__T235.z) = 1U)))) , __T235), (((void)((((__T237.x) = __cuda_local_var_45179_18_non_const_threadsPerBlock) , (void)((__T237.y) = 1U)) , (void)((__T237.z) = 1U))) , __T237), (52UL * ((unsigned long)__cuda_local_var_45179_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z55kCalculateCDLJObcGbsaSoftcoreCutoffByWarpForces1_kernelPj(((__cuda_local_var_45182_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T238;
 unsigned __T239;
 struct dim3 __T240;
(cudaConfigureCall((((void)((__T239 = ((__cuda_local_var_45182_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T238.x) = __T239) , (void)((__T238.y) = 1U)) , ((__T238.z) = 1U)))) , __T238), (((void)((((__T240.x) = __cuda_local_var_45179_18_non_const_threadsPerBlock) , (void)((__T240.y) = 1U)) , (void)((__T240.z) = 1U))) , __T240), (52UL * ((unsigned long)__cuda_local_var_45179_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z49kCalculateCDLJObcGbsaSoftcoreCutoffForces1_kernelPj(((__cuda_local_var_45182_16_non_const_gpu->sim).pInteractingWorkUnit))); }


{  enum cudaError __cuda_local_var_45220_27_non_const_status;
# 160 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
__cuda_local_var_45220_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_45220_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T241;
 struct _ZSs __T242;
 struct _ZSs __T243;
 struct _ZSs __T244;
 _ZSt6string __T245;
...
# 160 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
((((((__T241 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T247 = __T241) , (void)(__T248 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T242), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T243), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T244), ((_ZNSsC1EPKcRKSaIcE((&__T245), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T246))) , (((const struct _ZSaIcE *)&__T246))))) , (((const struct _ZSs *)&__T245))), (cudaGetErrorString(__cuda_local_var_45220_27_non_const_status)))) , (((const struct _ZSs *)&__T244))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T243))), ((const char *)"kCalculateCDLJObcGbsaSoftcoreCutoffForces1"))) , (((const _ZSt6string *)&__T242))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T247->__b_St9exception)))) , (void)(((__T247->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T247->message)), __T248)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T242)))) , (void)(_ZNSsD1Ev((&__T243)))) , (void)(_ZNSsD1Ev((&__T244)))) , (void)(_ZNSsD1Ev((&__T245)))) , (void)(_ZNSaIcED1Ev((&__T246))); } } ;

goto __T234;

case 2:

if (__cuda_local_var_45182_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T249;
 unsigned __T250;
 struct dim3 __T251;
# 167 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
(cudaConfigureCall((((void)((__T250 = ((__cuda_local_var_45182_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T249.x) = __T250) , (void)((__T249.y) = 1U)) , ((__T249.z) = 1U)))) , __T249), (((void)((((__T251.x) = __cuda_local_var_45179_18_non_const_threadsPerBlock) , (void)((__T251.y) = 1U)) , (void)((__T251.z) = 1U))) , __T251), (52UL * ((unsigned long)__cuda_local_var_45179_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z57kCalculateCDLJObcGbsaSoftcorePeriodicByWarpForces1_kernelPj(((__cuda_local_var_45182_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T252;
 unsigned __T253;
 struct dim3 __T254;
(cudaConfigureCall((((void)((__T253 = ((__cuda_local_var_45182_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T252.x) = __T253) , (void)((__T252.y) = 1U)) , ((__T252.z) = 1U)))) , __T252), (((void)((((__T254.x) = __cuda_local_var_45179_18_non_const_threadsPerBlock) , (void)((__T254.y) = 1U)) , (void)((__T254.z) = 1U))) , __T254), (52UL * ((unsigned long)__cuda_local_var_45179_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z51kCalculateCDLJObcGbsaSoftcorePeriodicForces1_kernelPj(((__cuda_local_var_45182_16_non_const_gpu->sim).pInteractingWorkUnit))); }


{  enum cudaError __cuda_local_var_45233_27_non_const_status;
# 173 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateCDLJObcGbsaSoftcoreForces1.cu"
__cuda_local_var_45233_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_45233_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T255;
 struct _ZSs __T256;
 struct _ZSs __T257;
 struct _ZSs __T258;
 _ZSt6string __T259;
...
#include "kCalculateCDLJObcGbsaSoftcoreForces1.compute_12.cudafe1.stub.c"
