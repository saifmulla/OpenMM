# 1 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
...
# 62 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
extern void SetCalculateGBVISoftcoreForces2Sim(freeEnergyGpuContext);
...
# 104 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
extern void _Z29kCalculateGBVISoftcoreForces2P21_freeEnergyGpuContext(freeEnergyGpuContext);
...
static void __sti___48_kCalculateGBVISoftcoreForces2_compute_20_cpp1_ii_c77af4d5(void) __attribute__((__constructor__));
...
{
 enum cudaError __cuda_local_var_43310_17_non_const_status;
__cuda_local_var_43310_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&((gpu->gpuContext)->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_43310_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 104 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
void _Z29kCalculateGBVISoftcoreForces2P21_freeEnergyGpuContext( freeEnergyGpuContext freeEnergyGpu)
{

static unsigned threadsPerBlockPerMethod[3] = {0U,0U,0U};
static unsigned natoms[3] = {0U,0U,0U};
# 106 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
 unsigned __cuda_local_var_45219_18_non_const_threadsPerBlock;


 gpuContext __cuda_local_var_45222_16_non_const_gpu;
 unsigned __cuda_local_var_45223_18_non_const_methodIndex;
# 109 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
__cuda_local_var_45222_16_non_const_gpu = (freeEnergyGpu->gpuContext);
__cuda_local_var_45223_18_non_const_methodIndex = ((unsigned)((freeEnergyGpu->freeEnergySim).nonbondedMethod));

if (__cuda_local_var_45223_18_non_const_methodIndex > 2U) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 _ZSt6string __T28;
 struct _ZSaIcE __T29;
 struct _ZN6OpenMM15OpenMMExceptionE *__T210;
 const _ZSt6string *__T211;
# 113 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
(((__T27 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T210 = __T27) , (void)(__T211 = ((_ZNSsC1EPKcRKSaIcE((((_ZSt6string *)&__T28)), ((const char *)"kCalculateGBVISoftcoreForces2 method index invalid."), ((_ZNSaIcEC1Ev((&__T29))) , (((const struct _ZSaIcE *)&__T29))))) , ((const _ZSt6string *)&__T28)))) , (void)(((_ZNSt9exceptionC1Ev((&(__T210->__b_St9exception)))) , (void)(((__T210->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T210->message)), __T211)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev(((struct _ZSs *)((const _ZSt6string *)&__T28))))) , (void)(_ZNSaIcED1Ev((&__T29)));
}

if (((natoms)[__cuda_local_var_45223_18_non_const_methodIndex]) != ((unsigned)(__cuda_local_var_45222_16_non_const_gpu->natoms))) {  unsigned __T212;
 unsigned __cuda_local_var_45230_22_non_const_extra;
# 117 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
__cuda_local_var_45230_22_non_const_extra = ((unsigned)((__cuda_local_var_45223_18_non_const_methodIndex == 0U) ? 0UL : 12UL));
((threadsPerBlockPerMethod)[__cuda_local_var_45223_18_non_const_methodIndex]) = (*(_ZSt3minIjERKT_S2_S2_(((__T212 = (getThreadsPerBlockFEP(freeEnergyGpu, ((unsigned)(40UL + ((unsigned long)__cuda_local_var_45230_22_non_const_extra))), (__cuda_local_var_45222_16_non_const_gpu->sharedMemoryPerBlock)))) , (((const unsigned *)&__T212))), (((const unsigned *)&((__cuda_local_var_45222_16_non_const_gpu->sim).nonbond_threads_per_block))))));
((natoms)[__cuda_local_var_45223_18_non_const_methodIndex]) = ((unsigned)(__cuda_local_var_45222_16_non_const_gpu->natoms));
}
__cuda_local_var_45219_18_non_const_threadsPerBlock = ((threadsPerBlockPerMethod)[__cuda_local_var_45223_18_non_const_methodIndex]);
...
if (__cuda_local_var_45222_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T213;
 unsigned __T214;
 struct dim3 __T215;
# 129 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T214 = ((__cuda_local_var_45222_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T213.x) = __T214) , (void)((__T213.y) = 1U)) , ((__T213.z) = 1U)))) , __T213), (((void)((((__T215.x) = __cuda_local_var_45219_18_non_const_threadsPerBlock) , (void)((__T215.y) = 1U)) , (void)((__T215.z) = 1U))) , __T215), (40UL * ((unsigned long)__cuda_local_var_45219_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z44kCalculateGBVISoftcoreN2ByWarpForces2_kernelPj(((__cuda_local_var_45222_16_non_const_gpu->sim).pWorkUnit))); } else  {  struct dim3 __T216;
 unsigned __T217;
 struct dim3 __T218;
(cudaConfigureCall((((void)((__T217 = ((__cuda_local_var_45222_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T216.x) = __T217) , (void)((__T216.y) = 1U)) , ((__T216.z) = 1U)))) , __T216), (((void)((((__T218.x) = __cuda_local_var_45219_18_non_const_threadsPerBlock) , (void)((__T218.y) = 1U)) , (void)((__T218.z) = 1U))) , __T218), (40UL * ((unsigned long)__cuda_local_var_45219_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z38kCalculateGBVISoftcoreN2Forces2_kernelPj(((__cuda_local_var_45222_16_non_const_gpu->sim).pWorkUnit))); }

goto __T219;

case 1:

if (__cuda_local_var_45222_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T220;
 unsigned __T221;
 struct dim3 __T222;
# 139 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T221 = ((__cuda_local_var_45222_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T220.x) = __T221) , (void)((__T220.y) = 1U)) , ((__T220.z) = 1U)))) , __T220), (((void)((((__T222.x) = __cuda_local_var_45219_18_non_const_threadsPerBlock) , (void)((__T222.y) = 1U)) , (void)((__T222.z) = 1U))) , __T222), (52UL * ((unsigned long)__cuda_local_var_45219_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z48kCalculateGBVISoftcoreCutoffByWarpForces2_kernelPj(((__cuda_local_var_45222_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T223;
 unsigned __T224;
 struct dim3 __T225;
(cudaConfigureCall((((void)((__T224 = ((__cuda_local_var_45222_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T223.x) = __T224) , (void)((__T223.y) = 1U)) , ((__T223.z) = 1U)))) , __T223), (((void)((((__T225.x) = __cuda_local_var_45219_18_non_const_threadsPerBlock) , (void)((__T225.y) = 1U)) , (void)((__T225.z) = 1U))) , __T225), (52UL * ((unsigned long)__cuda_local_var_45219_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z42kCalculateGBVISoftcoreCutoffForces2_kernelPj(((__cuda_local_var_45222_16_non_const_gpu->sim).pInteractingWorkUnit))); }

goto __T219;

case 2:

if (__cuda_local_var_45222_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T226;
 unsigned __T227;
 struct dim3 __T228;
# 149 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
(cudaConfigureCall((((void)((__T227 = ((__cuda_local_var_45222_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T226.x) = __T227) , (void)((__T226.y) = 1U)) , ((__T226.z) = 1U)))) , __T226), (((void)((((__T228.x) = __cuda_local_var_45219_18_non_const_threadsPerBlock) , (void)((__T228.y) = 1U)) , (void)((__T228.z) = 1U))) , __T228), (52UL * ((unsigned long)__cuda_local_var_45219_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z50kCalculateGBVISoftcorePeriodicByWarpForces2_kernelPj(((__cuda_local_var_45222_16_non_const_gpu->sim).pInteractingWorkUnit))); } else  {  struct dim3 __T229;
 unsigned __T230;
 struct dim3 __T231;
(cudaConfigureCall((((void)((__T230 = ((__cuda_local_var_45222_16_non_const_gpu->sim).bornForce2_blocks)) , (void)((((__T229.x) = __T230) , (void)((__T229.y) = 1U)) , ((__T229.z) = 1U)))) , __T229), (((void)((((__T231.x) = __cuda_local_var_45219_18_non_const_threadsPerBlock) , (void)((__T231.y) = 1U)) , (void)((__T231.z) = 1U))) , __T231), (52UL * ((unsigned long)__cuda_local_var_45219_18_non_const_threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z44kCalculateGBVISoftcorePeriodicForces2_kernelPj(((__cuda_local_var_45222_16_non_const_gpu->sim).pInteractingWorkUnit))); }

goto __T219;

} __T219:;
{  enum cudaError __cuda_local_var_45270_19_non_const_status;
# 157 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
__cuda_local_var_45270_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_45270_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T232;
 struct _ZSs __T233;
 struct _ZSs __T234;
 struct _ZSs __T235;
 _ZSt6string __T236;
...
# 157 "/home/saifmulla/openmm/OpenMM/plugins/freeEnergy/platforms/cuda/src/kernels//kCalculateGBVISoftcoreForces2.cu"
((((((__T232 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T238 = __T232) , (void)(__T239 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T233), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T234), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T235), ((_ZNSsC1EPKcRKSaIcE((&__T236), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T237))) , (((const struct _ZSaIcE *)&__T237))))) , (((const struct _ZSs *)&__T236))), (cudaGetErrorString(__cuda_local_var_45270_19_non_const_status)))) , (((const struct _ZSs *)&__T235))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T234))), ((const char *)"kCalculateGBVISoftcoreForces2"))) , (((const _ZSt6string *)&__T233))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T238->__b_St9exception)))) , (void)(((__T238->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T238->message)), __T239)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T233)))) , (void)(_ZNSsD1Ev((&__T234)))) , (void)(_ZNSsD1Ev((&__T235)))) , (void)(_ZNSsD1Ev((&__T236)))) , (void)(_ZNSaIcED1Ev((&__T237))); } } ; 
}
__asm__(".align 2");
# 62 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/exception" 3
...
{  _ZNSs14allocator_typeE __T240;
 struct _ZNSs4_RepE *__T241;
 const struct _ZSaIcE *__T242;
 void *__T243;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T241 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T242 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T240)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T240))))) , (void)((__builtin_expect(((long)(__T241 != ((__T243 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T243)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T241->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T241, __T242)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T240)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T244) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T245) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T245);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T246,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T246, __lhs);
_ZNSs6appendEPKcm(__T246, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 186 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/stl_algobase.h" 3
...
return ((__T247 = (*__mem)) , (void)((*__mem) += __val)) , __T247; }



}
static void __sti___48_kCalculateGBVISoftcoreForces2_compute_20_cpp1_ii_c77af4d5(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kCalculateGBVISoftcoreForces2.compute_13.cudafe1.stub.c"
