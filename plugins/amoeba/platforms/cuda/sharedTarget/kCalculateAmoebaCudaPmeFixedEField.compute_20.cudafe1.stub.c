...
# 1 "kCalculateAmoebaCudaPmeFixedEField.compute_20.cudafe1.stub.c"
...
# 1 "kCalculateAmoebaCudaPmeFixedEField.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T277) {  __nv_dummy_param_ref(__T277); __cudaRegisterEntry(__T277, ((void ( *)(unsigned *, float *, float *))kCalculateAmoebaPmeDirectFixedE_FieldCutoffByWarp_kernel), _Z56kCalculateAmoebaPmeDirectFixedE_FieldCutoffByWarp_kernelPjPfS0_, 384); __cudaRegisterEntry(__T277, ((void ( *)(unsigned *, float *, float *))kCalculateAmoebaPmeDirectFixedE_FieldCutoff_kernel), _Z50kCalculateAmoebaPmeDirectFixedE_FieldCutoff_kernelPjPfS0_, 384); __cudaRegisterEntry(__T277, ((void ( *)(unsigned, unsigned, float *, float *))kReducePmeEField_kernel), _Z23kReducePmeEField_kerneljjPfS_, 512); __cudaRegisterEntry(__T277, ((void ( *)(unsigned, unsigned, float *, float *, float *))kReducePmeEFieldPolar_kernel), _Z28kReducePmeEFieldPolar_kerneljjPfS_S_, 512); __cudaRegisterVariable(__T277, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T277, __shadow_var(cAmoebaSim,cAmoebaSim), 0, 1792, 1, 0); __cudaRegisterVariable(__T277, __shadow_var(mpoleScale,mpoleScale), 0, 20, 1, 0); __cudaRegisterVariable(__T277, __shadow_var(polarScale,polarScale), 0, 20, 1, 0); __cudaRegisterVariable(__T277, __shadow_var(directScale,directScale), 0, 20, 1, 0); }
