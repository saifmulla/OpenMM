...
# 1 "kCalculateAmoebaCudaFixedEAndGkFields.compute_11.cudafe1.stub.c"
...
# 1 "kCalculateAmoebaCudaFixedEAndGkFields.compute_11.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T289) {  __nv_dummy_param_ref(__T289); __cudaRegisterEntry(__T289, ((void ( *)(unsigned *, float *, float *, float *))kCalculateAmoebaFixedEAndGkFieldN2ByWarp_kernel), _Z47kCalculateAmoebaFixedEAndGkFieldN2ByWarp_kernelPjPfS0_S0_, 64); __cudaRegisterEntry(__T289, ((void ( *)(unsigned *, float *, float *, float *))kCalculateAmoebaFixedEAndGkFieldN2_kernel), _Z41kCalculateAmoebaFixedEAndGkFieldN2_kernelPjPfS0_S0_, 64); __cudaRegisterVariable(__T289, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T289, __shadow_var(cAmoebaSim,cAmoebaSim), 0, 1792, 1, 0); __cudaRegisterVariable(__T289, __shadow_var(mpoleScale,mpoleScale), 0, 20, 1, 0); __cudaRegisterVariable(__T289, __shadow_var(polarScale,polarScale), 0, 20, 1, 0); __cudaRegisterVariable(__T289, __shadow_var(directScale,directScale), 0, 20, 1, 0); }
