...
# 1 "kCalculateAmoebaCudaWcaDispersion.compute_13.cudafe1.stub.c"
...
# 1 "kCalculateAmoebaCudaWcaDispersion.compute_13.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T253) {  __nv_dummy_param_ref(__T253); __cudaRegisterEntry(__T253, ((void ( *)(unsigned *))kCalculateAmoebaWcaDispersionN2ByWarp_kernel), _Z44kCalculateAmoebaWcaDispersionN2ByWarp_kernelPj, 192); __cudaRegisterEntry(__T253, ((void ( *)(unsigned *))kCalculateAmoebaWcaDispersionN2_kernel), _Z38kCalculateAmoebaWcaDispersionN2_kernelPj, 192); __cudaRegisterVariable(__T253, __shadow_var(mpoleScale,mpoleScale), 0, 20, 1, 0); __cudaRegisterVariable(__T253, __shadow_var(polarScale,polarScale), 0, 20, 1, 0); __cudaRegisterVariable(__T253, __shadow_var(directScale,directScale), 0, 20, 1, 0); __cudaRegisterVariable(__T253, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T253, __shadow_var(cAmoebaSim,cAmoebaSim), 0, 1792, 1, 0); }
