...
{
 enum cudaError __cuda_local_var_41797_17_non_const_status;
 gpuContext __cuda_local_var_41798_16_non_const_gpu;
# 46 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
__cuda_local_var_41798_16_non_const_gpu = (amoebaGpu->gpuContext);
__cuda_local_var_41797_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(__cuda_local_var_41798_16_non_const_gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41797_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
{
 enum cudaError __cuda_local_var_41807_17_non_const_status;
 gpuContext __cuda_local_var_41808_16_non_const_gpu;
# 56 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
__cuda_local_var_41808_16_non_const_gpu = (amoebaGpu->gpuContext);
__cuda_local_var_41807_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(__cuda_local_var_41808_16_non_const_gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_41807_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T214;
 struct _ZSs __T215;
 struct _ZSs __T216;
 _ZSt6string __T217;
...
# 405 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
 gpuContext __cuda_local_var_42099_16_non_const_gpu;

 int __cuda_local_var_42101_9_non_const_numBlocks;
 int __cuda_local_var_42102_9_non_const_numThreads;
# 405 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
__cuda_local_var_42099_16_non_const_gpu = (amoebaGpu->gpuContext);

__cuda_local_var_42101_9_non_const_numBlocks = ((int)((__cuda_local_var_42099_16_non_const_gpu->sim).blocks));
__cuda_local_var_42102_9_non_const_numThreads = ((int)((__cuda_local_var_42099_16_non_const_gpu->sim).threads_per_block));
# 414 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
cudaMemcpy(((void *)((amoebaGpu->psLabFrameDipole)->_pDevData)), ((const void *)((amoebaGpu->psMolecularDipole)->_pDevData)), (((unsigned long)(3U * ((__cuda_local_var_42099_16_non_const_gpu->sim).paddedNumberOfAtoms))) * 4UL), cudaMemcpyDeviceToDevice);
cudaMemcpy(((void *)((amoebaGpu->psLabFrameQuadrupole)->_pDevData)), ((const void *)((amoebaGpu->psMolecularQuadrupole)->_pDevData)), (((unsigned long)(9U * ((__cuda_local_var_42099_16_non_const_gpu->sim).paddedNumberOfAtoms))) * 4UL), cudaMemcpyDeviceToDevice);

(cudaConfigureCall((((void)((__T229 = ((unsigned)__cuda_local_var_42101_9_non_const_numBlocks)) , (void)((((__T228.x) = __T229) , (void)((__T228.y) = 1U)) , ((__T228.z) = 1U)))) , __T228), (((void)((__T231 = ((unsigned)__cuda_local_var_42102_9_non_const_numThreads)) , (void)((((__T230.x) = __T231) , (void)((__T230.y) = 1U)) , ((__T230.z) = 1U)))) , __T230), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z30kCudaComputeCheckChiral_kernelv());
{  enum cudaError __cuda_local_var_42112_19_non_const_status;
# 418 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
__cuda_local_var_42112_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_42112_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T236;
 struct _ZSs __T237;
 struct _ZSs __T238;
 struct _ZSs __T239;
 _ZSt6string __T240;
...
{  struct _ZSaIcE __T252;
 _ZSt6string __cuda_local_var_42121_17_non_const_methodName;
# 427 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
_ZNSsC1EPKcRKSaIcE((&__cuda_local_var_42121_17_non_const_methodName), ((const char *)"kCalculateAmoebaMultipoleForces"), ((_ZNSaIcEC1Ev((&__T252))) , (((const struct _ZSaIcE *)&__T252)))); _ZNSaIcED1Ev((&__T252));
...
# 434 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
 gpuContext __cuda_local_var_42128_20_non_const_gpu;
 struct _ZSt6vectorIiSaIiEE __cuda_local_var_42129_26_non_const_fileId;

 VectorOfDoubleVectors __cuda_local_var_42131_31_non_const_outputVector;
# 434 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
__cuda_local_var_42128_20_non_const_gpu = (amoebaGpu->gpuContext);
_ZNSt6vectorIiSaIiEEC1Ev((&__cuda_local_var_42129_26_non_const_fileId));

_ZNSt6vectorIS_IdSaIdEESaIS1_EEC1Ev((&__cuda_local_var_42131_31_non_const_outputVector));

_Z22cudaLoadCudaFloatArrayiiP10CUDAStreamIfERSt6vectorIS2_IdSaIdEESaIS4_EEPif((__cuda_local_var_42128_20_non_const_gpu->natoms), 3, (amoebaGpu->psLabFrameDipole), (&__cuda_local_var_42131_31_non_const_outputVector), ((__cuda_local_var_42128_20_non_const_gpu->psAtomIndex)->_pSysData), (1.0F));
_Z22cudaLoadCudaFloatArrayiiP10CUDAStreamIfERSt6vectorIS2_IdSaIdEESaIS4_EEPif((__cuda_local_var_42128_20_non_const_gpu->natoms), 9, (amoebaGpu->psLabFrameQuadrupole), (&__cuda_local_var_42131_31_non_const_outputVector), ((__cuda_local_var_42128_20_non_const_gpu->psAtomIndex)->_pSysData), (1.0F));
((_Z36cudaWriteVectorOfDoubleVectorsToFileRKSsRSt6vectorIiSaIiEERS1_IS1_IdSaIdEESaIS6_EE(((_ZNSsC1EPKcRKSaIcE((((_ZSt6string *)&__T253)), ((const char *)"CudaLabMoments"), ((_ZNSaIcEC1Ev((&__T254))) , (((const struct _ZSaIcE *)&__T254))))) , ((const _ZSt6string *)&__T253)), (&__cuda_local_var_42129_26_non_const_fileId), (&__cuda_local_var_42131_31_non_const_outputVector))) , (void)(_ZNSsD1Ev(((struct _ZSs *)((const _ZSt6string *)&__T253))))) , (void)(_ZNSaIcED1Ev((&__T254)));
_ZNSt6vectorIS_IdSaIdEESaIS1_EED1Ev((&__cuda_local_var_42131_31_non_const_outputVector)); _ZNSt6vectorIiSaIiEED1Ev((&__cuda_local_var_42129_26_non_const_fileId)); }
...
# 458 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
 gpuContext __cuda_local_var_42152_24_non_const_gpu;
# 458 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
__cuda_local_var_42152_24_non_const_gpu = (amoebaGpu->gpuContext);
(cudaConfigureCall((((void)((__T256 = ((((__cuda_local_var_42152_24_non_const_gpu->psGridBoundingBox)->_length) + 63U) / 64U)) , (void)((((__T255.x) = __T256) , (void)((__T255.y) = 1U)) , ((__T255.z) = 1U)))) , __T255), (((void)((((__T257.x) = 64U) , (void)((__T257.y) = 1U)) , (void)((__T257.z) = 1U))) , __T257), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z31kFindBlockBoundsPeriodic_kernelv());
{  enum cudaError __cuda_local_var_42154_27_non_const_status;
# 460 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
__cuda_local_var_42154_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_42154_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T266;
 struct _ZSs __T267;
 struct _ZSs __T268;
 struct _ZSs __T269;
 _ZSt6string __T270;
...
# 462 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
((((((__T274 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T280 = __T274) , (void)(__T281 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T275), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T276), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T277), ((_ZNSsC1EPKcRKSaIcE((&__T278), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T279))) , (((const struct _ZSaIcE *)&__T279))))) , (((const struct _ZSs *)&__T278))), (cudaGetErrorString(__cuda_local_var_42156_27_non_const_status)))) , (((const struct _ZSs *)&__T277))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T276))), ((const char *)"kFindBlocksWithInteractionsPeriodic"))) , (((const _ZSt6string *)&__T275))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T280->__b_St9exception)))) , (void)(((__T280->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T280->message)), __T281)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T275)))) , (void)(_ZNSsD1Ev((&__T276)))) , (void)(_ZNSsD1Ev((&__T277)))) , (void)(_ZNSsD1Ev((&__T278)))) , (void)(_ZNSaIcED1Ev((&__T279))); } } ;

compactStream((((const struct compactionPlan *)&(__cuda_local_var_42152_24_non_const_gpu->compactPlan))), ((__cuda_local_var_42152_24_non_const_gpu->sim).pInteractingWorkUnit), ((const unsigned *)((__cuda_local_var_42152_24_non_const_gpu->sim).pWorkUnit)), ((const unsigned *)((__cuda_local_var_42152_24_non_const_gpu->sim).pInteractionFlag)), ((size_t)((__cuda_local_var_42152_24_non_const_gpu->sim).workUnits)), ((__cuda_local_var_42152_24_non_const_gpu->sim).pInteractionCount));
# 472 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
(cudaConfigureCall((((void)((__T263 = ((__cuda_local_var_42152_24_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T262.x) = __T263) , (void)((__T262.y) = 1U)) , ((__T262.z) = 1U)))) , __T262), (((void)((__T265 = ((__cuda_local_var_42152_24_non_const_gpu->sim).nonbond_threads_per_block)) , (void)((((__T264.x) = __T265) , (void)((__T264.y) = 1U)) , ((__T264.z) = 1U)))) , __T264), (4UL * ((unsigned long)((__cuda_local_var_42152_24_non_const_gpu->sim).nonbond_threads_per_block))), ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z44kFindInteractionsWithinBlocksPeriodic_kernelPj(((__cuda_local_var_42152_24_non_const_gpu->sim).pInteractingWorkUnit)));

{  enum cudaError __cuda_local_var_42168_27_non_const_status;
# 474 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaRotateFrame.cu"
__cuda_local_var_42168_27_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_42168_27_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T282;
 struct _ZSs __T283;
 struct _ZSs __T284;
 struct _ZSs __T285;
 _ZSt6string __T286;
...
} { _ZNSsD1Ev((&__cuda_local_var_42121_17_non_const_methodName));  }
...
#include "kCalculateAmoebaCudaRotateFrame.compute_12.cudafe1.stub.c"
