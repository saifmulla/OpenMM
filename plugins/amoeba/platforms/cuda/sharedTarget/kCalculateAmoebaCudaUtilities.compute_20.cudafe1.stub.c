...
# 1 "kCalculateAmoebaCudaUtilities.compute_20.cudafe1.stub.c"
...
# 1 "kCalculateAmoebaCudaUtilities.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2165) {  __nv_dummy_param_ref(__T2165); __cudaRegisterEntry(__T2165, ((void ( *)(unsigned, unsigned, float *, struct float4 *))kReduceFieldsToFloat4_kernel), _Z28kReduceFieldsToFloat4_kerneljjPfP6float4, 512); __cudaRegisterEntry(__T2165, ((void ( *)(unsigned, unsigned, float *, float *, float *))kReduceAndCombineFields_kernel), _Z30kReduceAndCombineFields_kerneljjPfS_S_, 512); __cudaRegisterEntry(__T2165, ((void ( *)(unsigned, unsigned, float *, float *, int))kReduceFields_kernel), _Z20kReduceFields_kerneljjPfS_i, 512); __cudaRegisterEntry(__T2165, ((void ( *)(unsigned, float *))kClearFields_kernel), _Z19kClearFields_kerneljPf, 512); __cudaRegisterEntry(__T2165, ((void ( *)(unsigned, float *))kClearFloat_kernel), _Z18kClearFloat_kerneljPf, 512); __cudaRegisterEntry(__T2165, ((void ( *)(void))kClearBornSum_kernel), _Z20kClearBornSum_kernelv, 384); __cudaRegisterEntry(__T2165, ((void ( *)(unsigned, struct float4 *))kClearFloat4_kernel), _Z19kClearFloat4_kerneljP6float4, 512); __cudaRegisterEntry(__T2165, ((void ( *)(unsigned *))kFindInteractionsWithinBlocksVdwPeriodic_kernel), _Z47kFindInteractionsWithinBlocksVdwPeriodic_kernelPj, (-1)); __cudaRegisterEntry(__T2165, ((void ( *)(void))kFindBlocksWithInteractionsVdwPeriodic_kernel), _Z45kFindBlocksWithInteractionsVdwPeriodic_kernelv, (-1)); __cudaRegisterEntry(__T2165, ((void ( *)(unsigned *))kFindInteractionsWithinBlocksPeriodic_kernel), _Z44kFindInteractionsWithinBlocksPeriodic_kernelPj, (-1)); __cudaRegisterEntry(__T2165, ((void ( *)(void))kFindBlocksWithInteractionsPeriodic_kernel), _Z42kFindBlocksWithInteractionsPeriodic_kernelv, (-1)); __cudaRegisterEntry(__T2165, ((void ( *)(void))kFindBlockBoundsPeriodic_kernel), _Z31kFindBlockBoundsPeriodic_kernelv, (-1)); __cudaRegisterVariable(__T2165, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T2165, __shadow_var(cAmoebaSim,cAmoebaSim), 0, 1792, 1, 0); }
