...
# 1 "kCalculateAmoebaCudaPmeMutualInducedField.compute_20.cudafe1.stub.c"
...
# 1 "kCalculateAmoebaCudaPmeMutualInducedField.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2117) {  __nv_dummy_param_ref(__T2117); __cudaRegisterEntry(__T2117, ((void ( *)(float *, float *, float *, float *, float *, float *, float *))kSorUpdateMutualInducedField_kernel), _Z35kSorUpdateMutualInducedField_kernelPfS_S_S_S_S_S_, 512); __cudaRegisterEntry(__T2117, ((void ( *)(int, float *, float *, float *))kReduceMutualInducedFieldDelta_kernel), _Z37kReduceMutualInducedFieldDelta_kerneliPfS_S_, 512); __cudaRegisterEntry(__T2117, ((void ( *)(int, float *, float *, float *))kInitializeMutualInducedField_kernel), _Z36kInitializeMutualInducedField_kerneliPfS_S_, 512); __cudaRegisterEntry(__T2117, ((void ( *)(unsigned *, float *, float *))kCalculateAmoebaPmeMutualInducedFieldCutoffByWarp_kernel), _Z56kCalculateAmoebaPmeMutualInducedFieldCutoffByWarp_kernelPjPfS0_, 768); __cudaRegisterEntry(__T2117, ((void ( *)(unsigned *, float *, float *))kCalculateAmoebaPmeMutualInducedFieldCutoff_kernel), _Z50kCalculateAmoebaPmeMutualInducedFieldCutoff_kernelPjPfS0_, 768); __cudaRegisterVariable(__T2117, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T2117, __shadow_var(cAmoebaSim,cAmoebaSim), 0, 1792, 1, 0); __cudaRegisterVariable(__T2117, __shadow_var(mpoleScale,mpoleScale), 0, 20, 1, 0); __cudaRegisterVariable(__T2117, __shadow_var(polarScale,polarScale), 0, 20, 1, 0); __cudaRegisterVariable(__T2117, __shadow_var(directScale,directScale), 0, 20, 1, 0); }
