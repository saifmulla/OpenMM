...
# 1 "kCalculateAmoebaCudaGrycuk.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2175) {  __nv_dummy_param_ref(__T2175); __cudaRegisterEntry(__T2175, ((void ( *)(unsigned *))kCalculateAmoebaGrycukChainRuleN2ByWarp_kernel), _Z46kCalculateAmoebaGrycukChainRuleN2ByWarp_kernelPj, 768); __cudaRegisterEntry(__T2175, ((void ( *)(unsigned *))kCalculateAmoebaGrycukChainRuleN2_kernel), _Z40kCalculateAmoebaGrycukChainRuleN2_kernelPj, 768); __cudaRegisterEntry(__T2175, ((void ( *)(unsigned *))kCalculateAmoebaGrycukBornRadiiN2ByWarp_kernel), _Z46kCalculateAmoebaGrycukBornRadiiN2ByWarp_kernelPj, 768); __cudaRegisterEntry(__T2175, ((void ( *)(unsigned *))kCalculateAmoebaGrycukBornRadiiN2_kernel), _Z40kCalculateAmoebaGrycukBornRadiiN2_kernelPj, 768); __cudaRegisterEntry(__T2175, ((void ( *)(void))kReduceGrycukGbsaBornSum_kernel), _Z31kReduceGrycukGbsaBornSum_kernelv, 384); __cudaRegisterVariable(__T2175, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T2175, __shadow_var(cAmoebaSim,cAmoebaSim), 0, 1792, 1, 0); __cudaRegisterVariable(__T2175, __shadow_var(mpoleScale,mpoleScale), 0, 20, 1, 0); __cudaRegisterVariable(__T2175, __shadow_var(polarScale,polarScale), 0, 20, 1, 0); __cudaRegisterVariable(__T2175, __shadow_var(directScale,directScale), 0, 20, 1, 0); }
