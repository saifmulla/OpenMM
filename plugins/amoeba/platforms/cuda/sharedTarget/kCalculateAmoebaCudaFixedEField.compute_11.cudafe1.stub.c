...
# 1 "kCalculateAmoebaCudaFixedEField.compute_11.cudafe1.stub.c"
...
# 1 "kCalculateAmoebaCudaFixedEField.compute_11.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T277) {  __nv_dummy_param_ref(__T277); __cudaRegisterEntry(__T277, ((void ( *)(unsigned *, float *, float *))kCalculateAmoebaFixedE_FieldN2ByWarpForces_kernel), _Z49kCalculateAmoebaFixedE_FieldN2ByWarpForces_kernelPjPfS0_, 256); __cudaRegisterEntry(__T277, ((void ( *)(unsigned *, float *, float *))kCalculateAmoebaFixedE_FieldN2Forces_kernel), _Z43kCalculateAmoebaFixedE_FieldN2Forces_kernelPjPfS0_, 256); __cudaRegisterVariable(__T277, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T277, __shadow_var(cAmoebaSim,cAmoebaSim), 0, 1792, 1, 0); __cudaRegisterVariable(__T277, __shadow_var(mpoleScale,mpoleScale), 0, 20, 1, 0); __cudaRegisterVariable(__T277, __shadow_var(polarScale,polarScale), 0, 20, 1, 0); __cudaRegisterVariable(__T277, __shadow_var(directScale,directScale), 0, 20, 1, 0); }
