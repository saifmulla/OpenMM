...
# 1 "kCalculateAmoebaCudaMapTorques.compute_13.cudafe1.stub.c"
...
# 1 "kCalculateAmoebaCudaMapTorques.compute_13.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2164) {  __nv_dummy_param_ref(__T2164); __cudaRegisterEntry(__T2164, ((void ( *)(float *))amoebaMapTorqueToForce_kernel), _Z29amoebaMapTorqueToForce_kernelPf, 256); __cudaRegisterEntry(__T2164, ((void ( *)(void))amoebaClearMapTorqueForce_kernel), _Z32amoebaClearMapTorqueForce_kernelv, 256); __cudaRegisterEntry(__T2164, ((void ( *)(void))amoebaAddMapTorqueForceToForce_kernel), _Z37amoebaAddMapTorqueForceToForce_kernelv, 256); __cudaRegisterVariable(__T2164, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T2164, __shadow_var(cAmoebaSim,cAmoebaSim), 0, 1792, 1, 0); }
