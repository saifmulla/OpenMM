...
(((((__T214 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T219 = __T214) , (void)(__T220 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T215), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T216), ((_ZNSsC1EPKcRKSaIcE((&__T217), ((const char *)"GetCalculateAmoebaCudaFixedEFieldSim: cudaMemcpyFromSymbol: SetSim copy from cSim failed"), ((_ZNSaIcEC1Ev((&__T218))) , (((const struct _ZSaIcE *)&__T218))))) , (((const struct _ZSs *)&__T217))), ((const char *)" "))) , (((const struct _ZSs *)&__T216))), (cudaGetErrorString(__cuda_local_var_41623_17_non_const_status)))) , (((const _ZSt6string *)&__T215))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T219->__b_St9exception)))) , (void)(((__T219->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T219->message)), __T220)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T215)))) , (void)(_ZNSsD1Ev((&__T216)))) , (void)(_ZNSsD1Ev((&__T217)))) , (void)(_ZNSaIcED1Ev((&__T218))); } ;
...
# 58 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEField.cu"
 gpuContext __cuda_local_var_41636_16_non_const_gpu;
# 58 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEField.cu"
__cuda_local_var_41636_16_non_const_gpu = (amoebaGpu->gpuContext);
(cudaConfigureCall((((void)((__T229 = ((__cuda_local_var_41636_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T228.x) = __T229) , (void)((__T228.y) = 1U)) , ((__T228.z) = 1U)))) , __T228), (((void)((__T231 = ((__cuda_local_var_41636_16_non_const_gpu->sim).bsf_reduce_threads_per_block)) , (void)((((__T230.x) = __T231) , (void)((__T230.y) = 1U)) , ((__T230.z) = 1U)))) , __T230), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z20kReduceFields_kerneljjPfS_i((((__cuda_local_var_41636_16_non_const_gpu->sim).paddedNumberOfAtoms) * 3U), ((__cuda_local_var_41636_16_non_const_gpu->sim).outputBuffers), ((amoebaGpu->psWorkArray_3_1)->_pDevData), ((amoebaGpu->psE_Field)->_pDevData), 0));


{  enum cudaError __cuda_local_var_41640_19_non_const_status;
# 62 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEField.cu"
__cuda_local_var_41640_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_41640_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T236;
 struct _ZSs __T237;
 struct _ZSs __T238;
 struct _ZSs __T239;
 _ZSt6string __T240;
...
# 96 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEField.cu"
 gpuContext __cuda_local_var_42497_16_non_const_gpu;
# 96 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEField.cu"
__cuda_local_var_42497_16_non_const_gpu = (amoebaGpu->gpuContext);

_Z14kClearFields_3P17_amoebaGpuContextj(amoebaGpu, 2U);


if (threadsPerBlock == 0U) {  unsigned __T252;
 unsigned __cuda_local_var_42503_22_non_const_maxThreads;
if (((int)(__cuda_local_var_42497_16_non_const_gpu->sm_version)) >= 3) {
__cuda_local_var_42503_22_non_const_maxThreads = 512U; } else  {
if (((int)(__cuda_local_var_42497_16_non_const_gpu->sm_version)) >= 2) {
__cuda_local_var_42503_22_non_const_maxThreads = 128U; } else  {

__cuda_local_var_42503_22_non_const_maxThreads = 64U; } }
threadsPerBlock = (*(_ZSt3minIjERKT_S2_S2_(((__T252 = (_Z18getThreadsPerBlockP17_amoebaGpuContextjj(amoebaGpu, 84U, (__cuda_local_var_42497_16_non_const_gpu->sharedMemoryPerBlock)))) , (((const unsigned *)&__T252))), (((const unsigned *)&__cuda_local_var_42503_22_non_const_maxThreads)))));
}

if (__cuda_local_var_42497_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T253;
 unsigned __T254;
 struct dim3 __T255;
 unsigned __T256;
# 113 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEField.cu"
(cudaConfigureCall((((void)((__T254 = ((__cuda_local_var_42497_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T253.x) = __T254) , (void)((__T253.y) = 1U)) , ((__T253.z) = 1U)))) , __T253), (((void)((__T256 = threadsPerBlock) , (void)((((__T255.x) = __T256) , (void)((__T255.y) = 1U)) , ((__T255.z) = 1U)))) , __T255), (84UL * ((unsigned long)threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z49kCalculateAmoebaFixedE_FieldN2ByWarpForces_kernelPjPfS0_(((__cuda_local_var_42497_16_non_const_gpu->psWorkUnit)->_pDevData), ((amoebaGpu->psWorkArray_3_1)->_pDevData), ((amoebaGpu->psWorkArray_3_2)->_pDevData)));
...
#include "kCalculateAmoebaCudaFixedEField.compute_11.cudafe1.stub.c"
