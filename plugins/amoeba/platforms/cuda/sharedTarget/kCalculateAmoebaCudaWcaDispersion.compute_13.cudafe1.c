...
{
 enum cudaError __cuda_local_var_42009_17_non_const_status;
 gpuContext __cuda_local_var_42010_16_non_const_gpu;
# 43 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaWcaDispersion.cu"
__cuda_local_var_42010_16_non_const_gpu = (amoebaGpu->gpuContext);
__cuda_local_var_42009_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(__cuda_local_var_42010_16_non_const_gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_42009_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
{
 enum cudaError __cuda_local_var_42019_17_non_const_status;
 gpuContext __cuda_local_var_42020_16_non_const_gpu;
# 53 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaWcaDispersion.cu"
__cuda_local_var_42020_16_non_const_gpu = (amoebaGpu->gpuContext);
__cuda_local_var_42019_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(__cuda_local_var_42020_16_non_const_gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_42019_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T214;
 struct _ZSs __T215;
 struct _ZSs __T216;
 _ZSt6string __T217;
...
(((((__T214 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T219 = __T214) , (void)(__T220 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T215), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T216), ((_ZNSsC1EPKcRKSaIcE((&__T217), ((const char *)"GetCalculateAmoebaCudaWcaDispersionSim: cudaMemcpyFromSymbol: SetSim copy from cSim failed"), ((_ZNSaIcEC1Ev((&__T218))) , (((const struct _ZSaIcE *)&__T218))))) , (((const struct _ZSs *)&__T217))), ((const char *)" "))) , (((const struct _ZSs *)&__T216))), (cudaGetErrorString(__cuda_local_var_42019_17_non_const_status)))) , (((const _ZSt6string *)&__T215))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T219->__b_St9exception)))) , (void)(((__T219->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T219->message)), __T220)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T215)))) , (void)(_ZNSsD1Ev((&__T216)))) , (void)(_ZNSsD1Ev((&__T217)))) , (void)(_ZNSaIcED1Ev((&__T218))); } ;
__cuda_local_var_42019_17_non_const_status = (_Z20cudaMemcpyFromSymbolI23cudaAmoebaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(amoebaGpu->amoebaSim))), (((const struct cudaAmoebaGmxSimulation *)&cAmoebaSim)), 1792UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_42019_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T221;
 struct _ZSs __T222;
 struct _ZSs __T223;
 _ZSt6string __T224;
...
static int threadsPerBlock = 0;
 ...
 gpuContext __cuda_local_var_42647_17_non_const_gpu;
# 362 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaWcaDispersion.cu"
__cuda_local_var_42647_17_non_const_gpu = (amoebaGpu->gpuContext);



if (threadsPerBlock == 0) {  unsigned __T228;
 unsigned __cuda_local_var_42652_22_non_const_maxThreads;
if (((int)(__cuda_local_var_42647_17_non_const_gpu->sm_version)) >= 3) {
__cuda_local_var_42652_22_non_const_maxThreads = 384U; } else  {
if (((int)(__cuda_local_var_42647_17_non_const_gpu->sm_version)) >= 2) {
__cuda_local_var_42652_22_non_const_maxThreads = 192U; } else  {

__cuda_local_var_42652_22_non_const_maxThreads = 64U; } }
threadsPerBlock = ((int)(*(_ZSt3minIjERKT_S2_S2_(((__T228 = (_Z18getThreadsPerBlockP17_amoebaGpuContextjj(amoebaGpu, 36U, (__cuda_local_var_42647_17_non_const_gpu->sharedMemoryPerBlock)))) , (((const unsigned *)&__T228))), (((const unsigned *)&__cuda_local_var_42652_22_non_const_maxThreads))))));
}

if (__cuda_local_var_42647_17_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T229;
 unsigned __T230;
 struct dim3 __T231;
 unsigned __T232;
# 379 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaWcaDispersion.cu"
(cudaConfigureCall((((void)((__T230 = ((__cuda_local_var_42647_17_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T229.x) = __T230) , (void)((__T229.y) = 1U)) , ((__T229.z) = 1U)))) , __T229), (((void)((__T232 = ((unsigned)threadsPerBlock)) , (void)((((__T231.x) = __T232) , (void)((__T231.y) = 1U)) , ((__T231.z) = 1U)))) , __T231), (36UL * ((unsigned long)threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z44kCalculateAmoebaWcaDispersionN2ByWarp_kernelPj(((__cuda_local_var_42647_17_non_const_gpu->psWorkUnit)->_pDevData)));
...
(cudaConfigureCall((((void)((__T234 = ((__cuda_local_var_42647_17_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T233.x) = __T234) , (void)((__T233.y) = 1U)) , ((__T233.z) = 1U)))) , __T233), (((void)((__T236 = ((unsigned)threadsPerBlock)) , (void)((((__T235.x) = __T236) , (void)((__T235.y) = 1U)) , ((__T235.z) = 1U)))) , __T235), (36UL * ((unsigned long)threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z38kCalculateAmoebaWcaDispersionN2_kernelPj(((__cuda_local_var_42647_17_non_const_gpu->psWorkUnit)->_pDevData)));


}
{  enum cudaError __cuda_local_var_42673_19_non_const_status;
# 388 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaWcaDispersion.cu"
__cuda_local_var_42673_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_42673_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T237;
 struct _ZSs __T238;
 struct _ZSs __T239;
 struct _ZSs __T240;
 _ZSt6string __T241;
...
#include "kCalculateAmoebaCudaWcaDispersion.compute_13.cudafe1.stub.c"
