...
# 1 "kCalculateAmoebaCudaRotateFrame.compute_20.cudafe1.stub.c"
...
# 1 "kCalculateAmoebaCudaRotateFrame.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T2116) {  __nv_dummy_param_ref(__T2116); __cudaRegisterEntry(__T2116, ((void ( *)(void))kCudaComputeLabFrameMoments_kernel), _Z34kCudaComputeLabFrameMoments_kernelv, 512); __cudaRegisterEntry(__T2116, ((void ( *)(void))kCudaComputeCheckChiral_kernel), _Z30kCudaComputeCheckChiral_kernelv, 512); __cudaRegisterVariable(__T2116, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T2116, __shadow_var(cAmoebaSim,cAmoebaSim), 0, 1792, 1, 0); }
