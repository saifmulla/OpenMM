...
{
 enum cudaError __cuda_local_var_41986_17_non_const_status;
 gpuContext __cuda_local_var_41987_16_non_const_gpu;
# 38 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaPmeFixedEField.cu"
__cuda_local_var_41987_16_non_const_gpu = (amoebaGpu->gpuContext);
__cuda_local_var_41986_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(__cuda_local_var_41987_16_non_const_gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41986_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
{
 enum cudaError __cuda_local_var_41996_17_non_const_status;
 gpuContext __cuda_local_var_41997_16_non_const_gpu;
# 48 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaPmeFixedEField.cu"
__cuda_local_var_41997_16_non_const_gpu = (amoebaGpu->gpuContext);
__cuda_local_var_41996_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(__cuda_local_var_41997_16_non_const_gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_41996_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T214;
 struct _ZSs __T215;
 struct _ZSs __T216;
 _ZSt6string __T217;
...
(((((__T214 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T219 = __T214) , (void)(__T220 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T215), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T216), ((_ZNSsC1EPKcRKSaIcE((&__T217), ((const char *)"GetCalculateAmoebaCudaPmeFixedEFieldSim: cudaMemcpyFromSymbol: SetSim copy from cSim failed"), ((_ZNSaIcEC1Ev((&__T218))) , (((const struct _ZSaIcE *)&__T218))))) , (((const struct _ZSs *)&__T217))), ((const char *)" "))) , (((const struct _ZSs *)&__T216))), (cudaGetErrorString(__cuda_local_var_41996_17_non_const_status)))) , (((const _ZSt6string *)&__T215))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T219->__b_St9exception)))) , (void)(((__T219->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T219->message)), __T220)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T215)))) , (void)(_ZNSsD1Ev((&__T216)))) , (void)(_ZNSsD1Ev((&__T217)))) , (void)(_ZNSaIcED1Ev((&__T218))); } ;
__cuda_local_var_41996_17_non_const_status = (_Z20cudaMemcpyFromSymbolI23cudaAmoebaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(amoebaGpu->amoebaSim))), (((const struct cudaAmoebaGmxSimulation *)&cAmoebaSim)), 1792UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_41996_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T221;
 struct _ZSs __T222;
 struct _ZSs __T223;
 _ZSt6string __T224;
...
# 159 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaPmeFixedEField.cu"
 gpuContext __cuda_local_var_42108_16_non_const_gpu;
# 159 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaPmeFixedEField.cu"
__cuda_local_var_42108_16_non_const_gpu = (amoebaGpu->gpuContext);



(cudaConfigureCall((((void)((__T229 = ((__cuda_local_var_42108_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T228.x) = __T229) , (void)((__T228.y) = 1U)) , ((__T228.z) = 1U)))) , __T228), (((void)((__T231 = ((__cuda_local_var_42108_16_non_const_gpu->sim).bsf_reduce_threads_per_block)) , (void)((((__T230.x) = __T231) , (void)((__T230.y) = 1U)) , ((__T230.z) = 1U)))) , __T230), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z28kReducePmeEFieldPolar_kerneljjPfS_S_((((__cuda_local_var_42108_16_non_const_gpu->sim).paddedNumberOfAtoms) * 3U), ((__cuda_local_var_42108_16_non_const_gpu->sim).outputBuffers), ((amoebaGpu->psE_Field)->_pDevData), ((amoebaGpu->psWorkArray_3_2)->_pDevData), ((amoebaGpu->psE_FieldPolar)->_pDevData)));
...
__cuda_local_var_42115_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_42115_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T236;
 struct _ZSs __T237;
 struct _ZSs __T238;
 struct _ZSs __T239;
 _ZSt6string __T240;
...
if (threadsPerBlock == 0U) {  unsigned __T252;
 unsigned __cuda_local_var_43116_22_non_const_maxThreads;
if (((int)(__cuda_local_var_43109_16_non_const_gpu->sm_version)) >= 3) {
__cuda_local_var_43116_22_non_const_maxThreads = 384U; } else  {
if (((int)(__cuda_local_var_43109_16_non_const_gpu->sm_version)) >= 2) {
__cuda_local_var_43116_22_non_const_maxThreads = 192U; } else  {

__cuda_local_var_43116_22_non_const_maxThreads = 64U; } }
threadsPerBlock = (*(_ZSt3minIjERKT_S2_S2_(((__T252 = (_Z18getThreadsPerBlockP17_amoebaGpuContextjj(amoebaGpu, 108U, (__cuda_local_var_43109_16_non_const_gpu->sharedMemoryPerBlock)))) , (((const unsigned *)&__T252))), (((const unsigned *)&__cuda_local_var_43116_22_non_const_maxThreads)))));
}

if (__cuda_local_var_43109_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T253;
 unsigned __T254;
 struct dim3 __T255;
 unsigned __T256;
# 397 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaPmeFixedEField.cu"
(cudaConfigureCall((((void)((__T254 = ((__cuda_local_var_43109_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T253.x) = __T254) , (void)((__T253.y) = 1U)) , ((__T253.z) = 1U)))) , __T253), (((void)((__T256 = threadsPerBlock) , (void)((((__T255.x) = __T256) , (void)((__T255.y) = 1U)) , ((__T255.z) = 1U)))) , __T255), (108UL * ((unsigned long)threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z56kCalculateAmoebaPmeDirectFixedE_FieldCutoffByWarp_kernelPjPfS0_(((__cuda_local_var_43109_16_non_const_gpu->sim).pInteractingWorkUnit), ((amoebaGpu->psWorkArray_3_1)->_pDevData), ((amoebaGpu->psWorkArray_3_2)->_pDevData)));
...
(cudaConfigureCall((((void)((__T258 = ((__cuda_local_var_43109_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T257.x) = __T258) , (void)((__T257.y) = 1U)) , ((__T257.z) = 1U)))) , __T257), (((void)((__T260 = threadsPerBlock) , (void)((((__T259.x) = __T260) , (void)((__T259.y) = 1U)) , ((__T259.z) = 1U)))) , __T259), (108UL * ((unsigned long)threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z50kCalculateAmoebaPmeDirectFixedE_FieldCutoff_kernelPjPfS0_(((__cuda_local_var_43109_16_non_const_gpu->sim).pInteractingWorkUnit), ((amoebaGpu->psWorkArray_3_1)->_pDevData), ((amoebaGpu->psWorkArray_3_2)->_pDevData)));



}
{  enum cudaError __cuda_local_var_43137_19_non_const_status;
# 407 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaPmeFixedEField.cu"
__cuda_local_var_43137_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_43137_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T261;
 struct _ZSs __T262;
 struct _ZSs __T263;
 struct _ZSs __T264;
 _ZSt6string __T265;
...
#include "kCalculateAmoebaCudaPmeFixedEField.compute_13.cudafe1.stub.c"
