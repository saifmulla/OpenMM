...
# 1 "kCalculateAmoebaCudaKirkwoodEDiff.compute_20.cudafe1.stub.c"
...
# 1 "kCalculateAmoebaCudaKirkwoodEDiff.compute_20.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T265) {  __nv_dummy_param_ref(__T265); __cudaRegisterEntry(__T265, ((void ( *)(unsigned *, float *))kCalculateAmoebaCudaKirkwoodEDiffN2ByWarpForces_kernel), _Z54kCalculateAmoebaCudaKirkwoodEDiffN2ByWarpForces_kernelPjPf, 512); __cudaRegisterEntry(__T265, ((void ( *)(unsigned *, float *))kCalculateAmoebaCudaKirkwoodEDiffN2Forces_kernel), _Z48kCalculateAmoebaCudaKirkwoodEDiffN2Forces_kernelPjPf, 512); __cudaRegisterVariable(__T265, __shadow_var(cSim,cSim), 0, 1224, 1, 0); __cudaRegisterVariable(__T265, __shadow_var(cAmoebaSim,cAmoebaSim), 0, 1792, 1, 0); __cudaRegisterVariable(__T265, __shadow_var(mpoleScale,mpoleScale), 0, 20, 1, 0); __cudaRegisterVariable(__T265, __shadow_var(polarScale,polarScale), 0, 20, 1, 0); __cudaRegisterVariable(__T265, __shadow_var(directScale,directScale), 0, 20, 1, 0); }
