# 1 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
...
SM_20};
# 65 "/home/saifmulla/openmm/OpenMM/platforms/cuda/src/kernels/cudatypes.h"
struct _Z10CUDAStreamI6float2E; struct _Z10CUDAStreamI4int4E; struct _Z10CUDAStreamI4int2E; struct _Z10CUDAStreamIiE; struct _Z10CUDAStreamImE; struct _Z10CUDAStreamI5uint4E;
# 73 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/stl_vector.h" 3
...
# 33 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
extern void _Z42SetCalculateAmoebaCudaFixedEAndGKFieldsSimP17_amoebaGpuContext(amoebaGpuContext);
...
# 43 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
extern void _Z41GetCalculateAmoebaCudaFixedEAndGKFieldSimP17_amoebaGpuContext(amoebaGpuContext);
...
# 57 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
static void _Z19kReduceEAndGkFieldsP17_amoebaGpuContext(amoebaGpuContext);
# 338 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
...
static void __sti___56_kCalculateAmoebaCudaFixedEAndGkFields_compute_20_cpp1_ii_b5838d25(void) __attribute__((__constructor__));
...
# 33 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
void _Z42SetCalculateAmoebaCudaFixedEAndGKFieldsSimP17_amoebaGpuContext( amoebaGpuContext amoebaGpu)
{
 enum cudaError __cuda_local_var_41870_17_non_const_status;
 gpuContext __cuda_local_var_41871_16_non_const_gpu;
# 36 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
__cuda_local_var_41871_16_non_const_gpu = (amoebaGpu->gpuContext);
__cuda_local_var_41870_17_non_const_status = (_Z18cudaMemcpyToSymbolI17cudaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaGmxSimulation *)&cSim)), ((const void *)(&(__cuda_local_var_41871_16_non_const_gpu->sim))), 1224UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41870_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T20;
 struct _ZSs __T21;
 struct _ZSs __T22;
 _ZSt6string __T23;
...
# 38 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
(((((__T20 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T25 = __T20) , (void)(__T26 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T21), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T22), ((_ZNSsC1EPKcRKSaIcE((&__T23), ((const char *)"SetCalculateAmoebaCudaFixedEAndGKFieldSim: cudaMemcpyToSymbol: SetSim copy to cSim failed"), ((_ZNSaIcEC1Ev((&__T24))) , (((const struct _ZSaIcE *)&__T24))))) , (((const struct _ZSs *)&__T23))), ((const char *)" "))) , (((const struct _ZSs *)&__T22))), (cudaGetErrorString(__cuda_local_var_41870_17_non_const_status)))) , (((const _ZSt6string *)&__T21))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T25->__b_St9exception)))) , (void)(((__T25->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T25->message)), __T26)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T21)))) , (void)(_ZNSsD1Ev((&__T22)))) , (void)(_ZNSsD1Ev((&__T23)))) , (void)(_ZNSaIcED1Ev((&__T24))); } ;
__cuda_local_var_41870_17_non_const_status = (_Z18cudaMemcpyToSymbolI23cudaAmoebaGmxSimulationE9cudaErrorRKT_PKvmm14cudaMemcpyKind((((const struct cudaAmoebaGmxSimulation *)&cAmoebaSim)), ((const void *)(&(amoebaGpu->amoebaSim))), 1792UL, 0UL, cudaMemcpyHostToDevice));
if (((int)__cuda_local_var_41870_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T27;
 struct _ZSs __T28;
 struct _ZSs __T29;
 _ZSt6string __T210;
...
# 43 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
void _Z41GetCalculateAmoebaCudaFixedEAndGKFieldSimP17_amoebaGpuContext( amoebaGpuContext amoebaGpu)
{
 enum cudaError __cuda_local_var_41880_17_non_const_status;
 gpuContext __cuda_local_var_41881_16_non_const_gpu;
# 46 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
__cuda_local_var_41881_16_non_const_gpu = (amoebaGpu->gpuContext);
__cuda_local_var_41880_17_non_const_status = (_Z20cudaMemcpyFromSymbolI17cudaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(__cuda_local_var_41881_16_non_const_gpu->sim))), (((const struct cudaGmxSimulation *)&cSim)), 1224UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_41880_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T214;
 struct _ZSs __T215;
 struct _ZSs __T216;
 _ZSt6string __T217;
...
# 48 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
(((((__T214 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T219 = __T214) , (void)(__T220 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T215), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T216), ((_ZNSsC1EPKcRKSaIcE((&__T217), ((const char *)"GetCalculateAmoebaCudaFixedEAndGKFieldSim: cudaMemcpyFromSymbol: SetSim copy from cSim failed"), ((_ZNSaIcEC1Ev((&__T218))) , (((const struct _ZSaIcE *)&__T218))))) , (((const struct _ZSs *)&__T217))), ((const char *)" "))) , (((const struct _ZSs *)&__T216))), (cudaGetErrorString(__cuda_local_var_41880_17_non_const_status)))) , (((const _ZSt6string *)&__T215))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T219->__b_St9exception)))) , (void)(((__T219->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T219->message)), __T220)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T215)))) , (void)(_ZNSsD1Ev((&__T216)))) , (void)(_ZNSsD1Ev((&__T217)))) , (void)(_ZNSaIcED1Ev((&__T218))); } ;
__cuda_local_var_41880_17_non_const_status = (_Z20cudaMemcpyFromSymbolI23cudaAmoebaGmxSimulationE9cudaErrorPvRKT_mm14cudaMemcpyKind(((void *)(&(amoebaGpu->amoebaSim))), (((const struct cudaAmoebaGmxSimulation *)&cAmoebaSim)), 1792UL, 0UL, cudaMemcpyDeviceToHost));
if (((int)__cuda_local_var_41880_17_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T221;
 struct _ZSs __T222;
 struct _ZSs __T223;
 _ZSt6string __T224;
...
# 50 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
(((((__T221 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T226 = __T221) , (void)(__T227 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T222), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T223), ((_ZNSsC1EPKcRKSaIcE((&__T224), ((const char *)"GetCalculateAmoebaCudaFixedEAndGKFieldSim: cudaMemcpyFromSymbol: SetSim copy from cAmoebaSim failed"), ((_ZNSaIcEC1Ev((&__T225))) , (((const struct _ZSaIcE *)&__T225))))) , (((const struct _ZSs *)&__T224))), ((const char *)" "))) , (((const struct _ZSs *)&__T223))), (cudaGetErrorString(__cuda_local_var_41880_17_non_const_status)))) , (((const _ZSt6string *)&__T222))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T226->__b_St9exception)))) , (void)(((__T226->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T226->message)), __T227)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T222)))) , (void)(_ZNSsD1Ev((&__T223)))) , (void)(_ZNSsD1Ev((&__T224)))) , (void)(_ZNSaIcED1Ev((&__T225))); } ; 
}
# 415 "/usr/local/cuda-5.0/include/cuda_runtime.h"
...
# 57 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
static void _Z19kReduceEAndGkFieldsP17_amoebaGpuContext( amoebaGpuContext amoebaGpu)
{  struct dim3 __T228;
 unsigned __T229;
 struct dim3 __T230;
 unsigned __T231;
 ...
 struct dim3 __T238;
 unsigned __T239;
# 60 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
 gpuContext __cuda_local_var_41895_16_non_const_gpu;
# 60 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
__cuda_local_var_41895_16_non_const_gpu = (amoebaGpu->gpuContext);
(cudaConfigureCall((((void)((__T229 = ((__cuda_local_var_41895_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T228.x) = __T229) , (void)((__T228.y) = 1U)) , ((__T228.z) = 1U)))) , __T228), (((void)((__T231 = ((__cuda_local_var_41895_16_non_const_gpu->sim).bsf_reduce_threads_per_block)) , (void)((((__T230.x) = __T231) , (void)((__T230.y) = 1U)) , ((__T230.z) = 1U)))) , __T230), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z20kReduceFields_kerneljjPfS_i((((__cuda_local_var_41895_16_non_const_gpu->sim).paddedNumberOfAtoms) * 3U), ((__cuda_local_var_41895_16_non_const_gpu->sim).outputBuffers), ((amoebaGpu->psWorkArray_3_1)->_pDevData), ((amoebaGpu->psE_Field)->_pDevData), 0));



{  enum cudaError __cuda_local_var_41900_19_non_const_status;
# 65 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
__cuda_local_var_41900_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_41900_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T240;
 struct _ZSs __T241;
 struct _ZSs __T242;
 struct _ZSs __T243;
 _ZSt6string __T244;
...
# 65 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
((((((__T240 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T246 = __T240) , (void)(__T247 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T241), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T242), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T243), ((_ZNSsC1EPKcRKSaIcE((&__T244), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T245))) , (((const struct _ZSaIcE *)&__T245))))) , (((const struct _ZSs *)&__T244))), (cudaGetErrorString(__cuda_local_var_41900_19_non_const_status)))) , (((const struct _ZSs *)&__T243))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T242))), ((const char *)"kReduceEAndGK_Fields1"))) , (((const _ZSt6string *)&__T241))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T246->__b_St9exception)))) , (void)(((__T246->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T246->message)), __T247)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T241)))) , (void)(_ZNSsD1Ev((&__T242)))) , (void)(_ZNSsD1Ev((&__T243)))) , (void)(_ZNSsD1Ev((&__T244)))) , (void)(_ZNSaIcED1Ev((&__T245))); } } ;
(cudaConfigureCall((((void)((__T233 = ((__cuda_local_var_41895_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T232.x) = __T233) , (void)((__T232.y) = 1U)) , ((__T232.z) = 1U)))) , __T232), (((void)((__T235 = ((__cuda_local_var_41895_16_non_const_gpu->sim).bsf_reduce_threads_per_block)) , (void)((((__T234.x) = __T235) , (void)((__T234.y) = 1U)) , ((__T234.z) = 1U)))) , __T234), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z20kReduceFields_kerneljjPfS_i((((__cuda_local_var_41895_16_non_const_gpu->sim).paddedNumberOfAtoms) * 3U), ((__cuda_local_var_41895_16_non_const_gpu->sim).outputBuffers), ((amoebaGpu->psWorkArray_3_2)->_pDevData), ((amoebaGpu->psE_FieldPolar)->_pDevData), 0));


{  enum cudaError __cuda_local_var_41904_19_non_const_status;
# 69 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
__cuda_local_var_41904_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_41904_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T248;
 struct _ZSs __T249;
 struct _ZSs __T250;
 struct _ZSs __T251;
 _ZSt6string __T252;
 struct _ZSaIcE __T253;
 struct _ZN6OpenMM15OpenMMExceptionE *__T254;
 const _ZSt6string *__T255;
# 69 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
((((((__T248 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T254 = __T248) , (void)(__T255 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T249), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T250), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T251), ((_ZNSsC1EPKcRKSaIcE((&__T252), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T253))) , (((const struct _ZSaIcE *)&__T253))))) , (((const struct _ZSs *)&__T252))), (cudaGetErrorString(__cuda_local_var_41904_19_non_const_status)))) , (((const struct _ZSs *)&__T251))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T250))), ((const char *)"kReduceEAndGK_Fields2"))) , (((const _ZSt6string *)&__T249))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T254->__b_St9exception)))) , (void)(((__T254->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T254->message)), __T255)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T249)))) , (void)(_ZNSsD1Ev((&__T250)))) , (void)(_ZNSsD1Ev((&__T251)))) , (void)(_ZNSsD1Ev((&__T252)))) , (void)(_ZNSaIcED1Ev((&__T253))); } } ;

(cudaConfigureCall((((void)((__T237 = ((__cuda_local_var_41895_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T236.x) = __T237) , (void)((__T236.y) = 1U)) , ((__T236.z) = 1U)))) , __T236), (((void)((__T239 = ((__cuda_local_var_41895_16_non_const_gpu->sim).bsf_reduce_threads_per_block)) , (void)((((__T238.x) = __T239) , (void)((__T238.y) = 1U)) , ((__T238.z) = 1U)))) , __T238), 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (_Z20kReduceFields_kerneljjPfS_i((((__cuda_local_var_41895_16_non_const_gpu->sim).paddedNumberOfAtoms) * 3U), ((__cuda_local_var_41895_16_non_const_gpu->sim).outputBuffers), ((amoebaGpu->psWorkArray_3_3)->_pDevData), ((amoebaGpu->psGk_Field)->_pDevData), 0));


{  enum cudaError __cuda_local_var_41909_19_non_const_status;
# 74 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
__cuda_local_var_41909_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_41909_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T256;
 struct _ZSs __T257;
 struct _ZSs __T258;
 struct _ZSs __T259;
 _ZSt6string __T260;
 struct _ZSaIcE __T261;
 struct _ZN6OpenMM15OpenMMExceptionE *__T262;
 const _ZSt6string *__T263;
# 74 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
((((((__T256 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T262 = __T256) , (void)(__T263 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T257), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T258), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T259), ((_ZNSsC1EPKcRKSaIcE((&__T260), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T261))) , (((const struct _ZSaIcE *)&__T261))))) , (((const struct _ZSs *)&__T260))), (cudaGetErrorString(__cuda_local_var_41909_19_non_const_status)))) , (((const struct _ZSs *)&__T259))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T258))), ((const char *)"kReduceEAndGK_Fields3"))) , (((const _ZSt6string *)&__T257))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T262->__b_St9exception)))) , (void)(((__T262->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T262->message)), __T263)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T257)))) , (void)(_ZNSsD1Ev((&__T258)))) , (void)(_ZNSsD1Ev((&__T259)))) , (void)(_ZNSsD1Ev((&__T260)))) , (void)(_ZNSaIcED1Ev((&__T261))); } } ; 
}
# 338 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
void _Z34cudaComputeAmoebaFixedEAndGkFieldsP17_amoebaGpuContext( amoebaGpuContext amoebaGpu)
{
# 349 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
static unsigned threadsPerBlock = 0U;
# 345 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
 gpuContext __cuda_local_var_43189_16_non_const_gpu;
# 345 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
__cuda_local_var_43189_16_non_const_gpu = (amoebaGpu->gpuContext);




if (threadsPerBlock == 0U) {  unsigned __T264;
 unsigned __cuda_local_var_43195_22_non_const_maxThreads;
if (((int)(__cuda_local_var_43189_16_non_const_gpu->sm_version)) >= 3) {
__cuda_local_var_43195_22_non_const_maxThreads = 256U; } else  {
if (((int)(__cuda_local_var_43189_16_non_const_gpu->sm_version)) >= 2) {
__cuda_local_var_43195_22_non_const_maxThreads = 128U; } else  {

__cuda_local_var_43195_22_non_const_maxThreads = 64U; } }
threadsPerBlock = (*(_ZSt3minIjERKT_S2_S2_(((__T264 = (_Z18getThreadsPerBlockP17_amoebaGpuContextjj(amoebaGpu, 100U, (__cuda_local_var_43189_16_non_const_gpu->sharedMemoryPerBlock)))) , (((const unsigned *)&__T264))), (((const unsigned *)&__cuda_local_var_43195_22_non_const_maxThreads)))));
}

_Z14kClearFields_3P17_amoebaGpuContextj(amoebaGpu, 3U);

if (__cuda_local_var_43189_16_non_const_gpu->bOutputBufferPerWarp) {  struct dim3 __T265;
 unsigned __T266;
 struct dim3 __T267;
 unsigned __T268;
# 364 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
(cudaConfigureCall((((void)((__T266 = ((__cuda_local_var_43189_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T265.x) = __T266) , (void)((__T265.y) = 1U)) , ((__T265.z) = 1U)))) , __T265), (((void)((__T268 = threadsPerBlock) , (void)((((__T267.x) = __T268) , (void)((__T267.y) = 1U)) , ((__T267.z) = 1U)))) , __T267), (100UL * ((unsigned long)threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z47kCalculateAmoebaFixedEAndGkFieldN2ByWarp_kernelPjPfS0_S0_(((__cuda_local_var_43189_16_non_const_gpu->psWorkUnit)->_pDevData), ((amoebaGpu->psWorkArray_3_1)->_pDevData), ((amoebaGpu->psWorkArray_3_2)->_pDevData), ((amoebaGpu->psWorkArray_3_3)->_pDevData)));




} else  {  struct dim3 __T269;
 unsigned __T270;
 struct dim3 __T271;
 unsigned __T272;
# 371 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
(cudaConfigureCall((((void)((__T270 = ((__cuda_local_var_43189_16_non_const_gpu->sim).nonbond_blocks)) , (void)((((__T269.x) = __T270) , (void)((__T269.y) = 1U)) , ((__T269.z) = 1U)))) , __T269), (((void)((__T272 = threadsPerBlock) , (void)((((__T271.x) = __T272) , (void)((__T271.y) = 1U)) , ((__T271.z) = 1U)))) , __T271), (100UL * ((unsigned long)threadsPerBlock)), ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z41kCalculateAmoebaFixedEAndGkFieldN2_kernelPjPfS0_S0_(((__cuda_local_var_43189_16_non_const_gpu->psWorkUnit)->_pDevData), ((amoebaGpu->psWorkArray_3_1)->_pDevData), ((amoebaGpu->psWorkArray_3_2)->_pDevData), ((amoebaGpu->psWorkArray_3_3)->_pDevData)));



}
{  enum cudaError __cuda_local_var_43220_19_non_const_status;
# 376 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
__cuda_local_var_43220_19_non_const_status = (cudaGetLastError()); if (((int)__cuda_local_var_43220_19_non_const_status) != 0) {  struct _ZN6OpenMM15OpenMMExceptionE *__T273;
 struct _ZSs __T274;
 struct _ZSs __T275;
 struct _ZSs __T276;
 _ZSt6string __T277;
...
# 376 "/home/saifmulla/openmm/OpenMM/plugins/amoeba/platforms/cuda/src/kernels//kCalculateAmoebaCudaFixedEAndGkFields.cu"
((((((__T273 = ((struct _ZN6OpenMM15OpenMMExceptionE *)(__throw_setup_dtor((&_ZTIN6OpenMM15OpenMMExceptionE), 16UL, 0, _ZN6OpenMM15OpenMMExceptionD1Ev)))) , (void)((((__T279 = __T273) , (void)(__T280 = ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T274), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T275), ((_ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_((&__T276), ((_ZNSsC1EPKcRKSaIcE((&__T277), ((const char *)"Error: "), ((_ZNSaIcEC1Ev((&__T278))) , (((const struct _ZSaIcE *)&__T278))))) , (((const struct _ZSs *)&__T277))), (cudaGetErrorString(__cuda_local_var_43220_19_non_const_status)))) , (((const struct _ZSs *)&__T276))), ((const char *)" launching kernel "))) , (((const struct _ZSs *)&__T275))), ((const char *)"kCalculateAmoebaFixedEAndGkFieldN2_kernel"))) , (((const _ZSt6string *)&__T274))))) , (void)(((_ZNSt9exceptionC1Ev((&(__T279->__b_St9exception)))) , (void)(((__T279->__b_St9exception).__vptr) = (_ZTVN6OpenMM15OpenMMExceptionE + 2))) , (void)(_ZNSsC1ERKSs((&(__T279->message)), __T280)))) , (void)(__throw()))) , (void)(_ZNSsD1Ev((&__T274)))) , (void)(_ZNSsD1Ev((&__T275)))) , (void)(_ZNSsD1Ev((&__T276)))) , (void)(_ZNSsD1Ev((&__T277)))) , (void)(_ZNSaIcED1Ev((&__T278))); } } ;

_Z19kReduceEAndGkFieldsP17_amoebaGpuContext(amoebaGpu); 
...
{  _ZNSs14allocator_typeE __T281;
 struct _ZNSs4_RepE *__T282;
 const struct _ZSaIcE *__T283;
 void *__T284;
# 503 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
(((__T282 = (((struct _ZNSs4_RepE *)((((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)._M_p)) + (-1))) , (void)(__T283 = ((_ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T281)), ((const struct _ZN9__gnu_cxx13new_allocatorIcEE *)((struct _ZN9__gnu_cxx13new_allocatorIcEE *)((const struct _ZSaIcE *)(((struct _ZSaIcE *)&(((struct _ZSs *)((const struct _ZSs *)this))->_M_dataplus)))))))) , (((const struct _ZSaIcE *)&__T281))))) , (void)((__builtin_expect(((long)(__T282 != ((__T284 = ((void *)_ZNSs4_Rep20_S_empty_rep_storageE)) , ((struct _ZNSs4_RepE *)__T284)))), 0L)) ? (((_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii((&((__T282->__b_NSs9_Rep_baseE)._M_refcount)), (-1))) <= 0) ? (_ZNSs4_Rep10_M_destroyERKSaIcE(__T282, __T283)) : ((void)0)) : ((void)0))) , (void)(_ZN9__gnu_cxx13new_allocatorIcED1Ev(((struct _ZN9__gnu_cxx13new_allocatorIcEE *)(&__T281)))); { { _ZNSaIcED1Ev(((struct _ZSaIcE *)(&(this->_M_dataplus)))); } }  }
__asm__(".align 2");
...
# 68 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/ext/new_allocator.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T285) {   }
__asm__(".align 2");
 __attribute__((__weak__)) /* COMDAT group: _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_ */ __inline__ void _ZN9__gnu_cxx13new_allocatorIcEC2ERKS1_( struct _ZN9__gnu_cxx13new_allocatorIcEE *const this,  const struct _ZN9__gnu_cxx13new_allocatorIcEE *__T286) {  _ZN9__gnu_cxx13new_allocatorIcEC1ERKS1_(this, __T286);  }
__asm__(".align 2");
...
# 2198 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/basic_string.h" 3
 __attribute__((__weak__)) /* COMDAT group: _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_ */ __inline__ void _ZStplIcSt11char_traitsIcESaIcEESbIT_T0_T1_ERKS6_PKS3_( struct _ZSs *__T287,  const struct _ZSs *__lhs, 
const char *__rhs)
{
_ZNSsC1ERKSs(__T287, __lhs);
_ZNSs6appendEPKcm(__T287, __rhs, (__builtin_strlen(__rhs)));
return;
}
# 186 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/bits/stl_algobase.h" 3
...
return ((__T288 = (*__mem)) , (void)((*__mem) += __val)) , __T288; }



}
static void __sti___56_kCalculateAmoebaCudaFixedEAndGkFields_compute_20_cpp1_ii_b5838d25(void) {
# 72 "/usr/lib/gcc/x86_64-redhat-linux/4.4.7/../../../../include/c++/4.4.7/iostream" 3
_ZNSt8ios_base4InitC1Ev((&_ZSt8__ioinit)); __cxa_atexit(_ZNSt8ios_base4InitD1Ev, ((void *)(&_ZSt8__ioinit)), (&__dso_handle));  }

#include "kCalculateAmoebaCudaFixedEAndGkFields.compute_13.cudafe1.stub.c"
