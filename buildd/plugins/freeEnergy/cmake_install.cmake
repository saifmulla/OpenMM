...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libOpenMMFreeEnergy_d.so" AND
    ...
    FILE(RPATH_CHECK
         ...
         RPATH "")
  ENDIF()
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/home/saifmulla/openmm/OpenMM/buildd/libOpenMMFreeEnergy_d.so")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libOpenMMFreeEnergy_d.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libOpenMMFreeEnergy_d.so")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libOpenMMFreeEnergy_d.so")
...
IF(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  INCLUDE("/home/saifmulla/openmm/OpenMM/buildd/plugins/freeEnergy/platforms/reference/tests/cmake_install.cmake")
